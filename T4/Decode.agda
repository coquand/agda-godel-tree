...
-- T4.Decode -- the object  decode : Fun1 , the structural inverse of
-- T4.Num.num  on numeral codes, with the round-trip proved by INTERNAL
-- induction.  Step 3 of  T4/NEXT-SESSION-CHAITIN-G1-FRESH.md (the crux).
--
-- ======================================================================
...
-- realised as the shipped  T4.FoldRec.fold  with no tag dispatch, the
-- simplest fold instance after  T4.LenR ).
--
-- ======================================================================
...
open import T4.Tags         using ( tag_ap1 ; tag_s )
...
-- the prior-value lookup recovers  decode w .  This is the  T4.Parse
...
-- recover  decode w  via priorDecode_at.  This is the T4.Parse parse_at_leaf
