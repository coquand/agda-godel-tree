...
-- T4.ThmTCompleteAxClosed -- per-axiom completeness lemmas for
...
--  T4.ThmTCompleteAxFunctor  : they need an additional axFst/axSnd
-- reduction chain on the outputRHS's projections of  extra .

module T4.ThmTCompleteAxClosed where

open import T4.Base
open import T4.Tags
open import T4.Code
open import T4.Encode
...
open import T4.ThmTAtAx3 using ( thmT_at_axN3 )
open import T4.ThmTAtAx4 using ( thmT_at_axN4 )
open import T4.ThmTAtAx5 using ( thmT_at_axN5 )
open import T4.ThmTAtAx6 using ( thmT_at_axN6 )
open import T4.ThmTAtAx7 using ( thmT_at_axN7 )
...
open import T4.RuleInst3       using ( simSubst3F ; five_step_F )
