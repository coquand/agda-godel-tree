...
-- T4.Pair -- Cantor pairing at the Term level, using the BRA3
-- Pair (= pi) algebra.
--
...
--
-- which are re-exported by T4.Base.  T4 uses these AS-IS for the
-- user-facing pairing.
--
...
module T4.Pair where

open import T4.Base public

-- Pair, Fst, Snd, axFst, axSnd are re-exported from T4.Base
