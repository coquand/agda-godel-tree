...
-- T4.CloseW -- closes the user's witness w at vars 0 and 1, via two
-- ruleInst applications + three structural-induction closure lemmas.
--
-- Lets T4.ChaitinG1CoreNumRaw expose the EXACT fixed target signature
--   CGI_core_num_raw :
--     (w x : Term) ->
