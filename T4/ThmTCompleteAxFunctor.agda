...
-- T4.ThmTCompleteAxFunctor -- completeness for the functor-bearing
...
module T4.ThmTCompleteAxFunctor where
...
open import T4.ThmTAtAx9 using ( thmT_at_axN9 )
open import T4.ThmTAtAx10 using ( thmT_at_axN10 )
