...
-- T4.RuleInst2 -- re-export of BRA3.RuleInst2 (Church Standard
-- Metatheorem VII).
--
-- T4's Deriv layer is the same as BRA3's (T4.Base re-exports
...
--
-- USE.  This module is the foundation for T4.SbtFresh and
-- T4.ThmTCompleteAxEqTransUniv : both of those derive freshness-
-- style stability lemmas at the thmT level.

module T4.RuleInst2 where
