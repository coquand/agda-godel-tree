...
-- T4.ThmTCompleteAxClosedFree -- per-axiom completeness lemmas for
...
-- axFst/axSnd reduction chain.  Handled in T4.ThmTCompleteAxFunctor .

module T4.ThmTCompleteAxClosedFree where
...
open import T4.ThmTAtAx1 using ( thmT_at_axN1 )
