...
-- T4.CgFun -- the  cgFun : Term -> Term  /  cgFalse  decomposition of
-- T4.ChaitinG1CoreNumRawSelf.CGI_core_num_raw_self .
--
-- =================================================================
...
open import T4.ChaitinG1CoreNumRawSelf using ( CGI_core_num_raw_self )
