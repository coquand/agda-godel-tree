...
-- T4.ChaitinG1CoreNumRawSelf -- the  x -free, self-referential form of
-- CGI_core_num_raw .
--
-- Whether  thmT w  is of the form  ap1 (Kcode Lstar) _  is decided by the
--  outKdef Lstar  read-back ( decode . projKdef . thmT , T4.KdefRecog ).
...
module T4.ChaitinG1CoreNumRawSelf where
...
open import T4.ChaitinG1CoreNumRaw
