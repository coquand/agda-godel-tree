...
-- T4.NumInert -- the numeral-inertness lemma, by INTERNAL induction.
--
--   sbt_num_inert :
--     (k : Nat) (S : Term) (x : Term) ->
...
-- (T4.Num); its inertness is therefore an internal THEOREM.
--
...
-- and  T4/NEXT-SESSION-SBT2-SBT3.md .)

module T4.NumInert where
