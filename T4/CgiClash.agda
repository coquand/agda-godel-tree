...
-- T4.CgiClash -- CGI num-raw steps (e)+(f), the INTEGRATED clash, single-conjunct.
--
-- The abstract clash spike (T4.CgiClashSpike) de-abstracted onto the REAL
-- code-builder  Kcode  (T4.Kdef) and the REAL positive leg  dPos (T4.CgiDPos),
...
open import T4.Kdef using ( runProg ; Kcode ; Kcode_eval )
