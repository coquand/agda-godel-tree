...
-- T4.KFire -- THE FIRING, derived from thmT-completeness.
--
...
open import T4.KFormula        using ( Kgt ; negKgtCodeOf ; negKgtCodeOf_correct
                                       ; negKgtCodeOf_correct_T )
open import T4.KRecog          using ( hitK ; hitK_eval )
open import T4.KOut            using ( out_L ; out_L_correct ; out_L_correct_T )
