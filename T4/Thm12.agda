...
-- T4.Thm12 -- hub for Theorem 12 singulary cases.
--
-- Re-exports :
--
--   codeFTeq1 : Fun1 -> Term -> Term     (T4.Thm12.CodeFTeq)
--
--   Df_u   : Fun1
--   thm12_u : (X : Term) ->
...
module T4.Thm12 where

open import T4.Thm12.CodeFTeq    public using ( codeFTeq1 )
open import T4.Thm12.PartU       public using ( Df_u ; thm12_u )
open import T4.Thm12.PartO       public using ( Df_o ; thm12_o )
open import T4.Thm12.PartS       public using ( Df_s_meta ; thm12_s )
open import T4.Thm12.PartSF1     public using ( Df_s ; thm12_s_F1 )
open import T4.Thm12.EncodedRefl public using
  ( Df_refl_meta ; codedReflTerm ; encoded_refl )
open import T4.Thm12.EncodedReflF1 public using
