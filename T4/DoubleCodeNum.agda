...
-- T4.DoubleCodeNum -- the object realisation of  codeTerm . codeTerm  on
...
module T4.DoubleCodeNum where

open import T4.Base
open import T4.Tags using ( tag_ap1 ; tag_ap2 ; tag_s ; tag_o ; tag_u ; tag_C
                            ; tag_v ; tag_R )
