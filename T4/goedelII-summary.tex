...
of~\cite{Guard1963}; the realisation uses Church's $\pi$, written
...
$\mathrm{BRA}_0$ (Guard-Recursive-Arithmetic.pdf p.~19), that the simultaneous-substitution
...
\texttt{T4.Thm12.ImpHelpers} and \texttt{imp\_encoded\_mp}.
