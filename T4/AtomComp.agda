...
-- T4.AtomComp -- the POSITIVE companion of T4.NegAtomComp: the search-side
...
-- assembly (T4.ChaitinG1) feeds as  dPos / dExF 's antecedent.
--
...
open import T4.NegAtomComp using ( canonName ; canonPrf ; negAtomCompOf ; negAtomCompOf_eval )
...
--
-- The G1 assembly (T4.ChaitinG1) feeds  dExF : thmT cExF = cImp P (cImp N
