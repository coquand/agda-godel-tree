...
-- T4.StepU2CorrectRPeter -- R-case completeness for the Layer-1
-- universal interpreter, via the T4.PeterRec abstract induction
-- principle.
--
-- This file SUPERSEDES the Stack-motive specialisation in
-- T4/StepU2CorrectR.agda Sections 3-5.  Instead of building a custom
...
module T4.StepU2CorrectRPeter where
...
open import T4.PeterRec using ( PeterRec )
...
module Construct
  ...
  -- T4.StepU2CorrectR Section 4c (parametric in X = "x", N = "y", so we
