...
-- T4.Encode -- meta-Agda encoder  encode : {P : Formula} -> Deriv P -> Term .
--
-- Produces the Pair-tree code of a derivation, in the format the T4
-- thmT verifier (T4.ThmT) dispatches on.
--
-- TOP-LEVEL RULE TAGS:
...
--
-- See  T4.ThmT.axBranchN  for the schemas these correspond to and
-- T4.ThmTAtAxN  closures for the per-axiom Deriv equations.

module T4.Encode where
