...
-- T4.ChaitinG1 -- the num-headed, Con-FREE Goedel-Chaitin G1 barrier:
...
-- Supersedes the codeFormula-based  T4.Chaitin / T4.ChaitinComp .
--
...
--   T4.AtomComp.negAtomCompOf_eq_cNeg_atomCompOf  (N = cNeg P).
-- No codeFormula anywhere.

module T4.ChaitinG1 where
...
open import T4.AtomComp        using ( atomCompOf ; negAtomCompOf_eq_cNeg_atomCompOf )
