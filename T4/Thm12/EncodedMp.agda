...
-- T4.Thm12.EncodedMp -- the encoded modus-ponens primitive.
--
-- Given:
...
-- Term).
--
-- Built atop  T4.ThmTAtMp.thmT_at_mp .

module T4.Thm12.EncodedMp where

open import T4.Base
open import T4.Tags
open import T4.Code
open import T4.ThmT             using ( thmT )
open import T4.ThmTAtMp         using ( thmT_at_mp ; imp_thmT_at_mp )
