...
-- T4.Thm12.All -- Theorem 12, mutual assembly.
--
...
module T4.Thm12.All where

open import T4.Base
open import T4.ThmT              using ( thmT )
open import T4.Thm12.CodeFTeq    using ( codeFTeq1 ; codeFTeq2 )
open import T4.Thm12.PartO       using ( Df_o ; thm12_o )
open import T4.Thm12.PartU       using ( Df_u ; thm12_u )
open import T4.Thm12.PartSF1     using ( Df_s ; thm12_s_F1 )
open import T4.Thm12.PartCF1     using ( Df_C_F1 ; thm12_C_F1 )
open import T4.Thm12.PartVF2     using ( Df_v_F2 ; thm12_v_F2 )
open import T4.Thm12.PartRStep   using ( Dg ; thm12_R )

------------------------------------------------------------------------
-- Local Sigma (BRA3 / T4 do not export a global Sigma).
