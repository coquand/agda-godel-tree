...
-- T4.Thm12.PartCF1 -- Theorem 12, composition case with Df_C_F1 : Fun1.
--
--   Df_C_F1 :
--     (g : Fun2) (h1 h2 : Fun1)
...
open import T4.Thm12.EncodedAxC
  using ( Df_axC )
...
open import T4.Thm12.EncodedEqChain
  using ( Df_eqTrans )
open import T4.Thm12.PartC
  using ( Df_C ; thm12_C )
open import T4.Thm12.PartRStep
