...
-- T4.Thm12.PartRStep -- Theorem 12, R-case STEP (Y -> s Y).
--
...
--     Requires imp-lifting thmT_at_mp (T4/ThmTAtMp.agda lines 830-1300 :
...
module T4.Thm12.PartRStep where
...
open import T4.Thm12.EncodedAxRStep
  using ( Df_axRStep ; encodedAxRStep ; encodedAxRStep_Term )
open import T4.Thm12.EncodedAxEqTrans
  using ( Df_axEqTrans ; encodedAxEqTrans )
open import T4.Thm12.EncodedRefl
  using ( Df_refl_meta ; encoded_refl )
open import T4.Thm12.EncodedAxRBase
  using ( Df_axRBase )
open import T4.Thm12.PartRBase using ( Df_R_at_O ; thm12_R_at_O )
open import T4.Thm12.EncodedAxEqCongL
  using ( Df_axEqCongL ; encodedAxEqCongL ; encodedAxEqCongL_Term )
open import T4.Thm12.EncodedAxEqCongR
  using ( Df_axEqCongR ; encodedAxEqCongR ; encodedAxEqCongR_Term )
open import T4.Thm12.EncodedMp   using ( encoded_mp ; imp_encoded_mp )
open import T4.Thm12.EncodedEqChain
...
open import T4.RuleInst2 using ( ruleInst2 ; simSubstT ; simSubstF )
...
open import T4.Thm12.EncodedReflVar0
...
-- built atop imp_encoded_mp from T4.Thm12.EncodedMp).

private
  -- imp_encoded_eqSym -- Hilbert-lifted encoded_eqSym (T4.Thm12.EncodedEqChain).
  --
  ...
  -- imp_encoded_eqTrans -- Hilbert-lifted encoded_eqTrans (T4.Thm12.EncodedEqChain).
  --
