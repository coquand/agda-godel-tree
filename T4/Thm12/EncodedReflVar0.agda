...
-- T4.Thm12.EncodedReflVar0 -- the encoded reflexivity at the SPECIFIC
-- value  var 0 .
--
-- z_axRefl_v0 : Term
...
--       (Church Standard Metatheorem VII style, see T4.RuleInst2)
...
module T4.Thm12.EncodedReflVar0 where
...
open import T4.ThmTAtAx2         using ( thmT_at_axN2 )
open import T4.ThmTAtAx4         using ( thmT_at_axN4 )
open import T4.ThmTAtMp          using ( thmT_at_mp_codeF )
open import T4.ThmTCompleteAxClosedFree using ( thmT_complete_ax_u )
