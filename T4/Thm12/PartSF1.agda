...
-- T4.Thm12.PartSF1 -- Theorem 12 successor case with Df_s : Fun1.
--
--   Df_s : Fun1
...
open import T4.Thm12.EncodedReflF1
  using ( Df_refl ; Df_refl_unfold )
open import T4.Thm12.PartS       using ( Df_s_meta ; thm12_s )
