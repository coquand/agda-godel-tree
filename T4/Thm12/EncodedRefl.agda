...
-- T4.Thm12.EncodedRefl -- universal encoded-reflexivity for arbitrary
...
-- (proved in T4.Thm12.EncodedReflVar0 using the fresh-c sb-cascade).
...
module T4.Thm12.EncodedRefl where
