...
-- T4.Thm12.EncodedAxC -- encoded  ax_C  instance via single sb-wrap
-- on axN8.
--
...
module T4.Thm12.EncodedAxC where
...
open import T4.ThmTAtAx8         using ( thmT_at_axN8 )
...
private
  ...
  -- outputRHS extra (re-derived for clarity ; matches T4.ThmTAtAx8.outputRHS
  ...
  outputRHS_bridge g h1 h2 =
    let extra : Term
        ...
        -- (This is DEFINITIONAL in T4.Code.codeFun1 ;  no Deriv needed.)
