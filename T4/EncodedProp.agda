...
-- T4.EncodedProp -- the code-agnostic ax-branch necessitations of the THREE
...
-- (T4.ThmTAtAx11/12/13) -- which gives  thmT (packAx k extra) = outputRHS extra
...
module T4.EncodedProp where

open import T4.Base
open import T4.Tags  using ( tag_ax ; tag_imp ; tag_neg )
open import T4.ThmT  using ( thmT )
open import T4.DefWit using ( cImp ; cNeg ; cAnd )
open import T4.ThmTAtAx11 using ( thmT_at_axN11 )
open import T4.ThmTAtAx12 using ( thmT_at_axN12 )
open import T4.ThmTAtAx13 using ( thmT_at_axN13 )
...
-- (pack/packAx are private in T4.Encode; we spell the form thmT_at_axN11 reads.)
