...
-- T4.Base -- re-exports of the shared Term / Formula / Deriv
-- system from BRA3.  T4 keeps the same syntax of Terms and
-- the same rule system as BRA3 (Theorems and Deriv data type are
-- unchanged).  Only the coding scheme  code  and the verifier
-- thmT  are redesigned in T4 to follow Guard 1963 more closely.

module T4.Base where
