...
-- T4.ProgParse -- Phase E4, step R1b (CHAITIN-G1-FAITHFUL-BLUEPRINT.md S5bis):
...
-- canonical preorder string  enc t  (T4.ProgEnc) the stack machine rebuilds
...
-- Copied from T4.Parse with  stepFun_parse  this module's.
