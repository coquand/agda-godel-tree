...
-- T4.SbStep -- generic single-substitution "one-pass" step combinators
...
--  T4/NEXT-SESSION-ELIMINATE-SBT2-SBT3.md ).  An  sb2 / sb3  code-wrap
...
open import T4.SbfAtClosures using ( sbf_at_atomic ; sbf_at_neg ; sbf_at_imp )
open import T4.NumInert  using ( sbt_num_inert )
open import T4.NumInertCode using ( sbt_inert_ap1 ; sbt_inert_ap2 )
