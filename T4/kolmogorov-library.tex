...
theorem of $T$''. Kolmogorov complexity~\cite{Kolmogorov65,LiVitanyi} is
defined relative to the universal machine of the companion Chaitin
development~\cite{arGII}.
...
itself a consequence of $\Con_T$), one \emph{concludes} the meta equation
