...
\hline
$W \to A$ (diagonal) & \texttt{T4.Thm.Thm14GodelII} (\emph{shipped}) & fixed point $+$ $\mathbf{sub}$ $+$ encoded mp \\
...
$\mathbf{thmT}$ of \verb|T4/ThmT.agda|, but with the verifier-cascade
...
in \verb|T4/Thm/Thm14GodelII.agda|:
\begin{itemize}
...
(\verb|T4/SbT2.agda| and its dependents, $\sim 10\,000$ LoC).  As
noted in \verb|T4/goedelII-summary.tex| {\S}5, $\mathbf{sub_2}$
...
\verb|T4/Thm/Thm14GodelII.agda|.  The estimated implementation cost
is $\sim 8\,000$ LoC.
