...
-- T4.Bridge -- the mathematical core of the Chaitin search's  bridge  lemma
...
module T4.Bridge where

open import T4.Base
open import T4.Code using ( codeFormula ; falseF )
open import T4.ThmT using ( thmT )
open import T4.DefWit using ( atomForm )
open import T4.NegAtomCode using ( negAtomCodeOf ; negAtomCodeOf_correct )
