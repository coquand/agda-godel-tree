...
-- T4.KFormula -- Phase E2 (CHAITIN-G1-STANDARD-DIRECTION.md SS3/SS5):
...
open import T4.Thm12.ConstTermFun1 using ( NoVar_natCode ; constTermFun1 )
...
-- length of the description, T4.ProgParse).
