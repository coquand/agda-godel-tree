...
-- T4.StabilityNatFuel -- meta-Nat induction over the fuel argument of
...
module T4.StabilityNatFuel where
...
-- by stepFun_sbt's lookup machinery.  This is the T4 analog of the
...
--
-- The Fst-of-Snd is exactly what  get_spec  in T4/SbT.agda reads off.
