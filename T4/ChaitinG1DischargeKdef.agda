...
-- T4.ChaitinG1DischargeKdef -- num-raw, Kdef-shape  Discharge  for
-- CGI_core_num_raw.   Parallel to  T4.ChaitinG1Discharge  but at the
...
-- module of  T4.StepU2MuCorrect  with  gFun := predFlipDef Lstar  ;
...
module T4.ChaitinG1DischargeKdef where
