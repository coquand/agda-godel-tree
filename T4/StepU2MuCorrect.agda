...
module T4.StepU2MuCorrect where
...
module Construct
  ...
  frmM-index-rw t t' e = congR pi (natCode 4) (congR pi gc e)
    -- frmM gc k = pi (natCode tagM) (pi gc k), tagM = 4 in T4.EvalU.
