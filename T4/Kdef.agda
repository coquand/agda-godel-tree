...
-- T4.Kdef -- CGI num-raw step (a): the OPEN K-formula  Kdef L x  and its
...
-- halt configuration is a stepU-fixpoint (T4.EvalUStep.stepU_at_halt) -- so the
