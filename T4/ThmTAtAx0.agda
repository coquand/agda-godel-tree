...
-- T4.ThmTAtAx0 -- discharge of the  ax_0  (succ_nonzero) axiom closure
-- of  thmT  :
--
--   thmT_at_axN0 :
--     (extra : Term) ->
...
module T4.ThmTAtAx0 where

open import T4.Base
open import T4.Tags
open import T4.Code
open import T4.CoVSpec
open import T4.SbT          using ( get_tag ; get_body )
open import T4.ThmT
open import T4.PiPositivity
open import T4.ThmTAtAxCommon
