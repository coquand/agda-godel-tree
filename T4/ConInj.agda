...
-- T4.ConInj -- Con-injectivity, the core of Kritchman-Raz Phase KR-A.
--
...
-- pigeonhole (`InjBelowObj` in T4.CountingObj, via the merged surprise-exam
...
-- modus ponens (`encoded_mp`, T4.Thm12.EncodedMp): two MPs combine
