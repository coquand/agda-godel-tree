...
-- T4.Thm.Thm14HPart -- Step 5a of Guard's Theorem 14 proof in T4 ,
...
--
-- Since  code t = num t  (T4.Thm.Thm14F) , both substituents are
...
-- hence  InertU  via  NumCode  (T4.SbStep).  The inner-planted
...
module T4.Thm.Thm14HPart where
...
open import T4.Thm.Thm14TPrime
