...
-- T4.Thm.Thm14GodelII -- Goedel's Second Incompleteness Theorem for
...
--        T4.GoedelI.godelI but using Thm14F's sub-form  diag_term_eq
--        instead of T4.Diagonal 's sbf-form .

module T4.Thm.Thm14GodelII where

open import T4.Base
open import T4.Tags
open import T4.Code              using ( codeFormula ; falseF ; codeFalse )
open import T4.ThmT              using ( thmT )
open import T4.Encode            using ( encode )
open import T4.Sub               using ( sub )
open import T4.ThmTCompleteRec   using ( thmT_complete_rec )
open import T4.Thm.Thm14F
  using ( i ; iNat ; j ; G ; F ; H ; diag_inst ; diag_term_eq
        ; sub_ii_eq_j )
open import T4.Thm.Thm14Step1    using ( P_x )
open import T4.Thm.Thm14Step5    using ( big_term ; step5 )
...
------------------------------------------------------------------------
-- godelI_subform : same as T4.GoedelI.godelI but for Thm14F 's G
