...
-- T4.Thm.Thm14Step1 -- Step 1 of Guard's Theorem 14 proof , EXACTLY
...
--  Definition 12 + the typo correction noted in T4.Thm12.Thm13 .)
--
...
module T4.Thm.Thm14Step1 where
...
open import T4.Thm12.CodeFTeq    using ( codeFTeq1 )
open import T4.Thm12.All         using ( thm12 ; fst ; snd )
...
open import T4.Thm.Thm14F        using ( j ; code ; encEqF ; encThm )
