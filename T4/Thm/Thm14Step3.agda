...
module T4.Thm.Thm14Step3 where
...
open import T4.Thm.Thm14Step1     using ( P_x ; Df_thmT ; step1 )
open import T4.Thm.Thm14Step2     using ( Df_sub_ii ; step2 )
