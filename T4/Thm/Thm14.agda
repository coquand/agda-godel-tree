...
-- T4.Thm.Thm14 -- Goedel's Second Incompleteness Theorem.
--
-- PER T4/Plan.md sections "Thm 14 + Goedel II" (lines 400-412) and
-- "Things to AVOID" (lines 512-528), Thm 14 in T4 must be the
...
-- Goedel II to its own hardest sub-step -- and T4 is explicitly
