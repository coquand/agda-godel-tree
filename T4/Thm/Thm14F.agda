...
-- T4.Thm.Thm14F -- the concrete formula  F  driving the diagonal
...
-- with  diag_sub  =  ap2 sub (var 0) (var 0)  (not T4.Diagonal's
-- sbf-form ; T4.Diagonal is kept untouched and serves T4.GoedelI ) .
--
...
module T4.Thm.Thm14F where

open import T4.Base
open import T4.Tags
open import T4.Code              using ( codeFun1 ; codeFun2 ; codeFormula ; codeTerm )
open import T4.Num               using ( num )
open import T4.NumContract       using ( numContract ; NumContract ; module NumContract )
