...
--                                                       -- "th(x_) ≠ sub(i,i)"
--
-- Construction.  K_part  uses T4's encoded-substitution constructor
...
module T4.Thm.Thm14Step4 where
