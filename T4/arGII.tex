...
\title{Auto formalisation of G\"odel's Second Incompleteness Theorem in Binary Recursive Arithmetic}
...
\begin{abstract}
  We report an experiment in autoformalisation of Gödel's second incompleteness
  theorem in Agda using Claude. The theorem is formalised for Church's Basic Recursive
  Arithmetic (BRA), following the proof outline given in Guard's 1963 lecture notes. The
  ...
  autonomous attempt based on a theorem of Rose failed because the theorem is false;
  ...
  operation and the
  interaction between substitution and numeral closure. The
  ...
  incompleteness theorem for BRA.
\end{abstract}
...
\bibitem{Carneiro}
Mario Carneiro.
\newblock Natural deduction in the metamath proof language, 2016.
\newblock Accessed: 2026-05-29.
...
\bibitem{Church}
Alonzo Church.
\newblock Basic recursive arithmetic.
\newblock Logic Seminar lectures, Princeton University, 1957--1959. Cited via
  Guard's 1963 lecture notes, where the G\"odel numbering and incompleteness
  proof are described as essentially those of Church.

\bibitem{Cook75}
Stephen~A. Cook.
\newblock Feasibly constructive proofs and the propositional calculus.
\newblock Preliminary version, 1975.

\bibitem{Guard63}
James~R. Guard.
\newblock Lecture notes on recursive arithmetic.
\newblock Unpublished lecture notes. Definitions 6--16, Exercises 17--24, and
  Theorems 8--16 contain the verifier $\mathbf{th}$ and proofs of G\"odel's
  first and second incompleteness theorems for Binary Recursive Arithmetic,
  1963.

\bibitem{Goedel31}
Kurt Gödel.
\newblock \"uber formal unentscheidbare s{\"a}tze der principia mathematica und
  verwandter systeme i.
\newblock {\em Monatshefte f{\"u}r Mathematik und Physik}, 38(1):173--198,
  1931.
...
\bibitem{Rose61}
H.~E. Rose.
\newblock On the consistency and undecidability of recursive arithmetic.
\newblock {\em Zeitschrift f{\"u}r Mathematische Logik und Grundlagen der
  Mathematik}, 7:124--135, 1961.

\bibitem{Rose67}
H.~E. Rose.
\newblock Some mathematical results in recursive arithmetic.
\newblock {\em Z. Math. Logik Grundlagen Math.}, 13:381--384, 1967.
...
\bibitem{Skolem23}
Thoralf Skolem.
\newblock{Begr{\"u}ndung der elementaren arithmetik durch die rekurrierende
  denkweise ohne anwendung scheinbarer ver{\"a}nderlichen mit unendlichem
  ausdehnungsbereich.}
\newblock {\em Skrifter utgit av Videnskapsselskapet i Kristiania, I.
  Matematisk-naturvidenskabelig Klasse}, 1923(6):1--38, 1923.

\bibitem{Urban26}
Josef Urban.
\newblock 130k lines of formal topology in two weeks: Simple and cheap
  autoformalization for everyone?, 2026.
\newblock arXiv:2601.03298.

\bibitem{vonPlato20}
Jan von Plato.
\newblock {\em Can Mathematics Be Proved Consistent?: G{\"o}del's Shorthand
  Notes and Lectures on Incompleteness}.
\newblock Springer, Cham, 2020.

\bibitem{17Provers}
Freek Wiedijk, editor.
\newblock {\em The Seventeen Provers of the World: Foreword by Dana S. Scott},
  volume 3600 of {\em Lecture Notes in Computer Science}.
