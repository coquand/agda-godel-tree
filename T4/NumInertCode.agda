...
-- T4.NumInertCode -- compositional inertness of  sbt  on  num-based
-- code shapes.
--
...
--  T4/NEXT-SESSION-ELIMINATE-SBT2-SBT3.md ) we must show: when single
...
-- the dead  T4/Thm12/SbtAtFresh.agda ), this file ships COMBINATORS
...
--  num-leaf  base  sbt_num_inert  (T4.NumInert), they discharge
