...
-- T4.Parse -- the object  parse : Fun1  for the Kritchman-Raz KR-A
...
-- top.  Correctness (round-trip) is in T4.ParseRoundtrip.
--
-- This is a straight REDEPLOY of  T4.LenR  (the simplest FoldRec
-- instance) + the  condFork  tag-dispatch cascade of  T4.SbtAtAp .
-- No new primitive.

module T4.Parse where
