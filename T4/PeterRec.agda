...
-- T4.PeterRec -- Rosa Peter's iterated-parameter-transformer
...
-- of the value slot uses  T4.SubstCongInternal.substF_cong_imp .
--
...
module T4.PeterRec where

open import T4.Base
open import T4.SubLeqIdentities
...
open import T4.SubstCongInternal using ( substF_cong_imp )
