...
-- T4.LenR -- the right-recursive length functor, the FIRST concrete
-- T4.FoldRec instance (validates the Phase A0 API end-to-end) and the
...
--  Len(B) < m0  achievable.  (binMeta + the bound live in T4.Bin, next.)

module T4.LenR where
