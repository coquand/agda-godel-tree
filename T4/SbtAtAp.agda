...
-- T4.SbtAtAp -- discharge of the SbContract sbt closures at the two
-- ap-shape inputs:
--
--   sbt_at_ap1 :
...
--
-- (Same as T4/SbtAtVar.agda's helpers; reproduced here to avoid making
