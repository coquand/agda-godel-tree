...
-- T4.FnGlueAp2RcongCtx6 -- the ap2-flN-Rcong leaf (fun-head 8 = R, but the
...
module T4.FnGlueAp2RcongCtx6 where

open import T4.Base

open import T4.PrCodeObj using ( tmAp2 ; tgAp2 )
open import T4.FnMark using ( mAp2 ; flN ; mFun ; mMa ; mMb )
...
open import T4.FnResidualOpaque2Imp using ( residual_op_ap2_flN_Rcong_neg_ctx5f )
...
leaf_ap2_flN_Rcong =
  let residE : Deriv (imp Ga (imp Gb (imp Gc (imp Gd (imp Ge (imp Gf
      ...
      residE = wk56 (residual_op_ap2_flN_Rcong_neg_ctx5f sk ne_sk)
