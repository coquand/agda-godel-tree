...
-- T4.ChaitinG1ChainKdef -- num-raw, Kdef-shape Chain (gLcodeDef-based).
--
...
module T4.ChaitinG1ChainKdef where
...
module ChainKdef
  ...
  open T4.ChaitinG1DischargeKdef.DischargeKdef w x h sub0_w sub1_w sim_w
  ...
  h1c : Term
  h1c = mcodeMu (mcode1 (T4.ChaitinG1DischargeKdef.DischargeKdef.gFun
