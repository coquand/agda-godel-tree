...
-- T4.SbT -- the substitution functor  sbt : Fun2  on coded Terms.
--
-- ======================================================================
-- DESIGN.
-- ======================================================================
--
-- Built atop  T4.CoVSpec.cov_spec : Fun1 -> Fun2 -> Fun2 , the
...
--  T4/NEXT-SESSION-S2.md  and friends.
...
-- are exposed (not private) because T4/SbtAtVar.agda + T4/SbtAtAp.agda
...
-- stability/lookup machinery to be built in T4/StabilityNatFuel.agda (S2)
-- and T4/SbtAtPair.agda (S3).  See T4/NEXT-SESSION-S2.md.
