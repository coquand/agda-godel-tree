...
-- T4.Num -- the internal numeralisation functor  num : Fun1 .
--
...
-- T4/PLAN.md), an  ap1 f t  is encoded as  Pair tag_ap1 (Pair (codeFun1 f)
...
--
-- (T4/PLAN.md's  num_at_S  statement omits the outer  tag_ap1
-- wrapping; we fix that here so that the Deriv-level bridge
--  num_eq_code  in T4.IsNat is a straightforward meta-induction.)
--
-- CONSTRUCTION:
--
