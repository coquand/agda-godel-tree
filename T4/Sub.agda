...
-- T4.Sub -- the top-level Guard substitution functor  sub : Fun2 .
--
...
--   ap2 (codeFun2 sub) (Pair (num i) (num i))   in T4 ' s Pair encoding.
--
-- The T4 definition uses BRA3.Fan combinators :
--
