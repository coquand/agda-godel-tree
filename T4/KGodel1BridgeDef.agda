...
-- T4.KGodel1BridgeDef -- the Kdef-shape parallel of T4.KGodel1Bridge .
--
...
module T4.KGodel1BridgeDef where
...
import T4.GLCodePDef

-- ONE shared instantiation of the SizeDef module, re-exported.
module SzDef = T4.GLCodePDef.SizeDef thmT
