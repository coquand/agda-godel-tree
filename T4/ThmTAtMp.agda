...
-- T4.ThmTAtMp -- discharge of the  mp  closure of  thmT  in the
...
leq_cPImpIdx_P_outer_mp cPImpIdx cAIdx =
  let A : Term
      ...
      eqPi : Deriv (eqF (ap2 sigma (ap1 tau (ap2 sigma cPImpIdx cAIdx)) cAIdx)
                         (ap2 pi cPImpIdx cAIdx))
      eqPi = ruleSym (T4.LeqMono.T114_at cPImpIdx cAIdx)
      cong_sub :
...
-- using impEqTrans / impCong* from T4.Thm12.ImpHelpers.
