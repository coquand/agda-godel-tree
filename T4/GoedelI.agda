...
-- T4.GoedelI -- Goedel's Incompleteness Theorem for BRA, Guard 1963
-- Theorem 11 (p. 15).
--
...
--
--   sub : Fun2  (Exercise 24 [8]) ; built from T4.sbf + T4.num as
...
open import T4.NatBridge using ( codeTermNat ; codeFormulaNat
