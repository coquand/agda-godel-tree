...
-- T4.ThmTAtInd -- discharge of the  ind  closure of  thmT  in the
...
--
-- Mirrors the CURRENT shallow  ind_branch_thmT  in  T4.ThmT  : only
...
leq_cPBaseIdx_P_outer_ind cPBaseIdx cPStepIdx =
  let A : Term
      ...
      eqPi = ruleSym (T4.LeqMono.T114_at cPBaseIdx cPStepIdx)
