...
-- T4.CoVSpecUniv -- the Closed-free, universal-in-Term versions of
-- the cov_spec step / history-table lemmas.  S4 prerequisites.
--
-- The lemmas in T4.CoVSpec take  Closed n  as a premise on the fuel
