...
-- T4.ThmTComplete -- per-constructor pieces of the verifier-completeness
...
-- SCHEMA codeFormula) is deferred to T4.ThmTCompleteAx* (round 3).
...
open import T4.ThmTAtMp   using ( thmT_at_mp_codeF )
open import T4.ThmTAtInd  using ( thmT_at_ind_codeF )
open import T4.ThmTAtAx0  using ( thmT_at_axN0 )
...
------------------------------------------------------------------------
-- Specialise sbtEq_codeTerm / sbfEq_codeFormula to T4's concrete sbt , sbf .
