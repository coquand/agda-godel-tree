...
-- T4.ExistsHit -- the bounded-existential indicator and its one-hit lemma,
-- the OBJECT kernel of the witnessed bounded-exists-introduction that
-- discharges  T4.ChaitinG1Hit.chaitin_G1_hit 's hypothesis  h  (CHAITIN-G1-
-- ATOM-CORRECTION.md).
--
