...
-- T4.PHP -- the (P1) object pigeonhole spike for Gate-1
...
-- form needed by (P2) uses the established c-renaming pattern (T4.Stability).
...
--
-- as a sum of object 0/1 INDICATORS (Skolem 1923, T4/Skolem23.pdf,
