...
-- T4.CountingObj -- the OBJECT-N arbitrary-injection pigeonhole
-- (Kritchman-Raz Phase KR-C / "Spike C").
--
-- T4.Counting already proves the arbitrary-injection pigeonhole
...
-- and reusing the threshold-uniform per-term arithmetic of T4.Counting
...
open import T4.SpikeB using ( succ_mono_imp ; leq_trans_imp )
