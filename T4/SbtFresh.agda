...
-- T4.SbtFresh -- freshness-stability of  sbt / sbf  on codeTerm /
...
-- NatLe (suc m) c (= c > m) via natEq-lt-false (T4.RuleInst2).
--
-- This is the T4 thmT-level analog of BRA3 / RuleInst2's
-- substT_above_max .  Used by T4.ThmTCompleteAxEqTransUniv to
-- discharge the Closed-witness premises of  thmT_complete_ax_eqTrans .

module T4.SbtFresh where

open import T4.Base
open import T4.Tags
open import T4.Code
open import T4.SbContract
open import T4.RuleInst2
