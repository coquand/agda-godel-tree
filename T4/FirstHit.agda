...
-- T4.FirstHit -- the LEAST-NUMBER lemma for a decidable 0/1 predicate, as a
...
open import T4.Counting        using ( mapUnder1 ; mapUnder2 ; bCombThree )
open import T4.CountingObj      using ( trans2 )
open import T4.ExistsHit       using ( le_one_neq_zero ; lt_from_le_neq_curry ; unsucc_leq )
