...
-- T4.StepU2Correct1New -- completeness for operational semantics for
...
-- R-case (T4.StepU2CorrectR) can use it directly when constructing
-- paired_R : Fun2.

module T4.StepU2Correct1New where
...
open import T4.StepU2Reach     using ( sigma_zero ; sigma_succ ; iter_add_T )
...
-- T4.StepU2CorrectRPeter.  This yields the FULL Layer-1 Correct1/
-- Correct2 closed forms for every Fun1/Fun2 (no remaining open
-- parameters).

open import T4.StepU2CorrectRPeter using ( module Construct )
