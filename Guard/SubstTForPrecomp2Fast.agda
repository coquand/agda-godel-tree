...
-- Fast variant of SubstTForPrecomp2.
-- Identical to Guard.SubstTForPrecomp2 except that it imports
-- Guard.SubstTForPrecompFast instead of Guard.SubstTForPrecomp.

module Guard.SubstTForPrecomp2Fast where
