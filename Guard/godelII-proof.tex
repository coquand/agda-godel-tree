...
The constructive form directly produces a derivation of
$\trueT = \falseT$ from a derivation of~$G$, without
...
(the derivation rules allow instantiation of~$x$ by any term).
