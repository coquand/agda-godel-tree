...
\begin{theorem}[G\"odel~II --- \texttt{godelII} in \texttt{GodelIIFull.agda}]
\label{thm:godel2}
For any hypothesis equation~$H$:
\[
...
\noindent
That is: the internal consistency statement is not derivable
from any consistent hypothesis.
