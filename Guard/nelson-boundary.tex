...
(1)~a complete diagonal G\"odel~II proof~\cite{godel1931}
(168 lines, 0 postulates);
...
\item \textbf{Bounded consistency is feasible.}
  ...
  This connects to the proof-length phenomena studied by
  Pudl\'ak~\cite{pudlak1998} and the feasible arithmetic of
  Cook~\cite{cook1975}.
\end{enumerate}
