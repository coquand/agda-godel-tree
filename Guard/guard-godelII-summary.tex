...
\begin{remark}
\SchemaF{} was corrected during this development.  The original
formulation required proving $f(\pair{a}{b}) = g(\pair{a}{b})$
directly (without inductive hypothesis), which is too strong.
The corrected version requires showing $f$ and $g$ satisfy the
\emph{same} recursion equation --- matching Rose's original
Schema~F~\cite{rose1961} (uniqueness of the fixed point).
\end{remark}
