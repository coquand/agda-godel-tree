...
-- BRA4.SbfAtClosures -- discharge of the three formula closures of
--  SbContract :
--
...
module BRA4.SbfAtClosures where
...
open import BRA4.SbT          using ( sbt ; get_K ; get_inner ; get_spec
                                     ; get_table ; get_newK ; get_tag ; get_body
                                     ; lookupAt )
open import BRA4.SbF
...
open import BRA4.SbT      using ( sbt_at_O )
