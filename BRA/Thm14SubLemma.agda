...
--
-- Built on top of  BRA.Thm.ThmT.thmTDispRuleInst_param  (which is
...
-- swaps to the verifying body_ruleInst_v (BRA.SoundRuleInstProto), this
...
-- body_ruleInst (BRA.SoundRuleInstProto / BRA.SoundRuleInstVProof).
...
subTOfCodeFormulaImp_isPair n codeT Q R =
  let
      ...
      eA = subTDef n codeT (codeFormula (Q imp R))
...
subToFormulaBridge n r P =
  let eA : Deriv (atomic (eqn
      ...
      eA = subTDef n (code r) (codeFormula P)
