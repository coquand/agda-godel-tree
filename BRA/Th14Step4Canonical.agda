...
import BRA.Th14Step4

open import BRA.Th14SubTPushthrough using (subT_codeFormula_neg)
...
module Th14Step4Canonical
  ...
  open BRA.Th14Step4.Th14Step4 r12_th r12_sub using (step4_l)
  ...
  -- (per  BRA.Thm11Diagonal.G_norm 's definition).
  inner_eq : Formula
