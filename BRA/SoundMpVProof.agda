...
module BRA.SoundMpVProof where

open import BRA.Base
open import BRA.Term
open import BRA.Formula
open import BRA.Deriv
open import BRA.SubT using (treeEqRed)
open import BRA.Thm.EvalHelpers
  using ( liftAxiom ; liftedRuleTrans ; liftedCong1 ; liftedCongL ; liftedCongR )

open import BRA.SoundMpProto
  using ( body_mp_v ; codeTriv
        ; getD1 ; getD2 ; getHead ; getPT ; getQT
        ; outerCheckF1 ; innerCheckF1 ; innerOrFalsePairF1
        ; ccF1 ; qfailPairF1 ; verifierF1 )
...
-- by  thmTDispMp_param_l  (BRA.Thm.ThmT) to close the verifying mp
...
-- lifted helper from BRA.Thm.EvalHelpers .  Closed sub-derivations
