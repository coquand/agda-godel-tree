...
module BRA.SoundCong1VProof where
...
open import BRA.SoundCong1Proto
  using ( body_cong1_v ; verifierC1F1 ; doAssemblyF1
        ; assemblyLeftF1 ; assemblyRightF1 ; assemblyHalf
        ; getPayF ; getIH ; getFstIH ; getSndIH ; codeTriv )
