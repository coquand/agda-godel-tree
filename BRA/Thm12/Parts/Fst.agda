...
-- BRA.Thm12.Parts.Fst   (Theorem 12 case for f = Fst).
--
...
module BRA.Thm12.Parts.Fst where
...
open import BRA.Cor
open import BRA.Thm.Tag using (tagAxFst ; tagAxFstLf)
open import BRA.Thm.ThmT using (thmT ; tagCode_axFst ; tagCode_axFstLf ; thClosed)
open import BRA.Thm12.Param.AxFst
  using (parEncAxFst ; parOutAxFst ; parDispAxFst)
open import BRA.Thm12.Param.AxFstLf
...
D_Fst_reduce_O =
  let -- ap1 (Comp2 IfLf I dispatchFun) O = ap2 IfLf (ap1 I O) (ap1 dispatchFun O)
      ...
      d2 = axKT (nd (natCode tagAxFstLf) lf) O
...
D_Fst_reduce_Pair v1 v2 =
  let pv : Term
      ...
      d2 = axKT (nd (natCode tagAxFstLf) lf) pv
      ...
      n2 = axKT (natCode (suc (suc zero))) pv  -- tagAxFst = 2
