...
-- BRA.Thm12.Parts.IfLf   (Theorem 12 case for g = IfLf, binary).
--
...
module BRA.Thm12.Parts.IfLf where
...
open import BRA.Thm12.Param.AxIfLfL
  using (parEncAxIfLfL ; parOutAxIfLfL ; parDispAxIfLfL)
open import BRA.Thm12.Param.AxIfLfN
  using (parEncAxIfLfN ; parOutAxIfLfN ; parDispAxIfLfN)
open import BRA.Thm12.Param.AxIfLfLL
...
D_IfLf_reduce_OO =
  let -- ap2 D_IfLf O O = ap2 IfLf (ap2 fstProj O O) (ap2 outerInner O O).
      ...
      ilf2 = ruleTrans (axLift (KT caseLLTerm) O O)
                       (axKT (nd (natCode tagAxIfLfLL) lf) O)
...
D_IfLf_reduce_LN a b =
  let v = ap2 Pair a b
      ...
      lnf3 = axKT (natCode tagAxIfLfL) v
...
D_IfLf_reduce_NL p q =
  let x = ap2 Pair p q
      ...
      nlf3 = axKT (natCode tagAxIfLfNL) x
