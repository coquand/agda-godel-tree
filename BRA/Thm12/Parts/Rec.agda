...
-- BRA.Thm12.Parts.Rec   (Theorem 12 case for f = Rec z s).
--
...
module BRA.Thm12.Parts.Rec where
...
open import BRA.Thm.ThmT using (thmT ; tagCode_axRecLf ; thClosed)
open import BRA.Thm12.Param.AxRecLf
