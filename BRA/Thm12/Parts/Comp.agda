...
module BRA.Thm12.Parts.Comp where
...
open import BRA.Cor
open import BRA.Thm.Tag using (tagAxComp ; tagAxLift ; tagCong1 ; tagRuleTrans)
open import BRA.Thm.ThmT
  using (thmT ; tagCode_axComp ; tagCode_ruleTrans ; tagCode_cong1)
open import BRA.Thm12.Param.AxComp
