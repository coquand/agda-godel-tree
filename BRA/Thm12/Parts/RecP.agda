...
-- BRA.Thm12.Parts.RecP   (Theorem 12 case for g = RecP s, binary).
--
...
module BRA.Thm12.Parts.RecP where
...
open import BRA.Thm.ThmT using (thmT ; tagCode_axRecPLf)
open import BRA.Thm12.Param.AxRecPLf
