...
-- BRA.Thm12.Param.RuleInst : Term-level wrapper for the substitution
...
-- level by  body_ruleInst  inside  BRA.Thm.ThmT , using the  subT
-- combinator (BRA.SubT).  No Hilbert-level deduction theorem required.
--
...
module BRA.Thm12.Param.RuleInst where
...
open import BRA.Thm.Parts.RuleInst public
