...
-- BRA.Thm12.ShapeAdapters -- per-x / per-(x,v) shape adapters for the
...
-- BRA.Thm12.FromBridges' Comp2 / Fan dispatchers.
--
-- The four atomic shape lemmas (shape_D_F1_Fst_var0 etc.) live in their
-- own files and are imported here.

module BRA.Thm12.ShapeAdapters where

open import BRA.Base
open import BRA.Term
open import BRA.Formula
open import BRA.Deriv
open import BRA.Thm12.Shapes using (ShapeF1 ; ShapeF2)

open import BRA.Thm12.Parts.Fst    using (D_Fst)
open import BRA.Thm12.Parts.Snd    using (D_Snd)
...
open import BRA.Thm12.ShapeF1Fst    using (shape_D_F1_Fst_var0)
open import BRA.Thm12.ShapeF1Snd    using (shape_D_F1_Snd_var0)
open import BRA.Thm12.ShapeF2IfLf   using (shape_D_F2_IfLf_var01)
open import BRA.Thm12.ShapeF2TreeEq using (shape_D_F2_TreeEq_var01)
