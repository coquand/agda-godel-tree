...
-- BRA.Thm12.ShapeF1Snd -- mirror of ShapeF1Fst for Parts.Snd.D_Snd.

module BRA.Thm12.ShapeF1Snd where
...
open import BRA.Thm12.Parts.Snd
  using ( D_Snd
        ; D_Snd_reduce_O
        ; D_Snd_reduce_Pair )
open import BRA.Thm12.Param.AxSndLf using (parEncAxSndLf)
open import BRA.Thm12.Param.AxSnd   using (parEncAxSnd)
