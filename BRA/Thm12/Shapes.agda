...
-- Df_shape / D2g_shape parameters of BRA.Thm12.FromBridges.
--
...
open import BRA.Cor
open import BRA.Thm.ThmT using (thmT ; tagCode_axI)

open import BRA.Thm12.Parts.I
  using (D_I ; D_I_reduce)
open import BRA.Thm12.Parts.Fst
  using (D_Fst ; D_Fst_reduce_O ; D_Fst_reduce_Pair)
open import BRA.Thm12.Parts.Snd
  using (D_Snd ; D_Snd_reduce_O ; D_Snd_reduce_Pair)
open import BRA.Thm12.Parts.Z
  using (D_Z ; D_Z_reduce)
open import BRA.Thm12.Parts.Pair
  using (D2_Pair ; D2_Pair_reduce)
open import BRA.Thm12.Parts.Const
  using (D2_Const ; D2_Const_reduce)
open import BRA.Thm12.Param.AxI using (parEncAxI)
open import BRA.Thm12.Param.AxRefl using (parEncAxRefl)
...
shape_D2_Pair x v =
  ...
  where
    open BRA.Thm.ThmT using (tagCode_axRefl)
...
shape_D2_Const x v =
  mkSigma _ (mkSigma _ proof)
  where
    open BRA.Thm.ThmT using (tagCode_axConst)
...
shape_D_Z x =
  mkSigma _ (mkSigma _ proof)
  where
    open BRA.Thm.ThmT using (tagCode_axKT)
...
module ShapesComp
  ...
  open BRA.Thm.ThmT using (tagCode_ruleTrans)
  open import BRA.Thm12.Param.RuleTrans using (parEncRuleTrans)
  open import BRA.Thm12.Param.AxComp using (parEncAxComp)
  open import BRA.Thm12.Param.Cong1 using (parEncCong1)
...
module ShapesLift
  ...
  open BRA.Thm.ThmT using (tagCode_ruleTrans)
  open import BRA.Thm12.Param.RuleTrans using (parEncRuleTrans)
  open import BRA.Thm12.Param.AxLift using (parEncAxLift)
...
module ShapesPost
  ...
  open BRA.Thm.ThmT using (tagCode_ruleTrans)
  open import BRA.Thm12.Param.RuleTrans using (parEncRuleTrans)
  open import BRA.Thm12.Param.AxPost using (parEncAxPost)
  open import BRA.Thm12.Param.Cong1 using (parEncCong1)
...
module ShapesComp2
  ...
  D_Comp2_outer-Fst-shape innerFun x =
    let r1 = axComp2 Pair (KT tagCode_ruleTrans) innerFun x
        ...
        r3 = axKT (natCode tagRuleTrans) x
...
module ShapesFan
  ...
  D2_Fan_outer-Fst-shape innerFun x v =
    let r1 = axFan (Lift (KT tagCode_ruleTrans)) innerFun Pair x v
        ...
        r4 = axKT (natCode tagRuleTrans) x
