...
module BRA.Th14Step4Final where
...
open import BRA.Thm.ThmT using (thmT ; codedSubstT_code_thmT_var1)
...
open import BRA.GoedelII using (i ; cG ; G ; G_norm ; G_unfold ; j ; PrAtX)
...
module Th14Step4Final
  ...
  open BRA.Th14Step4Canonical.Th14Step4Canonical r12_th r12_sub
  ...
  private
    ...
    bK_tagAp1 x = subT_preserves_via_meta (suc zero) (ap1 cor x) tagAp1 refl
    ...
    bK_subII x =
      ...
      in subT_preserves_via_meta (suc zero) (ap1 cor x) (code (ap2 sub i i)) meta_eq
