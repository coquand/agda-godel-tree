...
open import BRA.SoundMpVProof using (body_mp_v ; body_mp_v_eval_pass ; body_mp_v_eval_pass_l)
open import BRA.SoundRuleInstVProof using (body_ruleInst_v ; body_ruleInst_v_eval_pass ; body_ruleInst_v_eval_pass_l ; codeFormulaPairShape)
open import BRA.SoundRuleSymVProof using (body_ruleSym_v ; body_ruleSym_v_eval_pass ; body_ruleSym_v_eval_pass_l)
open import BRA.SoundCong1VProof using (body_cong1_v ; body_cong1_v_eval_pass)
...
open import BRA.SoundRuleInst2VProof using ( body_ruleInst2_v ; body_ruleInst2_v_eval_pass )
open import BRA.SoundRuleInst2VProof as RI2Proto using ()
open import BRA.SoundRuleIndBTVProof using ( body_ruleIndBT_v ; body_ruleIndBT_v_eval_pass )
...
abstract
  ...
  -- payTcoded).
  --
  -- body_ruleSym moved to BRA.Thm.Parts.RuleSym (alias for body_ruleSym_v).
  -- body_ruleTrans, body_cong1, body_congL, body_congR, body_mp,
  -- body_ruleInst, body_ruleIndBT moved to their respective
  -- BRA.Thm.Parts.* files (each is an alias for the verifying body in
  -- the corresponding BRA.Sound*VProof file).
  ...
  -- body_ruleInst2 moved to BRA.Thm.Parts.RuleInst2 (alias for body_ruleInst2_v).
