...
--                                          (ap2 (treeRec f s) p b))) .
--
-- Modeled after BRA.Thm.Parts.AxRecPNd, with payT extended to depth 5 to
...
module BRA.Thm.Parts.AxTreeRecNd where

open import BRA.Base
open import BRA.Term
open import BRA.Formula
open import BRA.Deriv
open import BRA.Thm.Tag using (tagAxTreeRecNd)
...
abstract
  ...
  body_axTreeRecNd_eval f s p a' b' bb =
    let payFT  = reify (codeF1 f)
        ...
        tr_block = pairOfConst_eval K_trV
                     (Fan (Lift (Comp Fst Snd))
