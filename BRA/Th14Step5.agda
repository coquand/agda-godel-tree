...
open import BRA.Thm.Tag  using (tagMp ; tagAxContrapos ; tagRuleInst)
...
open import BRA.GoedelII using (cG ; G ; i ; j ; PrAtX ; bot)

open import BRA.Th14Step5HPart
  using (target_h ; target_h_eq01 ; module Th14Step5HPart)

import BRA.Th14StepHPre
import BRA.Th14HUnfolds
import BRA.Th14Step3
import BRA.Th14Step4Final
...
module Th14Step5
  ...
  open BRA.Th14HUnfolds.Th14HUnfolds r12_th r12_sub
    using (h_part_skel_unfold)

  open BRA.Th14StepHPre.Th14StepHPre r12_th r12_sub
    using (h_part_pre)

  open BRA.Th14Step5HPart.Th14Step5HPart r12_th r12_sub
    using (h_part_skel_l)

  open import BRA.Th14Step5HPart using (h_part_canon)

  -- Inner-check witnesses for the verifying mp dispatcher
  -- (load-bearing under PrAtX x):
  open BRA.Th14Step3.Th14Step3 r12_th r12_sub using (step3_l)
  open BRA.Th14Step4Final.Th14Step4Final r12_th r12_sub using (K_part_l)
