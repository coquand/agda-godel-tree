...
-- BRA.Th12TreeEqClose -- closes Theorem 12 for TreeEq.
--
-- Combines:
--   * basePP_concrete (BRA.Th12TreeEqBasePP) -- pointwise NN proof.
...
module BRA.Th12TreeEqClose where
...
open import BRA.Th12TreeEqNNFun using (D_TreeEq_NN_fun ; D_TreeEq_NN_closed ; pairOO)
...
open BRA.Thm12.Parts.TreeEq public using (codeFTeq2_TreeEq)

open import BRA.Th12TreeEqBaseLN using (P_Th12_TreeEq ; v3Nat ; v4Nat)
open import BRA.Th12TreeEqBaseNL using (v1Nat ; v2Nat)
open import BRA.Th12TreeEqUniv using (BasePPType ; Th12_F2_TreeEq_param)
open import BRA.Th12TreeEqBasePP using (Th12_F2_TreeEq_NN_pt)
...
-- BRA.Thm12.Parts.IfLf.D_correct2_IfLf).
--
