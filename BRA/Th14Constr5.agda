...
-- constr5 + step5 from r12_th, r12_sub.  Plugs into BRA.GoedelII.Compose
-- to produce
--
...
--
-- Mirrors thm13_F1 (BRA.Thm13) but lifted under an arbitrary
...
module Th14Constr5
  ...
  -- BRA.Thm.EvalHelpers.  The constr5 BUILDER is mechanical given the
