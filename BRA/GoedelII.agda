...
-- BRA.GoedelII
--
-- Full chain composition: concrete Thm 11 (from BRA.Thm.ThmT) plugged
-- into the abstract Goedel II tower (BRA.Thm14Abstract).
--
...
import BRA.Thm.ThmT
import BRA.Thm14Abstract

----------------------------------------------------------------------
-- Pull concrete Thm 11 components from BRA.Thm.ThmT.

open BRA.Thm.ThmT
  using (thmT ; thClosed ; codeF1Th_noVar)

open BRA.Thm.ThmT.WithDispatch
  using (encode)
