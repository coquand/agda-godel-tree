...
-- BRA.Th12TreeRecInternal -- internalised treeRec D2 builder.
--
...
module BRA.Th12TreeRecInternal where
...
open import BRA.Thm.Tag using (tagAxTreeRecLf ; tagAxTreeRecNd ; tagRuleTrans
                              ; tagCongL ; tagCongR)
...
open import BRA.Thm12.Param.AxTreeRecNd
...
module Construction
  ...
  lf_emitter_red p =
    let
      ...
      e2 = axKT (natCode tagRuleTrans) p
      ...
      e4kt = axKT (natCode tagAxTreeRecLf) p
  ...
  KT2_red : (v : Tree) (orig recs : Term) ->
    Deriv (atomic (eqn (ap2 (KT2 (reify v)) orig recs) (reify v)))
  KT2_red v orig recs =
  ...
  emit_enc_TR_v1_red p v1 v2 recs =
    let orig = ap2 Pair p (ap2 Pair v1 v2)
        ...
        e_mid = EmitPair_red (KT2 cf2_TR) (EmitPair emit_cor_p emit_cor_v1)
                  orig recs cf2_TR _
                  (KT2_red (codeF2 (treeRec f s)) orig recs)
                  e_pair_cor
    in EmitPair_red (KT2 (reify tagAp2))
  ...
  emit_parEncCongL_red p v1 v2 r1 r2 =
    ...
    in EmitPair_red (KT2 tagCode_congL)
                    ...
                    (KT2_red (natCode tagCongL) orig recs)
                    e_outer_pair
  ...
  emit_parEncCongR_red p v1 v2 r1 r2 =
    ...
    in EmitPair_red (KT2 tagCode_congR)
                    ...
                    (KT2_red (natCode tagCongR) orig recs)
                    e_outer_pair
  ...
  emit_parEncAxTreeRecNd_red p v1 v2 recs =
    ...
    in EmitPair_red (KT2 tagCode_axTreeRecNd)
                    ...
                    (KT2_red (natCode tagAxTreeRecNd) orig recs)
                    e_fT_outer
    ...
    let orig = ap2 Pair p (ap2 Pair v1 v2)
        ...
        e_inner =
          ...
          in EmitPair_red (KT2 tagCode_ruleTrans)
                          ...
                          (KT2_red (natCode tagRuleTrans) orig recs)
                          e_pair
