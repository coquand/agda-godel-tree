...
module BRA2.Th14Step3Canon where
...
open import BRA2.Thm14Numerals using (t_formula)
open import BRA2.GoedelII using (cG ; G ; i ; j ; j_isValue)
...
private
  ...
  bB_cG = subT_preserves_codeReify (suc zero) encoded_sub_ii (codeFormula G) (codeFormula_isValue G)
...
private
  ...
  bC_cG x = subT_preserves_codeReify zero (encoded_th_x_at x) (codeFormula G) (codeFormula_isValue G)
