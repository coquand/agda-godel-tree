...
module BRA2.SoundRuleSymVProof where
...
----------------------------------------------------------------------
-- Body and helpers (formerly in BRA2.SoundRuleSymProto).
...
body_ruleSym_v_eval_pass_l P a bb fp sp sndB_eqL =
  let
      ...
      c3A = axKT (codeFormula (atomic (eqn O O))) (codeFormula_isValue (atomic (eqn O O))) t
