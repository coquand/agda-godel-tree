...
module BRA2.SoundRuleInst2VProof where

open import BRA2.Base
open import BRA2.Term
open import BRA2.Formula
open import BRA2.Deriv
open import BRA2.Sb2 using (subT2)

----------------------------------------------------------------------
-- Body and helpers (formerly in BRA2.SoundRuleInst2Proto).
...
body_ruleInst2_v_eval_pass a bb argsPair codeFP fstPart sndPart
  ...
  let
      ...
      c3 = axKT (codeFormula (atomic (eqn O O))) (codeFormula_isValue (atomic (eqn O O))) tprime
