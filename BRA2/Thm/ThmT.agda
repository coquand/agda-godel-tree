...
--  WithDispatch  module.
--
-- This file extends  BRA2.Thm.StepProto  's 2-tag prototype to a full
...
--   * Tags >= suc zero (codified in BRA2.Thm.Tag).
--   * Zero postulates, zero holes.

module BRA2.Thm.ThmT where
...
open import BRA2.SoundMpVProof using (body_mp_v ; body_mp_v_eval_pass ; body_mp_v_eval_pass_l)
open import BRA2.SoundRuleInstVProof using (body_ruleInst_v ; body_ruleInst_v_eval_pass ; body_ruleInst_v_eval_pass_l ; codeFormulaPairShape)
open import BRA2.SoundRuleSymVProof using (body_ruleSym_v ; body_ruleSym_v_eval_pass ; body_ruleSym_v_eval_pass_l)
open import BRA2.SoundCong1VProof using (body_cong1_v ; body_cong1_v_eval_pass)
open import BRA2.SoundCongLVProof using
  ( body_congL_v ; body_congL_v_eval_pass ; body_congL_v_eval_pass_l ; body_congL_v_eval_pass_dl )
open import BRA2.SoundCongRVProof using
  ( body_congR_v ; body_congR_v_eval_pass ; body_congR_v_eval_pass_l ; body_congR_v_eval_pass_dl )
open import BRA2.SoundRuleTransVProof using
  ( body_ruleTrans_v ; body_ruleTrans_v_eval_pass ; body_ruleTrans_v_eval_pass_l
  ; body_ruleTrans_v_eval_pass_dl )
open import BRA2.SoundRuleInst2VProof using ( body_ruleInst2_v ; body_ruleInst2_v_eval_pass )
open import BRA2.SoundRuleInst2VProof as RI2Proto using ()
open import BRA2.SoundRuleIndBTVProof using ( body_ruleIndBT_v ; body_ruleIndBT_v_eval_pass )
open import BRA2.TreeEqReflParam using (treeEqReflParam)
open import BRA2.Thm.Tag

open import BRA2.Thm.Parts.AxI
open import BRA2.Thm.Parts.AxFst
open import BRA2.Thm.Parts.AxSnd
open import BRA2.Thm.Parts.AxConst
open import BRA2.Thm.Parts.AxComp
open import BRA2.Thm.Parts.AxComp2
open import BRA2.Thm.Parts.AxLift
open import BRA2.Thm.Parts.AxPost
...
open import BRA2.Thm.Parts.AxIfLfN
open import BRA2.Thm.Parts.AxTreeEqLL
open import BRA2.Thm.Parts.AxTreeEqLN
open import BRA2.Thm.Parts.AxTreeEqNL
open import BRA2.Thm.Parts.AxTreeEqNN
open import BRA2.Thm.Parts.AxGoodstein
open import BRA2.Thm.Parts.AxRefl
open import BRA2.Thm.Parts.RuleSym
open import BRA2.Thm.Parts.RuleTrans
open import BRA2.Thm.Parts.Cong1
open import BRA2.Thm.Parts.CongL
open import BRA2.Thm.Parts.CongR
open import BRA2.Thm.Parts.AxEqTrans
open import BRA2.Thm.Parts.AxEqCong1
open import BRA2.Thm.Parts.AxEqCongL
open import BRA2.Thm.Parts.AxEqCongR
open import BRA2.Thm.Parts.AxK
open import BRA2.Thm.Parts.AxS
open import BRA2.Thm.Parts.AxNeg
open import BRA2.Thm.Parts.AxExFalso
open import BRA2.Thm.Parts.AxContrapos
open import BRA2.Thm.Parts.Mp
open import BRA2.Thm.Parts.RuleInst
open import BRA2.Thm.Parts.RuleIndBT
open import BRA2.Thm.Parts.AxFstLf
open import BRA2.Thm.Parts.AxSndLf
open import BRA2.Thm.Parts.AxIfLfLL
open import BRA2.Thm.Parts.AxIfLfNL
open import BRA2.Thm.Parts.RuleInst2

------------------------------------------------------------------------
-- Reified tag-code constants extracted to BRA2.Thm.TagCodes so that
-- per-axiom Parts/Ax*.agda files can name them without going through
-- this file.

open import BRA2.Thm.TagCodes public
...
-- this 16k-line file.  See BRA2.Thm.EvalHelpers.

open import BRA2.Thm.EvalHelpers public
...
abstract
  ...
  -- body_axI and body_axI_eval moved to BRA2.Thm.Parts.AxI .
  -- body_axFst and body_axFst_eval moved to BRA2.Thm.Parts.AxFst .
  -- body_axSnd and body_axSnd_eval moved to BRA2.Thm.Parts.AxSnd .
  -- body_axConst and body_axConst_eval moved to BRA2.Thm.Parts.AxConst .
  -- body_axComp and body_axComp_eval moved to BRA2.Thm.Parts.AxComp .
  -- body_axComp2 and body_axComp2_eval moved to BRA2.Thm.Parts.AxComp2 .

  -- axLift f a' b' : LHS = ap2 (Lift f) a' b' , RHS = ap1 f a'.
  --   payT depth 3: Pair cf (Pair payAT payBT).
  -- body_axLift and body_axLift_eval moved to BRA2.Thm.Parts.AxLift .
  -- body_axPost and body_axPost_eval moved to BRA2.Thm.Parts.AxPost .
  -- body_axFan and body_axFan_eval moved to BRA2.Thm.Parts.AxFan .
  -- body_axZ and body_axZ_eval moved to BRA2.Thm.Parts.AxKT .
  -- body_axRecLf and body_axRecLf_eval moved to BRA2.Thm.Parts.AxRecLf .

  -- body_axRecNd and body_axRecNd_eval moved to BRA2.Thm.Parts.AxRecNd .

  -- body_axIfLfL and body_axIfLfL_eval moved to BRA2.Thm.Parts.AxIfLfL .
  -- body_axIfLfN and body_axIfLfN_eval moved to BRA2.Thm.Parts.AxIfLfN .
  -- body_axTreeEqLL and body_axTreeEqLL_eval moved to BRA2.Thm.Parts.AxTreeEqLL .
  -- body_axTreeEqLN and body_axTreeEqLN_eval moved to BRA2.Thm.Parts.AxTreeEqLN .
  -- body_axTreeEqNL and body_axTreeEqNL_eval moved to BRA2.Thm.Parts.AxTreeEqNL .
  -- body_axTreeEqNN and body_axTreeEqNN_eval moved to BRA2.Thm.Parts.AxTreeEqNN .
  -- body_axGoodstein and body_axGoodstein_eval moved to BRA2.Thm.Parts.AxGoodstein .
  -- body_axRefl and body_axRefl_eval moved to BRA2.Thm.Parts.AxRefl .
  -- body_axEqTrans and body_axEqTrans_eval moved to BRA2.Thm.Parts.AxEqTrans .
  -- body_axEqCong1 and body_axEqCong1_eval moved to BRA2.Thm.Parts.AxEqCong1 .
  -- body_axEqCongL and body_axEqCongL_eval moved to BRA2.Thm.Parts.AxEqCongL .
  -- body_axEqCongR and body_axEqCongR_eval moved to BRA2.Thm.Parts.AxEqCongR .
  -- body_axK and body_axK_eval moved to BRA2.Thm.Parts.AxK .
  -- body_axS and body_axS_eval moved to BRA2.Thm.Parts.AxS .
  ...
  -- payTcoded).
  --
  -- body_ruleSym moved to BRA2.Thm.Parts.RuleSym (alias for body_ruleSym_v).
  -- body_ruleTrans, body_cong1, body_congL, body_congR, body_mp,
  -- body_ruleInst, body_ruleIndBT moved to their respective
  -- BRA2.Thm.Parts.* files (each is an alias for the verifying body in
  -- the corresponding BRA2.Sound*VProof file).
  ...
  -- body_axFstLf and body_axFstLf_eval moved to BRA2.Thm.Parts.AxFstLf .
  -- body_axSndLf and body_axSndLf_eval moved to BRA2.Thm.Parts.AxSndLf .

  -- body_axIfLfLL and body_axIfLfLL_eval moved to BRA2.Thm.Parts.AxIfLfLL .
  ...
  -- body_ruleInst2 moved to BRA2.Thm.Parts.RuleInst2 (alias for body_ruleInst2_v).
  ...
  ------------------------------------------------------------------
  -- Top-level helpers (verbatim from BRA2.Thm.StepProto).
  ...
  skipAtTag : (tagCheckV : Term) -> IsValue tagCheckV ->
              (tagInput payload b : Term) (body nx : Fun2) ->
  ...
  skipAtTag tagCheckV tagCheckV_isValue tagInput payload b body nx neqProof =
    let tagCheck : Term
        ...
        c2 = ruleTrans (axLift (KT tagCheck) a b) (axKT tagCheckV tagCheckV_isValue a)
  ...
  hitAtTag : (tagCheckV : Term) -> IsValue tagCheckV ->
             (tagInput payload b : Term) (body nx : Fun2) ->
  ...
  hitAtTag tagCheckV tagCheckV_isValue tagInput payload b body nx eqProof =
    let tagCheck : Term
        tagCheck = reify tagCheckV
        a : Term
        a = ap2 Pair tagInput payload
  ...
  -- body_axI_eval moved to BRA2.Thm.Parts.AxI .
  ...
  thmTDispAxI t =
    let payT : Term
        ...
        e2 = hitAtTag (natCode tagAxI) (natCode_isValue tagAxI) tagCode_axI payT b body_axI next_axI (teqEq tagAxI)
  ...
  body_axI_eval_param xT bb =
    let payT  = xT
        ...
        innerKT_red = pairOfConst_eval K2V K2V_isValue (Lift Snd) a bb payT snd_a
  ...
  thmTDispAxFst a' b' =
    let payT = reify (nd (code a') (code b'))
        ...
        s1  = skipAtTag (natCode tagAxI) (natCode_isValue tagAxI) tagCode_axFst payT b body_axI next_axI
                 (teqDiff tagAxI tagAxFst refl)
        h   = hitAtTag (natCode tagAxFst) (natCode_isValue tagAxFst) tagCode_axFst payT b body_axFst next_axFst
                 (teqEq tagAxFst)
  ...
  body_axFst_eval_param aT bT bb =
    let payAT  = aT
        ...
        K1V_isValue = tagAp1_isValue
        K2V    = codeF1 Fst
        K2V_isValue = codeF1_isValue Fst
        K3V    = tagAp2
  ...
  thmTDispAxSnd a' b' =
    let payT = reify (nd (code a') (code b'))
        ...
        s1  = skipAtTag (natCode tagAxI) (natCode_isValue tagAxI)    tagCode_axSnd payT b body_axI    next_axI
                 (teqDiff tagAxI    tagAxSnd refl)
        s2  = skipAtTag (natCode tagAxFst) (natCode_isValue tagAxFst)  tagCode_axSnd payT b body_axFst  next_axFst
                 (teqDiff tagAxFst  tagAxSnd refl)
        h   = hitAtTag (natCode tagAxSnd) (natCode_isValue tagAxSnd)  tagCode_axSnd payT b body_axSnd  next_axSnd
                 (teqEq tagAxSnd)
  ...
  thmTDispAxConst a' b' =
    let payT = reify (nd (code a') (code b'))
        ...
        s1  = skipAtTag (natCode tagAxI) (natCode_isValue tagAxI)    tagCode_axConst payT b body_axI    next_axI
                 (teqDiff tagAxI    tagAxConst refl)
        s2  = skipAtTag (natCode tagAxFst) (natCode_isValue tagAxFst)  tagCode_axConst payT b body_axFst  next_axFst
                 (teqDiff tagAxFst  tagAxConst refl)
        s3  = skipAtTag (natCode tagAxSnd) (natCode_isValue tagAxSnd)  tagCode_axConst payT b body_axSnd  next_axSnd
                 (teqDiff tagAxSnd  tagAxConst refl)
        h   = hitAtTag (natCode tagAxConst) (natCode_isValue tagAxConst) tagCode_axConst payT b body_axConst next_axConst
                 (teqEq tagAxConst)
  ...
  thmTDispAxComp f g t =
    let payT = reify (nd (codeF1 f) (nd (codeF1 g) (code t)))
        ...
        s1  = skipAtTag (natCode tagAxI) (natCode_isValue tagAxI)     tagCode_axComp payT b body_axI     next_axI
                 (teqDiff tagAxI     tagAxComp refl)
        s2  = skipAtTag (natCode tagAxFst) (natCode_isValue tagAxFst)   tagCode_axComp payT b body_axFst   next_axFst
                 (teqDiff tagAxFst   tagAxComp refl)
        s3  = skipAtTag (natCode tagAxSnd) (natCode_isValue tagAxSnd)   tagCode_axComp payT b body_axSnd   next_axSnd
                 (teqDiff tagAxSnd   tagAxComp refl)
        s4  = skipAtTag (natCode tagAxConst) (natCode_isValue tagAxConst) tagCode_axComp payT b body_axConst next_axConst
                 (teqDiff tagAxConst tagAxComp refl)
        h   = hitAtTag (natCode tagAxComp) (natCode_isValue tagAxComp)  tagCode_axComp payT b body_axComp  next_axComp
                 (teqEq tagAxComp)
  ...
  body_axComp_eval_param f g xT bb =
    let cf = reify (codeF1 f)
        ...
        kcgxT = pairOfConst_eval K1V K1V_isValue
  ...
  thmTDispAxComp2 h' f g t =
    let payT = reify (nd (codeF2 h') (nd (codeF1 f) (nd (codeF1 g) (code t))))
        ...
        s1  = skipAtTag (natCode tagAxI) (natCode_isValue tagAxI)     tagCode_axComp2 payT b body_axI     next_axI
                 (teqDiff tagAxI     tagAxComp2 refl)
        s2  = skipAtTag (natCode tagAxFst) (natCode_isValue tagAxFst)   tagCode_axComp2 payT b body_axFst   next_axFst
                 (teqDiff tagAxFst   tagAxComp2 refl)
        s3  = skipAtTag (natCode tagAxSnd) (natCode_isValue tagAxSnd)   tagCode_axComp2 payT b body_axSnd   next_axSnd
                 (teqDiff tagAxSnd   tagAxComp2 refl)
        s4  = skipAtTag (natCode tagAxConst) (natCode_isValue tagAxConst) tagCode_axComp2 payT b body_axConst next_axConst
                 (teqDiff tagAxConst tagAxComp2 refl)
        s5  = skipAtTag (natCode tagAxComp) (natCode_isValue tagAxComp)  tagCode_axComp2 payT b body_axComp  next_axComp
                 (teqDiff tagAxComp  tagAxComp2 refl)
        hh  = hitAtTag (natCode tagAxComp2) (natCode_isValue tagAxComp2) tagCode_axComp2 payT b body_axComp2 next_axComp2
                 (teqEq tagAxComp2)
  ...
  body_axComp2_eval_param h' f g xT bb =
    let ch    = reify (codeF2 h')
        ...
        ka1Cfxt = pairOfConst_eval K_a1V K_a1V_isValue
                    (Fan (Lift (Comp Fst (Comp Snd Snd)))
                         (Lift (Comp Snd (Comp Snd (Comp Snd Snd)))) Pair)
                    a bb (ap2 Pair cf xT) cfxT
        ka1Cgxt = pairOfConst_eval K_a1V K_a1V_isValue
  ...
  thmTDispAxLift f a' b' =
    let payT = reify (nd (codeF1 f) (nd (code a') (code b')))
        ...
        s1  = skipAtTag (natCode tagAxI) (natCode_isValue tagAxI)      tagCode_axLift payT b body_axI      next_axI
                 (teqDiff tagAxI      tagAxLift refl)
        s2  = skipAtTag (natCode tagAxFst) (natCode_isValue tagAxFst)    tagCode_axLift payT b body_axFst    next_axFst
                 (teqDiff tagAxFst    tagAxLift refl)
        s3  = skipAtTag (natCode tagAxSnd) (natCode_isValue tagAxSnd)    tagCode_axLift payT b body_axSnd    next_axSnd
                 (teqDiff tagAxSnd    tagAxLift refl)
        s4  = skipAtTag (natCode tagAxConst) (natCode_isValue tagAxConst)  tagCode_axLift payT b body_axConst  next_axConst
                 (teqDiff tagAxConst  tagAxLift refl)
        s5  = skipAtTag (natCode tagAxComp) (natCode_isValue tagAxComp)   tagCode_axLift payT b body_axComp   next_axComp
                 (teqDiff tagAxComp   tagAxLift refl)
        s6  = skipAtTag (natCode tagAxComp2) (natCode_isValue tagAxComp2)  tagCode_axLift payT b body_axComp2  next_axComp2
                 (teqDiff tagAxComp2  tagAxLift refl)
        hh  = hitAtTag (natCode tagAxLift) (natCode_isValue tagAxLift)   tagCode_axLift payT b body_axLift   next_axLift
                 (teqEq tagAxLift)
  ...
  thmTDispAxPost f h' a' b' =
    let payT = reify (nd (codeF1 f) (nd (codeF2 h') (nd (code a') (code b'))))
        ...
        s1  = skipAtTag (natCode tagAxI) (natCode_isValue tagAxI)      tagCode_axPost payT b body_axI      next_axI
                 (teqDiff tagAxI      tagAxPost refl)
        s2  = skipAtTag (natCode tagAxFst) (natCode_isValue tagAxFst)    tagCode_axPost payT b body_axFst    next_axFst
                 (teqDiff tagAxFst    tagAxPost refl)
        s3  = skipAtTag (natCode tagAxSnd) (natCode_isValue tagAxSnd)    tagCode_axPost payT b body_axSnd    next_axSnd
                 (teqDiff tagAxSnd    tagAxPost refl)
        s4  = skipAtTag (natCode tagAxConst) (natCode_isValue tagAxConst)  tagCode_axPost payT b body_axConst  next_axConst
                 (teqDiff tagAxConst  tagAxPost refl)
        s5  = skipAtTag (natCode tagAxComp) (natCode_isValue tagAxComp)   tagCode_axPost payT b body_axComp   next_axComp
                 (teqDiff tagAxComp   tagAxPost refl)
        s6  = skipAtTag (natCode tagAxComp2) (natCode_isValue tagAxComp2)  tagCode_axPost payT b body_axComp2  next_axComp2
                 (teqDiff tagAxComp2  tagAxPost refl)
        s7  = skipAtTag (natCode tagAxLift) (natCode_isValue tagAxLift)   tagCode_axPost payT b body_axLift   next_axLift
                 (teqDiff tagAxLift   tagAxPost refl)
        hh  = hitAtTag (natCode tagAxPost) (natCode_isValue tagAxPost)   tagCode_axPost payT b body_axPost   next_axPost
                 (teqEq tagAxPost)
  ...
  thmTDispAxFan h1' h2' h' a' b' =
    let payT = reify (nd (codeF2 h1')
        ...
        s1  = skipAtTag (natCode tagAxI) (natCode_isValue tagAxI)      tagCode_axFan payT b body_axI      next_axI
                 (teqDiff tagAxI      tagAxFan refl)
        s2  = skipAtTag (natCode tagAxFst) (natCode_isValue tagAxFst)    tagCode_axFan payT b body_axFst    next_axFst
                 (teqDiff tagAxFst    tagAxFan refl)
        s3  = skipAtTag (natCode tagAxSnd) (natCode_isValue tagAxSnd)    tagCode_axFan payT b body_axSnd    next_axSnd
                 (teqDiff tagAxSnd    tagAxFan refl)
        s4  = skipAtTag (natCode tagAxConst) (natCode_isValue tagAxConst)  tagCode_axFan payT b body_axConst  next_axConst
                 (teqDiff tagAxConst  tagAxFan refl)
        s5  = skipAtTag (natCode tagAxComp) (natCode_isValue tagAxComp)   tagCode_axFan payT b body_axComp   next_axComp
                 (teqDiff tagAxComp   tagAxFan refl)
        s6  = skipAtTag (natCode tagAxComp2) (natCode_isValue tagAxComp2)  tagCode_axFan payT b body_axComp2  next_axComp2
                 (teqDiff tagAxComp2  tagAxFan refl)
        s7  = skipAtTag (natCode tagAxLift) (natCode_isValue tagAxLift)   tagCode_axFan payT b body_axLift   next_axLift
                 (teqDiff tagAxLift   tagAxFan refl)
        s8  = skipAtTag (natCode tagAxPost) (natCode_isValue tagAxPost)   tagCode_axFan payT b body_axPost   next_axPost
                 (teqDiff tagAxPost   tagAxFan refl)
        hh  = hitAtTag (natCode tagAxFan) (natCode_isValue tagAxFan)    tagCode_axFan payT b body_axFan    next_axFan
                 (teqEq tagAxFan)
  ...
  body_axFan_eval_param h1' h2' h' aT bT bb =
    let ch1   = reify (codeF2 h1')
        ...
        K_fV_isValue = leftT_isValue _ (codeF2_isValue (Fan IfLf IfLf IfLf))
        K_f   = reify K_fV
        ...
        kfChain = pairOfConst_eval K_fV K_fV_isValue
                    (Fan (Lift (Comp Fst Snd))
                         (Fan (Lift (Comp Fst (Comp Snd Snd)))
                              (Lift (Comp Fst (Comp Snd (Comp Snd Snd)))) Pair)
                         Pair)
        ...
        ka2ch1pATpBT = pairOfConst_eval K_a2V K_a2V_isValue
                         (Fan (Lift (Comp Fst Snd))
                              (Fan (Lift (Comp Fst (Comp Snd (Comp Snd (Comp Snd Snd)))))
                                   (Lift (Comp Snd (Comp Snd (Comp Snd (Comp Snd Snd)))))
                                   Pair) Pair)
                         a bb (ap2 Pair ch1 (ap2 Pair aT bT)) ch1pATpBT
        ka2ch2pATpBT = pairOfConst_eval K_a2V K_a2V_isValue
                         (Fan (Lift (Comp Fst (Comp Snd Snd)))
                              (Fan (Lift (Comp Fst (Comp Snd (Comp Snd (Comp Snd Snd)))))
                                   (Lift (Comp Snd (Comp Snd (Comp Snd (Comp Snd Snd)))))
                                   Pair) Pair)
  ...
  thmTDispAxZ x =
    let payT = reify (nd (codeF1 Z) (code x))
        ...
        s1  = skipAtTag (natCode tagAxI) (natCode_isValue tagAxI)      tagCode_axKT payT b body_axI      next_axI
                 (teqDiff tagAxI      tagAxKT refl)
        s2  = skipAtTag (natCode tagAxFst) (natCode_isValue tagAxFst)    tagCode_axKT payT b body_axFst    next_axFst
                 (teqDiff tagAxFst    tagAxKT refl)
        s3  = skipAtTag (natCode tagAxSnd) (natCode_isValue tagAxSnd)    tagCode_axKT payT b body_axSnd    next_axSnd
                 (teqDiff tagAxSnd    tagAxKT refl)
        s4  = skipAtTag (natCode tagAxConst) (natCode_isValue tagAxConst)  tagCode_axKT payT b body_axConst  next_axConst
                 (teqDiff tagAxConst  tagAxKT refl)
        s5  = skipAtTag (natCode tagAxComp) (natCode_isValue tagAxComp)   tagCode_axKT payT b body_axComp   next_axComp
                 (teqDiff tagAxComp   tagAxKT refl)
        s6  = skipAtTag (natCode tagAxComp2) (natCode_isValue tagAxComp2)  tagCode_axKT payT b body_axComp2  next_axComp2
                 (teqDiff tagAxComp2  tagAxKT refl)
        s7  = skipAtTag (natCode tagAxLift) (natCode_isValue tagAxLift)   tagCode_axKT payT b body_axLift   next_axLift
                 (teqDiff tagAxLift   tagAxKT refl)
        s8  = skipAtTag (natCode tagAxPost) (natCode_isValue tagAxPost)   tagCode_axKT payT b body_axPost   next_axPost
                 (teqDiff tagAxPost   tagAxKT refl)
        s9  = skipAtTag (natCode tagAxFan) (natCode_isValue tagAxFan)    tagCode_axKT payT b body_axFan    next_axFan
                 (teqDiff tagAxFan    tagAxKT refl)
        hh  = hitAtTag (natCode tagAxKT) (natCode_isValue tagAxKT)    tagCode_axKT payT b body_axZ      next_axKT
                 (teqEq tagAxKT)
  ...
  thmTDispAxTreeEqLL =
    let payT = O
        ...
        s1   = skipAtTag (natCode tagAxI) (natCode_isValue tagAxI)       tagCode_axTreeEqLL payT b body_axI       next_axI
                  (teqDiff tagAxI       tagAxTreeEqLL refl)
        s2   = skipAtTag (natCode tagAxFst) (natCode_isValue tagAxFst)     tagCode_axTreeEqLL payT b body_axFst     next_axFst
                  (teqDiff tagAxFst     tagAxTreeEqLL refl)
        s3   = skipAtTag (natCode tagAxSnd) (natCode_isValue tagAxSnd)     tagCode_axTreeEqLL payT b body_axSnd     next_axSnd
                  (teqDiff tagAxSnd     tagAxTreeEqLL refl)
        s4   = skipAtTag (natCode tagAxConst) (natCode_isValue tagAxConst)   tagCode_axTreeEqLL payT b body_axConst   next_axConst
                  (teqDiff tagAxConst   tagAxTreeEqLL refl)
        s5   = skipAtTag (natCode tagAxComp) (natCode_isValue tagAxComp)    tagCode_axTreeEqLL payT b body_axComp    next_axComp
                  (teqDiff tagAxComp    tagAxTreeEqLL refl)
        s6   = skipAtTag (natCode tagAxComp2) (natCode_isValue tagAxComp2)   tagCode_axTreeEqLL payT b body_axComp2   next_axComp2
                  (teqDiff tagAxComp2   tagAxTreeEqLL refl)
        s7   = skipAtTag (natCode tagAxLift) (natCode_isValue tagAxLift)    tagCode_axTreeEqLL payT b body_axLift    next_axLift
                  (teqDiff tagAxLift    tagAxTreeEqLL refl)
        s8   = skipAtTag (natCode tagAxPost) (natCode_isValue tagAxPost)    tagCode_axTreeEqLL payT b body_axPost    next_axPost
                  (teqDiff tagAxPost    tagAxTreeEqLL refl)
        s9   = skipAtTag (natCode tagAxFan) (natCode_isValue tagAxFan)     tagCode_axTreeEqLL payT b body_axFan     next_axFan
                  (teqDiff tagAxFan     tagAxTreeEqLL refl)
        s10  = skipAtTag (natCode tagAxKT) (natCode_isValue tagAxKT)      tagCode_axTreeEqLL payT b body_axZ      next_axKT
                  (teqDiff tagAxKT      tagAxTreeEqLL refl)
        s15  = skipAtTag (natCode tagAxIfLfL) (natCode_isValue tagAxIfLfL)   tagCode_axTreeEqLL payT b body_axIfLfL   next_axIfLfL
                  (teqDiff tagAxIfLfL   tagAxTreeEqLL refl)
        s16  = skipAtTag (natCode tagAxIfLfN) (natCode_isValue tagAxIfLfN)   tagCode_axTreeEqLL payT b body_axIfLfN   next_axIfLfN
                  (teqDiff tagAxIfLfN   tagAxTreeEqLL refl)
        hh   = hitAtTag (natCode tagAxTreeEqLL) (natCode_isValue tagAxTreeEqLL) tagCode_axTreeEqLL payT b body_axTreeEqLL next_axTreeEqLL
                  (teqEq tagAxTreeEqLL)
  ...
  thmTDispAxIfLfL a' b' =
    let payT = reify (nd (code a') (code b'))
        ...
        s1   = skipAtTag (natCode tagAxI) (natCode_isValue tagAxI)       tagCode_axIfLfL payT b body_axI       next_axI
                  (teqDiff tagAxI       tagAxIfLfL refl)
        s2   = skipAtTag (natCode tagAxFst) (natCode_isValue tagAxFst)     tagCode_axIfLfL payT b body_axFst     next_axFst
                  (teqDiff tagAxFst     tagAxIfLfL refl)
        s3   = skipAtTag (natCode tagAxSnd) (natCode_isValue tagAxSnd)     tagCode_axIfLfL payT b body_axSnd     next_axSnd
                  (teqDiff tagAxSnd     tagAxIfLfL refl)
        s4   = skipAtTag (natCode tagAxConst) (natCode_isValue tagAxConst)   tagCode_axIfLfL payT b body_axConst   next_axConst
                  (teqDiff tagAxConst   tagAxIfLfL refl)
        s5   = skipAtTag (natCode tagAxComp) (natCode_isValue tagAxComp)    tagCode_axIfLfL payT b body_axComp    next_axComp
                  (teqDiff tagAxComp    tagAxIfLfL refl)
        s6   = skipAtTag (natCode tagAxComp2) (natCode_isValue tagAxComp2)   tagCode_axIfLfL payT b body_axComp2   next_axComp2
                  (teqDiff tagAxComp2   tagAxIfLfL refl)
        s7   = skipAtTag (natCode tagAxLift) (natCode_isValue tagAxLift)    tagCode_axIfLfL payT b body_axLift    next_axLift
                  (teqDiff tagAxLift    tagAxIfLfL refl)
        s8   = skipAtTag (natCode tagAxPost) (natCode_isValue tagAxPost)    tagCode_axIfLfL payT b body_axPost    next_axPost
                  (teqDiff tagAxPost    tagAxIfLfL refl)
        s9   = skipAtTag (natCode tagAxFan) (natCode_isValue tagAxFan)     tagCode_axIfLfL payT b body_axFan     next_axFan
                  (teqDiff tagAxFan     tagAxIfLfL refl)
        s10  = skipAtTag (natCode tagAxKT) (natCode_isValue tagAxKT)      tagCode_axIfLfL payT b body_axZ      next_axKT
                  (teqDiff tagAxKT      tagAxIfLfL refl)
        hh   = hitAtTag (natCode tagAxIfLfL) (natCode_isValue tagAxIfLfL)   tagCode_axIfLfL payT b body_axIfLfL   next_axIfLfL
                  (teqEq tagAxIfLfL)
  ...
  thmTDispAxTreeEqLN a' b' =
    let payT = reify (nd (code a') (code b'))
        ...
        s1   = skipAtTag (natCode tagAxI) (natCode_isValue tagAxI)        tagCode_axTreeEqLN payT b body_axI        next_axI
                  (teqDiff tagAxI        tagAxTreeEqLN refl)
        s2   = skipAtTag (natCode tagAxFst) (natCode_isValue tagAxFst)      tagCode_axTreeEqLN payT b body_axFst      next_axFst
                  (teqDiff tagAxFst      tagAxTreeEqLN refl)
        s3   = skipAtTag (natCode tagAxSnd) (natCode_isValue tagAxSnd)      tagCode_axTreeEqLN payT b body_axSnd      next_axSnd
                  (teqDiff tagAxSnd      tagAxTreeEqLN refl)
        s4   = skipAtTag (natCode tagAxConst) (natCode_isValue tagAxConst)    tagCode_axTreeEqLN payT b body_axConst    next_axConst
                  (teqDiff tagAxConst    tagAxTreeEqLN refl)
        s5   = skipAtTag (natCode tagAxComp) (natCode_isValue tagAxComp)     tagCode_axTreeEqLN payT b body_axComp     next_axComp
                  (teqDiff tagAxComp     tagAxTreeEqLN refl)
        s6   = skipAtTag (natCode tagAxComp2) (natCode_isValue tagAxComp2)    tagCode_axTreeEqLN payT b body_axComp2    next_axComp2
                  (teqDiff tagAxComp2    tagAxTreeEqLN refl)
        s7   = skipAtTag (natCode tagAxLift) (natCode_isValue tagAxLift)     tagCode_axTreeEqLN payT b body_axLift     next_axLift
                  (teqDiff tagAxLift     tagAxTreeEqLN refl)
        s8   = skipAtTag (natCode tagAxPost) (natCode_isValue tagAxPost)     tagCode_axTreeEqLN payT b body_axPost     next_axPost
                  (teqDiff tagAxPost     tagAxTreeEqLN refl)
        s9   = skipAtTag (natCode tagAxFan) (natCode_isValue tagAxFan)      tagCode_axTreeEqLN payT b body_axFan      next_axFan
                  (teqDiff tagAxFan      tagAxTreeEqLN refl)
        s10  = skipAtTag (natCode tagAxKT) (natCode_isValue tagAxKT)       tagCode_axTreeEqLN payT b body_axZ       next_axKT
                  (teqDiff tagAxKT       tagAxTreeEqLN refl)
        s15  = skipAtTag (natCode tagAxIfLfL) (natCode_isValue tagAxIfLfL)    tagCode_axTreeEqLN payT b body_axIfLfL    next_axIfLfL
                  (teqDiff tagAxIfLfL    tagAxTreeEqLN refl)
        s16  = skipAtTag (natCode tagAxIfLfN) (natCode_isValue tagAxIfLfN)    tagCode_axTreeEqLN payT b body_axIfLfN    next_axIfLfN
                  (teqDiff tagAxIfLfN    tagAxTreeEqLN refl)
        s17  = skipAtTag (natCode tagAxTreeEqLL) (natCode_isValue tagAxTreeEqLL) tagCode_axTreeEqLN payT b body_axTreeEqLL next_axTreeEqLL
                  (teqDiff tagAxTreeEqLL tagAxTreeEqLN refl)
        hh   = hitAtTag (natCode tagAxTreeEqLN) (natCode_isValue tagAxTreeEqLN) tagCode_axTreeEqLN payT b body_axTreeEqLN next_axTreeEqLN
                  (teqEq tagAxTreeEqLN)
  ...
  thmTDispAxTreeEqNL a' b' =
    let payT = reify (nd (code a') (code b'))
        ...
        s1   = skipAtTag (natCode tagAxI) (natCode_isValue tagAxI)        tagCode_axTreeEqNL payT b body_axI        next_axI
                  (teqDiff tagAxI        tagAxTreeEqNL refl)
        s2   = skipAtTag (natCode tagAxFst) (natCode_isValue tagAxFst)      tagCode_axTreeEqNL payT b body_axFst      next_axFst
                  (teqDiff tagAxFst      tagAxTreeEqNL refl)
        s3   = skipAtTag (natCode tagAxSnd) (natCode_isValue tagAxSnd)      tagCode_axTreeEqNL payT b body_axSnd      next_axSnd
                  (teqDiff tagAxSnd      tagAxTreeEqNL refl)
        s4   = skipAtTag (natCode tagAxConst) (natCode_isValue tagAxConst)    tagCode_axTreeEqNL payT b body_axConst    next_axConst
                  (teqDiff tagAxConst    tagAxTreeEqNL refl)
        s5   = skipAtTag (natCode tagAxComp) (natCode_isValue tagAxComp)     tagCode_axTreeEqNL payT b body_axComp     next_axComp
                  (teqDiff tagAxComp     tagAxTreeEqNL refl)
        s6   = skipAtTag (natCode tagAxComp2) (natCode_isValue tagAxComp2)    tagCode_axTreeEqNL payT b body_axComp2    next_axComp2
                  (teqDiff tagAxComp2    tagAxTreeEqNL refl)
        s7   = skipAtTag (natCode tagAxLift) (natCode_isValue tagAxLift)     tagCode_axTreeEqNL payT b body_axLift     next_axLift
                  (teqDiff tagAxLift     tagAxTreeEqNL refl)
        s8   = skipAtTag (natCode tagAxPost) (natCode_isValue tagAxPost)     tagCode_axTreeEqNL payT b body_axPost     next_axPost
                  (teqDiff tagAxPost     tagAxTreeEqNL refl)
        s9   = skipAtTag (natCode tagAxFan) (natCode_isValue tagAxFan)      tagCode_axTreeEqNL payT b body_axFan      next_axFan
                  (teqDiff tagAxFan      tagAxTreeEqNL refl)
        s10  = skipAtTag (natCode tagAxKT) (natCode_isValue tagAxKT)       tagCode_axTreeEqNL payT b body_axZ       next_axKT
                  (teqDiff tagAxKT       tagAxTreeEqNL refl)
        s15  = skipAtTag (natCode tagAxIfLfL) (natCode_isValue tagAxIfLfL)    tagCode_axTreeEqNL payT b body_axIfLfL    next_axIfLfL
                  (teqDiff tagAxIfLfL    tagAxTreeEqNL refl)
        s16  = skipAtTag (natCode tagAxIfLfN) (natCode_isValue tagAxIfLfN)    tagCode_axTreeEqNL payT b body_axIfLfN    next_axIfLfN
                  (teqDiff tagAxIfLfN    tagAxTreeEqNL refl)
        s17  = skipAtTag (natCode tagAxTreeEqLL) (natCode_isValue tagAxTreeEqLL) tagCode_axTreeEqNL payT b body_axTreeEqLL next_axTreeEqLL
                  (teqDiff tagAxTreeEqLL tagAxTreeEqNL refl)
        s18  = skipAtTag (natCode tagAxTreeEqLN) (natCode_isValue tagAxTreeEqLN) tagCode_axTreeEqNL payT b body_axTreeEqLN next_axTreeEqLN
                  (teqDiff tagAxTreeEqLN tagAxTreeEqNL refl)
        hh   = hitAtTag (natCode tagAxTreeEqNL) (natCode_isValue tagAxTreeEqNL) tagCode_axTreeEqNL payT b body_axTreeEqNL next_axTreeEqNL
                  (teqEq tagAxTreeEqNL)
  ...
  thmTDispAxGoodstein a' b' =
    let payT = reify (nd (code a') (code b'))
        ...
        s1   = skipAtTag (natCode tagAxI) (natCode_isValue tagAxI)         tagCode_axGoodstein payT b body_axI         next_axI
                  (teqDiff tagAxI         tagAxGoodstein refl)
        s2   = skipAtTag (natCode tagAxFst) (natCode_isValue tagAxFst)       tagCode_axGoodstein payT b body_axFst       next_axFst
                  (teqDiff tagAxFst       tagAxGoodstein refl)
        s3   = skipAtTag (natCode tagAxSnd) (natCode_isValue tagAxSnd)       tagCode_axGoodstein payT b body_axSnd       next_axSnd
                  (teqDiff tagAxSnd       tagAxGoodstein refl)
        s4   = skipAtTag (natCode tagAxConst) (natCode_isValue tagAxConst)     tagCode_axGoodstein payT b body_axConst     next_axConst
                  (teqDiff tagAxConst     tagAxGoodstein refl)
        s5   = skipAtTag (natCode tagAxComp) (natCode_isValue tagAxComp)      tagCode_axGoodstein payT b body_axComp      next_axComp
                  (teqDiff tagAxComp      tagAxGoodstein refl)
        s6   = skipAtTag (natCode tagAxComp2) (natCode_isValue tagAxComp2)     tagCode_axGoodstein payT b body_axComp2     next_axComp2
                  (teqDiff tagAxComp2     tagAxGoodstein refl)
        s7   = skipAtTag (natCode tagAxLift) (natCode_isValue tagAxLift)      tagCode_axGoodstein payT b body_axLift      next_axLift
                  (teqDiff tagAxLift      tagAxGoodstein refl)
        s8   = skipAtTag (natCode tagAxPost) (natCode_isValue tagAxPost)      tagCode_axGoodstein payT b body_axPost      next_axPost
                  (teqDiff tagAxPost      tagAxGoodstein refl)
        s9   = skipAtTag (natCode tagAxFan) (natCode_isValue tagAxFan)       tagCode_axGoodstein payT b body_axFan       next_axFan
                  (teqDiff tagAxFan       tagAxGoodstein refl)
        s10  = skipAtTag (natCode tagAxKT) (natCode_isValue tagAxKT)        tagCode_axGoodstein payT b body_axZ        next_axKT
                  (teqDiff tagAxKT        tagAxGoodstein refl)
        s15  = skipAtTag (natCode tagAxIfLfL) (natCode_isValue tagAxIfLfL)     tagCode_axGoodstein payT b body_axIfLfL     next_axIfLfL
                  (teqDiff tagAxIfLfL     tagAxGoodstein refl)
        s16  = skipAtTag (natCode tagAxIfLfN) (natCode_isValue tagAxIfLfN)     tagCode_axGoodstein payT b body_axIfLfN     next_axIfLfN
                  (teqDiff tagAxIfLfN     tagAxGoodstein refl)
        s17  = skipAtTag (natCode tagAxTreeEqLL) (natCode_isValue tagAxTreeEqLL)  tagCode_axGoodstein payT b body_axTreeEqLL  next_axTreeEqLL
                  (teqDiff tagAxTreeEqLL  tagAxGoodstein refl)
        s18  = skipAtTag (natCode tagAxTreeEqLN) (natCode_isValue tagAxTreeEqLN)  tagCode_axGoodstein payT b body_axTreeEqLN  next_axTreeEqLN
                  (teqDiff tagAxTreeEqLN  tagAxGoodstein refl)
        s19  = skipAtTag (natCode tagAxTreeEqNL) (natCode_isValue tagAxTreeEqNL)  tagCode_axGoodstein payT b body_axTreeEqNL  next_axTreeEqNL
                  (teqDiff tagAxTreeEqNL  tagAxGoodstein refl)
        s20  = skipAtTag (natCode tagAxTreeEqNN) (natCode_isValue tagAxTreeEqNN)  tagCode_axGoodstein payT b body_axTreeEqNN  next_axTreeEqNN
                  (teqDiff tagAxTreeEqNN  tagAxGoodstein refl)
        hh   = hitAtTag (natCode tagAxGoodstein) (natCode_isValue tagAxGoodstein) tagCode_axGoodstein payT b body_axGoodstein next_axGoodstein
  ...
  thmTDispAxIfLfN x y a' b' =
    let payT = reify (nd (code x) (nd (code y) (nd (code a') (code b'))))
        ...
        s1   = skipAtTag (natCode tagAxI) (natCode_isValue tagAxI)       tagCode_axIfLfN payT b body_axI       next_axI
                  (teqDiff tagAxI       tagAxIfLfN refl)
        s2   = skipAtTag (natCode tagAxFst) (natCode_isValue tagAxFst)     tagCode_axIfLfN payT b body_axFst     next_axFst
                  (teqDiff tagAxFst     tagAxIfLfN refl)
        s3   = skipAtTag (natCode tagAxSnd) (natCode_isValue tagAxSnd)     tagCode_axIfLfN payT b body_axSnd     next_axSnd
                  (teqDiff tagAxSnd     tagAxIfLfN refl)
        s4   = skipAtTag (natCode tagAxConst) (natCode_isValue tagAxConst)   tagCode_axIfLfN payT b body_axConst   next_axConst
                  (teqDiff tagAxConst   tagAxIfLfN refl)
        s5   = skipAtTag (natCode tagAxComp) (natCode_isValue tagAxComp)    tagCode_axIfLfN payT b body_axComp    next_axComp
                  (teqDiff tagAxComp    tagAxIfLfN refl)
        s6   = skipAtTag (natCode tagAxComp2) (natCode_isValue tagAxComp2)   tagCode_axIfLfN payT b body_axComp2   next_axComp2
                  (teqDiff tagAxComp2   tagAxIfLfN refl)
        s7   = skipAtTag (natCode tagAxLift) (natCode_isValue tagAxLift)    tagCode_axIfLfN payT b body_axLift    next_axLift
                  (teqDiff tagAxLift    tagAxIfLfN refl)
        s8   = skipAtTag (natCode tagAxPost) (natCode_isValue tagAxPost)    tagCode_axIfLfN payT b body_axPost    next_axPost
                  (teqDiff tagAxPost    tagAxIfLfN refl)
        s9   = skipAtTag (natCode tagAxFan) (natCode_isValue tagAxFan)     tagCode_axIfLfN payT b body_axFan     next_axFan
                  (teqDiff tagAxFan     tagAxIfLfN refl)
        s10  = skipAtTag (natCode tagAxKT) (natCode_isValue tagAxKT)      tagCode_axIfLfN payT b body_axZ      next_axKT
                  (teqDiff tagAxKT      tagAxIfLfN refl)
        s15  = skipAtTag (natCode tagAxIfLfL) (natCode_isValue tagAxIfLfL)   tagCode_axIfLfN payT b body_axIfLfL   next_axIfLfL
                  (teqDiff tagAxIfLfL   tagAxIfLfN refl)
        hh   = hitAtTag (natCode tagAxIfLfN) (natCode_isValue tagAxIfLfN)   tagCode_axIfLfN payT b body_axIfLfN   next_axIfLfN
                  (teqEq tagAxIfLfN)
  ...
  body_axIfLfN_eval_param xT yT aT bT bb =
    let payX   = xT
        ...
        xy_KP    = pairOfConst_eval K_pairV K_pairV_isValue
                     (Fan (Lift (Comp Fst Snd))
                          (Lift (Comp Fst (Comp Snd Snd))) Pair)
                     a bb (ap2 Pair payX payY) xy_pair
        xy_full  = pairOfConst_eval K_a2V K_a2V_isValue
                     (Fan (Lift (KT K_pair))
                          (Fan (Lift (Comp Fst Snd))
                               (Lift (Comp Fst (Comp Snd Snd))) Pair)
                          Pair)
        ...
        ab_KP    = pairOfConst_eval K_pairV K_pairV_isValue
                     (Fan (Lift (Comp Fst (Comp Snd (Comp Snd Snd))))
                          (Lift (Comp Snd (Comp Snd (Comp Snd Snd)))) Pair)
                     a bb (ap2 Pair payAT payBT) ab_pair
        ab_full  = pairOfConst_eval K_a2V K_a2V_isValue
                     (Fan (Lift (KT K_pair))
                          (Fan (Lift (Comp Fst (Comp Snd (Comp Snd Snd))))
                               (Lift (Comp Snd (Comp Snd (Comp Snd Snd))))
                               Pair)
        ...
        xy_ab    = pairOfFan_eval
                     ...
                     xy_full ab_full
        ifLf_inner = pairOfConst_eval K_ifLfV K_ifLfV_isValue
                       (Fan (Fan (Lift (KT K_a2))
                                 (Fan (Lift (KT K_pair))
                                      (Fan (Lift (Comp Fst Snd))
                                           (Lift (Comp Fst (Comp Snd Snd)))
  ...
  thmTDispAxTreeEqNN a1 a2 b1 b2 =
    let payT = reify (nd (code a1) (nd (code a2) (nd (code b1) (code b2))))
        ...
        s1   = skipAtTag (natCode tagAxI) (natCode_isValue tagAxI)        tagCode_axTreeEqNN payT b body_axI        next_axI
                  (teqDiff tagAxI        tagAxTreeEqNN refl)
        s2   = skipAtTag (natCode tagAxFst) (natCode_isValue tagAxFst)      tagCode_axTreeEqNN payT b body_axFst      next_axFst
                  (teqDiff tagAxFst      tagAxTreeEqNN refl)
        s3   = skipAtTag (natCode tagAxSnd) (natCode_isValue tagAxSnd)      tagCode_axTreeEqNN payT b body_axSnd      next_axSnd
                  (teqDiff tagAxSnd      tagAxTreeEqNN refl)
        s4   = skipAtTag (natCode tagAxConst) (natCode_isValue tagAxConst)    tagCode_axTreeEqNN payT b body_axConst    next_axConst
                  (teqDiff tagAxConst    tagAxTreeEqNN refl)
        s5   = skipAtTag (natCode tagAxComp) (natCode_isValue tagAxComp)     tagCode_axTreeEqNN payT b body_axComp     next_axComp
                  (teqDiff tagAxComp     tagAxTreeEqNN refl)
        s6   = skipAtTag (natCode tagAxComp2) (natCode_isValue tagAxComp2)    tagCode_axTreeEqNN payT b body_axComp2    next_axComp2
                  (teqDiff tagAxComp2    tagAxTreeEqNN refl)
        s7   = skipAtTag (natCode tagAxLift) (natCode_isValue tagAxLift)     tagCode_axTreeEqNN payT b body_axLift     next_axLift
                  (teqDiff tagAxLift     tagAxTreeEqNN refl)
        s8   = skipAtTag (natCode tagAxPost) (natCode_isValue tagAxPost)     tagCode_axTreeEqNN payT b body_axPost     next_axPost
                  (teqDiff tagAxPost     tagAxTreeEqNN refl)
        s9   = skipAtTag (natCode tagAxFan) (natCode_isValue tagAxFan)      tagCode_axTreeEqNN payT b body_axFan      next_axFan
                  (teqDiff tagAxFan      tagAxTreeEqNN refl)
        s10  = skipAtTag (natCode tagAxKT) (natCode_isValue tagAxKT)       tagCode_axTreeEqNN payT b body_axZ       next_axKT
                  (teqDiff tagAxKT       tagAxTreeEqNN refl)
        s15  = skipAtTag (natCode tagAxIfLfL) (natCode_isValue tagAxIfLfL)    tagCode_axTreeEqNN payT b body_axIfLfL    next_axIfLfL
                  (teqDiff tagAxIfLfL    tagAxTreeEqNN refl)
        s16  = skipAtTag (natCode tagAxIfLfN) (natCode_isValue tagAxIfLfN)    tagCode_axTreeEqNN payT b body_axIfLfN    next_axIfLfN
                  (teqDiff tagAxIfLfN    tagAxTreeEqNN refl)
        s17  = skipAtTag (natCode tagAxTreeEqLL) (natCode_isValue tagAxTreeEqLL) tagCode_axTreeEqNN payT b body_axTreeEqLL next_axTreeEqLL
                  (teqDiff tagAxTreeEqLL tagAxTreeEqNN refl)
        s18  = skipAtTag (natCode tagAxTreeEqLN) (natCode_isValue tagAxTreeEqLN) tagCode_axTreeEqNN payT b body_axTreeEqLN next_axTreeEqLN
                  (teqDiff tagAxTreeEqLN tagAxTreeEqNN refl)
        s19  = skipAtTag (natCode tagAxTreeEqNL) (natCode_isValue tagAxTreeEqNL) tagCode_axTreeEqNN payT b body_axTreeEqNL next_axTreeEqNL
                  (teqDiff tagAxTreeEqNL tagAxTreeEqNN refl)
        hh   = hitAtTag (natCode tagAxTreeEqNN) (natCode_isValue tagAxTreeEqNN) tagCode_axTreeEqNN payT b body_axTreeEqNN next_axTreeEqNN
                  (teqEq tagAxTreeEqNN)
  ...
  thmTDispAxRefl t =
    let payT = reify (code t)
        ...
        s1   = skipAtTag (natCode tagAxI) (natCode_isValue tagAxI)         tagCode_axRefl payT b body_axI         next_axI
                  (teqDiff tagAxI         tagAxRefl refl)
        s2   = skipAtTag (natCode tagAxFst) (natCode_isValue tagAxFst)       tagCode_axRefl payT b body_axFst       next_axFst
                  (teqDiff tagAxFst       tagAxRefl refl)
        s3   = skipAtTag (natCode tagAxSnd) (natCode_isValue tagAxSnd)       tagCode_axRefl payT b body_axSnd       next_axSnd
                  (teqDiff tagAxSnd       tagAxRefl refl)
        s4   = skipAtTag (natCode tagAxConst) (natCode_isValue tagAxConst)     tagCode_axRefl payT b body_axConst     next_axConst
                  (teqDiff tagAxConst     tagAxRefl refl)
        s5   = skipAtTag (natCode tagAxComp) (natCode_isValue tagAxComp)      tagCode_axRefl payT b body_axComp      next_axComp
                  (teqDiff tagAxComp      tagAxRefl refl)
        s6   = skipAtTag (natCode tagAxComp2) (natCode_isValue tagAxComp2)     tagCode_axRefl payT b body_axComp2     next_axComp2
                  (teqDiff tagAxComp2     tagAxRefl refl)
        s7   = skipAtTag (natCode tagAxLift) (natCode_isValue tagAxLift)      tagCode_axRefl payT b body_axLift      next_axLift
                  (teqDiff tagAxLift      tagAxRefl refl)
        s8   = skipAtTag (natCode tagAxPost) (natCode_isValue tagAxPost)      tagCode_axRefl payT b body_axPost      next_axPost
                  (teqDiff tagAxPost      tagAxRefl refl)
        s9   = skipAtTag (natCode tagAxFan) (natCode_isValue tagAxFan)      tagCode_axRefl payT b body_axFan      next_axFan
                  (teqDiff tagAxFan      tagAxRefl refl)
        s10  = skipAtTag (natCode tagAxKT) (natCode_isValue tagAxKT)        tagCode_axRefl payT b body_axZ        next_axKT
                  (teqDiff tagAxKT        tagAxRefl refl)
        s15  = skipAtTag (natCode tagAxIfLfL) (natCode_isValue tagAxIfLfL)     tagCode_axRefl payT b body_axIfLfL     next_axIfLfL
                  (teqDiff tagAxIfLfL     tagAxRefl refl)
        s16  = skipAtTag (natCode tagAxIfLfN) (natCode_isValue tagAxIfLfN)     tagCode_axRefl payT b body_axIfLfN     next_axIfLfN
                  (teqDiff tagAxIfLfN     tagAxRefl refl)
        s17  = skipAtTag (natCode tagAxTreeEqLL) (natCode_isValue tagAxTreeEqLL)  tagCode_axRefl payT b body_axTreeEqLL  next_axTreeEqLL
                  (teqDiff tagAxTreeEqLL  tagAxRefl refl)
        s18  = skipAtTag (natCode tagAxTreeEqLN) (natCode_isValue tagAxTreeEqLN)  tagCode_axRefl payT b body_axTreeEqLN  next_axTreeEqLN
                  (teqDiff tagAxTreeEqLN  tagAxRefl refl)
        s19  = skipAtTag (natCode tagAxTreeEqNL) (natCode_isValue tagAxTreeEqNL)  tagCode_axRefl payT b body_axTreeEqNL  next_axTreeEqNL
                  (teqDiff tagAxTreeEqNL  tagAxRefl refl)
        s20  = skipAtTag (natCode tagAxTreeEqNN) (natCode_isValue tagAxTreeEqNN)  tagCode_axRefl payT b body_axTreeEqNN  next_axTreeEqNN
                  (teqDiff tagAxTreeEqNN  tagAxRefl refl)
        s21  = skipAtTag (natCode tagAxGoodstein) (natCode_isValue tagAxGoodstein) tagCode_axRefl payT b body_axGoodstein next_axGoodstein
                  (teqDiff tagAxGoodstein tagAxRefl refl)
        hh   = hitAtTag (natCode tagAxRefl) (natCode_isValue tagAxRefl)      tagCode_axRefl payT b body_axRefl      next_axRefl
                  (teqEq tagAxRefl)
  ...
  thmTDispAxEqTrans a' b' c' =
    let payT = reify (nd (code a') (nd (code b') (code c')))
        ...
        s1   = skipAtTag (natCode tagAxI) (natCode_isValue tagAxI)         tagCode_axEqTrans payT b body_axI         next_axI
                  (teqDiff tagAxI         tagAxEqTrans refl)
        s2   = skipAtTag (natCode tagAxFst) (natCode_isValue tagAxFst)       tagCode_axEqTrans payT b body_axFst       next_axFst
                  (teqDiff tagAxFst       tagAxEqTrans refl)
        s3   = skipAtTag (natCode tagAxSnd) (natCode_isValue tagAxSnd)       tagCode_axEqTrans payT b body_axSnd       next_axSnd
                  (teqDiff tagAxSnd       tagAxEqTrans refl)
        s4   = skipAtTag (natCode tagAxConst) (natCode_isValue tagAxConst)     tagCode_axEqTrans payT b body_axConst     next_axConst
                  (teqDiff tagAxConst     tagAxEqTrans refl)
        s5   = skipAtTag (natCode tagAxComp) (natCode_isValue tagAxComp)      tagCode_axEqTrans payT b body_axComp      next_axComp
                  (teqDiff tagAxComp      tagAxEqTrans refl)
        s6   = skipAtTag (natCode tagAxComp2) (natCode_isValue tagAxComp2)     tagCode_axEqTrans payT b body_axComp2     next_axComp2
                  (teqDiff tagAxComp2     tagAxEqTrans refl)
        s7   = skipAtTag (natCode tagAxLift) (natCode_isValue tagAxLift)      tagCode_axEqTrans payT b body_axLift      next_axLift
                  (teqDiff tagAxLift      tagAxEqTrans refl)
        s8   = skipAtTag (natCode tagAxPost) (natCode_isValue tagAxPost)      tagCode_axEqTrans payT b body_axPost      next_axPost
                  (teqDiff tagAxPost      tagAxEqTrans refl)
        s9   = skipAtTag (natCode tagAxFan) (natCode_isValue tagAxFan)       tagCode_axEqTrans payT b body_axFan       next_axFan
                  (teqDiff tagAxFan       tagAxEqTrans refl)
        s10  = skipAtTag (natCode tagAxKT) (natCode_isValue tagAxKT)        tagCode_axEqTrans payT b body_axZ        next_axKT
                  (teqDiff tagAxKT        tagAxEqTrans refl)
        s15  = skipAtTag (natCode tagAxIfLfL) (natCode_isValue tagAxIfLfL)     tagCode_axEqTrans payT b body_axIfLfL     next_axIfLfL
                  (teqDiff tagAxIfLfL     tagAxEqTrans refl)
        s16  = skipAtTag (natCode tagAxIfLfN) (natCode_isValue tagAxIfLfN)     tagCode_axEqTrans payT b body_axIfLfN     next_axIfLfN
                  (teqDiff tagAxIfLfN     tagAxEqTrans refl)
        s17  = skipAtTag (natCode tagAxTreeEqLL) (natCode_isValue tagAxTreeEqLL)  tagCode_axEqTrans payT b body_axTreeEqLL  next_axTreeEqLL
                  (teqDiff tagAxTreeEqLL  tagAxEqTrans refl)
        s18  = skipAtTag (natCode tagAxTreeEqLN) (natCode_isValue tagAxTreeEqLN)  tagCode_axEqTrans payT b body_axTreeEqLN  next_axTreeEqLN
                  (teqDiff tagAxTreeEqLN  tagAxEqTrans refl)
        s19  = skipAtTag (natCode tagAxTreeEqNL) (natCode_isValue tagAxTreeEqNL)  tagCode_axEqTrans payT b body_axTreeEqNL  next_axTreeEqNL
                  (teqDiff tagAxTreeEqNL  tagAxEqTrans refl)
        s20  = skipAtTag (natCode tagAxTreeEqNN) (natCode_isValue tagAxTreeEqNN)  tagCode_axEqTrans payT b body_axTreeEqNN  next_axTreeEqNN
                  (teqDiff tagAxTreeEqNN  tagAxEqTrans refl)
        s21  = skipAtTag (natCode tagAxGoodstein) (natCode_isValue tagAxGoodstein) tagCode_axEqTrans payT b body_axGoodstein next_axGoodstein
                  (teqDiff tagAxGoodstein tagAxEqTrans refl)
        s22  = skipAtTag (natCode tagAxRefl) (natCode_isValue tagAxRefl)      tagCode_axEqTrans payT b body_axRefl      next_axRefl
                  (teqDiff tagAxRefl      tagAxEqTrans refl)
        s23  = skipAtTag (natCode tagRuleSym) (natCode_isValue tagRuleSym)     tagCode_axEqTrans payT b body_ruleSym     next_ruleSym
                  (teqDiff tagRuleSym     tagAxEqTrans refl)
        s24  = skipAtTag (natCode tagRuleTrans) (natCode_isValue tagRuleTrans)   tagCode_axEqTrans payT b body_ruleTrans   next_ruleTrans
                  (teqDiff tagRuleTrans   tagAxEqTrans refl)
        s25  = skipAtTag (natCode tagCong1) (natCode_isValue tagCong1)       tagCode_axEqTrans payT b body_cong1       next_cong1
                  (teqDiff tagCong1       tagAxEqTrans refl)
        s26  = skipAtTag (natCode tagCongL) (natCode_isValue tagCongL)       tagCode_axEqTrans payT b body_congL       next_congL
                  (teqDiff tagCongL       tagAxEqTrans refl)
        s27  = skipAtTag (natCode tagCongR) (natCode_isValue tagCongR)       tagCode_axEqTrans payT b body_congR       next_congR
                  (teqDiff tagCongR       tagAxEqTrans refl)
        hh   = hitAtTag (natCode tagAxEqTrans) (natCode_isValue tagAxEqTrans)   tagCode_axEqTrans payT b body_axEqTrans   next_axEqTrans
                  (teqEq tagAxEqTrans)
  ...
  thmTDispAxEqCong1 f a' b' =
    let payT = reify (nd (codeF1 f) (nd (code a') (code b')))
        ...
        s1   = skipAtTag (natCode tagAxI) (natCode_isValue tagAxI)         tagCode_axEqCong1 payT b body_axI         next_axI
                  (teqDiff tagAxI         tagAxEqCong1 refl)
        s2   = skipAtTag (natCode tagAxFst) (natCode_isValue tagAxFst)       tagCode_axEqCong1 payT b body_axFst       next_axFst
                  (teqDiff tagAxFst       tagAxEqCong1 refl)
        s3   = skipAtTag (natCode tagAxSnd) (natCode_isValue tagAxSnd)       tagCode_axEqCong1 payT b body_axSnd       next_axSnd
                  (teqDiff tagAxSnd       tagAxEqCong1 refl)
        s4   = skipAtTag (natCode tagAxConst) (natCode_isValue tagAxConst)     tagCode_axEqCong1 payT b body_axConst     next_axConst
                  (teqDiff tagAxConst     tagAxEqCong1 refl)
        s5   = skipAtTag (natCode tagAxComp) (natCode_isValue tagAxComp)      tagCode_axEqCong1 payT b body_axComp      next_axComp
                  (teqDiff tagAxComp      tagAxEqCong1 refl)
        s6   = skipAtTag (natCode tagAxComp2) (natCode_isValue tagAxComp2)     tagCode_axEqCong1 payT b body_axComp2     next_axComp2
                  (teqDiff tagAxComp2     tagAxEqCong1 refl)
        s7   = skipAtTag (natCode tagAxLift) (natCode_isValue tagAxLift)      tagCode_axEqCong1 payT b body_axLift      next_axLift
                  (teqDiff tagAxLift      tagAxEqCong1 refl)
        s8   = skipAtTag (natCode tagAxPost) (natCode_isValue tagAxPost)      tagCode_axEqCong1 payT b body_axPost      next_axPost
                  (teqDiff tagAxPost      tagAxEqCong1 refl)
        s9   = skipAtTag (natCode tagAxFan) (natCode_isValue tagAxFan)       tagCode_axEqCong1 payT b body_axFan       next_axFan
                  (teqDiff tagAxFan       tagAxEqCong1 refl)
        s10  = skipAtTag (natCode tagAxKT) (natCode_isValue tagAxKT)        tagCode_axEqCong1 payT b body_axZ        next_axKT
                  (teqDiff tagAxKT        tagAxEqCong1 refl)
        s15  = skipAtTag (natCode tagAxIfLfL) (natCode_isValue tagAxIfLfL)     tagCode_axEqCong1 payT b body_axIfLfL     next_axIfLfL
                  (teqDiff tagAxIfLfL     tagAxEqCong1 refl)
        s16  = skipAtTag (natCode tagAxIfLfN) (natCode_isValue tagAxIfLfN)     tagCode_axEqCong1 payT b body_axIfLfN     next_axIfLfN
                  (teqDiff tagAxIfLfN     tagAxEqCong1 refl)
        s17  = skipAtTag (natCode tagAxTreeEqLL) (natCode_isValue tagAxTreeEqLL)  tagCode_axEqCong1 payT b body_axTreeEqLL  next_axTreeEqLL
                  (teqDiff tagAxTreeEqLL  tagAxEqCong1 refl)
        s18  = skipAtTag (natCode tagAxTreeEqLN) (natCode_isValue tagAxTreeEqLN)  tagCode_axEqCong1 payT b body_axTreeEqLN  next_axTreeEqLN
                  (teqDiff tagAxTreeEqLN  tagAxEqCong1 refl)
        s19  = skipAtTag (natCode tagAxTreeEqNL) (natCode_isValue tagAxTreeEqNL)  tagCode_axEqCong1 payT b body_axTreeEqNL  next_axTreeEqNL
                  (teqDiff tagAxTreeEqNL  tagAxEqCong1 refl)
        s20  = skipAtTag (natCode tagAxTreeEqNN) (natCode_isValue tagAxTreeEqNN)  tagCode_axEqCong1 payT b body_axTreeEqNN  next_axTreeEqNN
                  (teqDiff tagAxTreeEqNN  tagAxEqCong1 refl)
        s21  = skipAtTag (natCode tagAxGoodstein) (natCode_isValue tagAxGoodstein) tagCode_axEqCong1 payT b body_axGoodstein next_axGoodstein
                  (teqDiff tagAxGoodstein tagAxEqCong1 refl)
        s22  = skipAtTag (natCode tagAxRefl) (natCode_isValue tagAxRefl)      tagCode_axEqCong1 payT b body_axRefl      next_axRefl
                  (teqDiff tagAxRefl      tagAxEqCong1 refl)
        s23  = skipAtTag (natCode tagRuleSym) (natCode_isValue tagRuleSym)     tagCode_axEqCong1 payT b body_ruleSym     next_ruleSym
                  (teqDiff tagRuleSym     tagAxEqCong1 refl)
        s24  = skipAtTag (natCode tagRuleTrans) (natCode_isValue tagRuleTrans)   tagCode_axEqCong1 payT b body_ruleTrans   next_ruleTrans
                  (teqDiff tagRuleTrans   tagAxEqCong1 refl)
        s25  = skipAtTag (natCode tagCong1) (natCode_isValue tagCong1)       tagCode_axEqCong1 payT b body_cong1       next_cong1
                  (teqDiff tagCong1       tagAxEqCong1 refl)
        s26  = skipAtTag (natCode tagCongL) (natCode_isValue tagCongL)       tagCode_axEqCong1 payT b body_congL       next_congL
                  (teqDiff tagCongL       tagAxEqCong1 refl)
        s27  = skipAtTag (natCode tagCongR) (natCode_isValue tagCongR)       tagCode_axEqCong1 payT b body_congR       next_congR
                  (teqDiff tagCongR       tagAxEqCong1 refl)
        s28  = skipAtTag (natCode tagAxEqTrans) (natCode_isValue tagAxEqTrans)   tagCode_axEqCong1 payT b body_axEqTrans   next_axEqTrans
                  (teqDiff tagAxEqTrans   tagAxEqCong1 refl)
        hh   = hitAtTag (natCode tagAxEqCong1) (natCode_isValue tagAxEqCong1)   tagCode_axEqCong1 payT b body_axEqCong1   next_axEqCong1
                  (teqEq tagAxEqCong1)
  ...
  thmTDispAxEqCongL g a' b' c' =
    let payT = reify (nd (codeF2 g) (nd (code a') (nd (code b') (code c'))))
        ...
        s1   = skipAtTag (natCode tagAxI) (natCode_isValue tagAxI)         tagCode_axEqCongL payT b body_axI         next_axI
                  (teqDiff tagAxI         tagAxEqCongL refl)
        s2   = skipAtTag (natCode tagAxFst) (natCode_isValue tagAxFst)       tagCode_axEqCongL payT b body_axFst       next_axFst
                  (teqDiff tagAxFst       tagAxEqCongL refl)
        s3   = skipAtTag (natCode tagAxSnd) (natCode_isValue tagAxSnd)       tagCode_axEqCongL payT b body_axSnd       next_axSnd
                  (teqDiff tagAxSnd       tagAxEqCongL refl)
        s4   = skipAtTag (natCode tagAxConst) (natCode_isValue tagAxConst)     tagCode_axEqCongL payT b body_axConst     next_axConst
                  (teqDiff tagAxConst     tagAxEqCongL refl)
        s5   = skipAtTag (natCode tagAxComp) (natCode_isValue tagAxComp)      tagCode_axEqCongL payT b body_axComp      next_axComp
                  (teqDiff tagAxComp      tagAxEqCongL refl)
        s6   = skipAtTag (natCode tagAxComp2) (natCode_isValue tagAxComp2)     tagCode_axEqCongL payT b body_axComp2     next_axComp2
                  (teqDiff tagAxComp2     tagAxEqCongL refl)
        s7   = skipAtTag (natCode tagAxLift) (natCode_isValue tagAxLift)      tagCode_axEqCongL payT b body_axLift      next_axLift
                  (teqDiff tagAxLift      tagAxEqCongL refl)
        s8   = skipAtTag (natCode tagAxPost) (natCode_isValue tagAxPost)      tagCode_axEqCongL payT b body_axPost      next_axPost
                  (teqDiff tagAxPost      tagAxEqCongL refl)
        s9   = skipAtTag (natCode tagAxFan) (natCode_isValue tagAxFan)       tagCode_axEqCongL payT b body_axFan       next_axFan
                  (teqDiff tagAxFan       tagAxEqCongL refl)
        s10  = skipAtTag (natCode tagAxKT) (natCode_isValue tagAxKT)        tagCode_axEqCongL payT b body_axZ        next_axKT
                  (teqDiff tagAxKT        tagAxEqCongL refl)
        s15  = skipAtTag (natCode tagAxIfLfL) (natCode_isValue tagAxIfLfL)     tagCode_axEqCongL payT b body_axIfLfL     next_axIfLfL
                  (teqDiff tagAxIfLfL     tagAxEqCongL refl)
        s16  = skipAtTag (natCode tagAxIfLfN) (natCode_isValue tagAxIfLfN)     tagCode_axEqCongL payT b body_axIfLfN     next_axIfLfN
                  (teqDiff tagAxIfLfN     tagAxEqCongL refl)
        s17  = skipAtTag (natCode tagAxTreeEqLL) (natCode_isValue tagAxTreeEqLL)  tagCode_axEqCongL payT b body_axTreeEqLL  next_axTreeEqLL
                  (teqDiff tagAxTreeEqLL  tagAxEqCongL refl)
        s18  = skipAtTag (natCode tagAxTreeEqLN) (natCode_isValue tagAxTreeEqLN)  tagCode_axEqCongL payT b body_axTreeEqLN  next_axTreeEqLN
                  (teqDiff tagAxTreeEqLN  tagAxEqCongL refl)
        s19  = skipAtTag (natCode tagAxTreeEqNL) (natCode_isValue tagAxTreeEqNL)  tagCode_axEqCongL payT b body_axTreeEqNL  next_axTreeEqNL
                  (teqDiff tagAxTreeEqNL  tagAxEqCongL refl)
        s20  = skipAtTag (natCode tagAxTreeEqNN) (natCode_isValue tagAxTreeEqNN)  tagCode_axEqCongL payT b body_axTreeEqNN  next_axTreeEqNN
                  (teqDiff tagAxTreeEqNN  tagAxEqCongL refl)
        s21  = skipAtTag (natCode tagAxGoodstein) (natCode_isValue tagAxGoodstein) tagCode_axEqCongL payT b body_axGoodstein next_axGoodstein
                  (teqDiff tagAxGoodstein tagAxEqCongL refl)
        s22  = skipAtTag (natCode tagAxRefl) (natCode_isValue tagAxRefl)      tagCode_axEqCongL payT b body_axRefl      next_axRefl
                  (teqDiff tagAxRefl      tagAxEqCongL refl)
        s23  = skipAtTag (natCode tagRuleSym) (natCode_isValue tagRuleSym)     tagCode_axEqCongL payT b body_ruleSym     next_ruleSym
                  (teqDiff tagRuleSym     tagAxEqCongL refl)
        s24  = skipAtTag (natCode tagRuleTrans) (natCode_isValue tagRuleTrans)   tagCode_axEqCongL payT b body_ruleTrans   next_ruleTrans
                  (teqDiff tagRuleTrans   tagAxEqCongL refl)
        s25  = skipAtTag (natCode tagCong1) (natCode_isValue tagCong1)       tagCode_axEqCongL payT b body_cong1       next_cong1
                  (teqDiff tagCong1       tagAxEqCongL refl)
        s26  = skipAtTag (natCode tagCongL) (natCode_isValue tagCongL)       tagCode_axEqCongL payT b body_congL       next_congL
                  (teqDiff tagCongL       tagAxEqCongL refl)
        s27  = skipAtTag (natCode tagCongR) (natCode_isValue tagCongR)       tagCode_axEqCongL payT b body_congR       next_congR
                  (teqDiff tagCongR       tagAxEqCongL refl)
        s28  = skipAtTag (natCode tagAxEqTrans) (natCode_isValue tagAxEqTrans)   tagCode_axEqCongL payT b body_axEqTrans   next_axEqTrans
                  (teqDiff tagAxEqTrans   tagAxEqCongL refl)
        s29  = skipAtTag (natCode tagAxEqCong1) (natCode_isValue tagAxEqCong1)   tagCode_axEqCongL payT b body_axEqCong1   next_axEqCong1
                  (teqDiff tagAxEqCong1   tagAxEqCongL refl)
        hh   = hitAtTag (natCode tagAxEqCongL) (natCode_isValue tagAxEqCongL)   tagCode_axEqCongL payT b body_axEqCongL   next_axEqCongL
                  (teqEq tagAxEqCongL)
  ...
  thmTDispAxEqCongR g a' b' c' =
    let payT = reify (nd (codeF2 g) (nd (code a') (nd (code b') (code c'))))
        ...
        s1   = skipAtTag (natCode tagAxI) (natCode_isValue tagAxI)         tagCode_axEqCongR payT b body_axI         next_axI
                  (teqDiff tagAxI         tagAxEqCongR refl)
        s2   = skipAtTag (natCode tagAxFst) (natCode_isValue tagAxFst)       tagCode_axEqCongR payT b body_axFst       next_axFst
                  (teqDiff tagAxFst       tagAxEqCongR refl)
        s3   = skipAtTag (natCode tagAxSnd) (natCode_isValue tagAxSnd)       tagCode_axEqCongR payT b body_axSnd       next_axSnd
                  (teqDiff tagAxSnd       tagAxEqCongR refl)
        s4   = skipAtTag (natCode tagAxConst) (natCode_isValue tagAxConst)     tagCode_axEqCongR payT b body_axConst     next_axConst
                  (teqDiff tagAxConst     tagAxEqCongR refl)
        s5   = skipAtTag (natCode tagAxComp) (natCode_isValue tagAxComp)      tagCode_axEqCongR payT b body_axComp      next_axComp
                  (teqDiff tagAxComp      tagAxEqCongR refl)
        s6   = skipAtTag (natCode tagAxComp2) (natCode_isValue tagAxComp2)     tagCode_axEqCongR payT b body_axComp2     next_axComp2
                  (teqDiff tagAxComp2     tagAxEqCongR refl)
        s7   = skipAtTag (natCode tagAxLift) (natCode_isValue tagAxLift)      tagCode_axEqCongR payT b body_axLift      next_axLift
                  (teqDiff tagAxLift      tagAxEqCongR refl)
        s8   = skipAtTag (natCode tagAxPost) (natCode_isValue tagAxPost)      tagCode_axEqCongR payT b body_axPost      next_axPost
                  (teqDiff tagAxPost      tagAxEqCongR refl)
        s9   = skipAtTag (natCode tagAxFan) (natCode_isValue tagAxFan)       tagCode_axEqCongR payT b body_axFan       next_axFan
                  (teqDiff tagAxFan       tagAxEqCongR refl)
        s10  = skipAtTag (natCode tagAxKT) (natCode_isValue tagAxKT)        tagCode_axEqCongR payT b body_axZ        next_axKT
                  (teqDiff tagAxKT        tagAxEqCongR refl)
        s15  = skipAtTag (natCode tagAxIfLfL) (natCode_isValue tagAxIfLfL)     tagCode_axEqCongR payT b body_axIfLfL     next_axIfLfL
                  (teqDiff tagAxIfLfL     tagAxEqCongR refl)
        s16  = skipAtTag (natCode tagAxIfLfN) (natCode_isValue tagAxIfLfN)     tagCode_axEqCongR payT b body_axIfLfN     next_axIfLfN
                  (teqDiff tagAxIfLfN     tagAxEqCongR refl)
        s17  = skipAtTag (natCode tagAxTreeEqLL) (natCode_isValue tagAxTreeEqLL)  tagCode_axEqCongR payT b body_axTreeEqLL  next_axTreeEqLL
                  (teqDiff tagAxTreeEqLL  tagAxEqCongR refl)
        s18  = skipAtTag (natCode tagAxTreeEqLN) (natCode_isValue tagAxTreeEqLN)  tagCode_axEqCongR payT b body_axTreeEqLN  next_axTreeEqLN
                  (teqDiff tagAxTreeEqLN  tagAxEqCongR refl)
        s19  = skipAtTag (natCode tagAxTreeEqNL) (natCode_isValue tagAxTreeEqNL)  tagCode_axEqCongR payT b body_axTreeEqNL  next_axTreeEqNL
                  (teqDiff tagAxTreeEqNL  tagAxEqCongR refl)
        s20  = skipAtTag (natCode tagAxTreeEqNN) (natCode_isValue tagAxTreeEqNN)  tagCode_axEqCongR payT b body_axTreeEqNN  next_axTreeEqNN
                  (teqDiff tagAxTreeEqNN  tagAxEqCongR refl)
        s21  = skipAtTag (natCode tagAxGoodstein) (natCode_isValue tagAxGoodstein) tagCode_axEqCongR payT b body_axGoodstein next_axGoodstein
                  (teqDiff tagAxGoodstein tagAxEqCongR refl)
        s22  = skipAtTag (natCode tagAxRefl) (natCode_isValue tagAxRefl)      tagCode_axEqCongR payT b body_axRefl      next_axRefl
                  (teqDiff tagAxRefl      tagAxEqCongR refl)
        s23  = skipAtTag (natCode tagRuleSym) (natCode_isValue tagRuleSym)     tagCode_axEqCongR payT b body_ruleSym     next_ruleSym
                  (teqDiff tagRuleSym     tagAxEqCongR refl)
        s24  = skipAtTag (natCode tagRuleTrans) (natCode_isValue tagRuleTrans)   tagCode_axEqCongR payT b body_ruleTrans   next_ruleTrans
                  (teqDiff tagRuleTrans   tagAxEqCongR refl)
        s25  = skipAtTag (natCode tagCong1) (natCode_isValue tagCong1)       tagCode_axEqCongR payT b body_cong1       next_cong1
                  (teqDiff tagCong1       tagAxEqCongR refl)
        s26  = skipAtTag (natCode tagCongL) (natCode_isValue tagCongL)       tagCode_axEqCongR payT b body_congL       next_congL
                  (teqDiff tagCongL       tagAxEqCongR refl)
        s27  = skipAtTag (natCode tagCongR) (natCode_isValue tagCongR)       tagCode_axEqCongR payT b body_congR       next_congR
                  (teqDiff tagCongR       tagAxEqCongR refl)
        s28  = skipAtTag (natCode tagAxEqTrans) (natCode_isValue tagAxEqTrans)   tagCode_axEqCongR payT b body_axEqTrans   next_axEqTrans
                  (teqDiff tagAxEqTrans   tagAxEqCongR refl)
        s29  = skipAtTag (natCode tagAxEqCong1) (natCode_isValue tagAxEqCong1)   tagCode_axEqCongR payT b body_axEqCong1   next_axEqCong1
                  (teqDiff tagAxEqCong1   tagAxEqCongR refl)
        s30  = skipAtTag (natCode tagAxEqCongL) (natCode_isValue tagAxEqCongL)   tagCode_axEqCongR payT b body_axEqCongL   next_axEqCongL
                  (teqDiff tagAxEqCongL   tagAxEqCongR refl)
        hh   = hitAtTag (natCode tagAxEqCongR) (natCode_isValue tagAxEqCongR)   tagCode_axEqCongR payT b body_axEqCongR   next_axEqCongR
                  (teqEq tagAxEqCongR)
  ...
  thmTDispAxK P Q =
    let payT = reify (nd (codeFormula P) (codeFormula Q))
        ...
        s1   = skipAtTag (natCode tagAxI) (natCode_isValue tagAxI)         tagCode_axK payT b body_axI         next_axI
                  (teqDiff tagAxI         tagAxK refl)
        s2   = skipAtTag (natCode tagAxFst) (natCode_isValue tagAxFst)       tagCode_axK payT b body_axFst       next_axFst
                  (teqDiff tagAxFst       tagAxK refl)
        s3   = skipAtTag (natCode tagAxSnd) (natCode_isValue tagAxSnd)       tagCode_axK payT b body_axSnd       next_axSnd
                  (teqDiff tagAxSnd       tagAxK refl)
        s4   = skipAtTag (natCode tagAxConst) (natCode_isValue tagAxConst)     tagCode_axK payT b body_axConst     next_axConst
                  (teqDiff tagAxConst     tagAxK refl)
        s5   = skipAtTag (natCode tagAxComp) (natCode_isValue tagAxComp)      tagCode_axK payT b body_axComp      next_axComp
                  (teqDiff tagAxComp      tagAxK refl)
        s6   = skipAtTag (natCode tagAxComp2) (natCode_isValue tagAxComp2)     tagCode_axK payT b body_axComp2     next_axComp2
                  (teqDiff tagAxComp2     tagAxK refl)
        s7   = skipAtTag (natCode tagAxLift) (natCode_isValue tagAxLift)      tagCode_axK payT b body_axLift      next_axLift
                  (teqDiff tagAxLift      tagAxK refl)
        s8   = skipAtTag (natCode tagAxPost) (natCode_isValue tagAxPost)      tagCode_axK payT b body_axPost      next_axPost
                  (teqDiff tagAxPost      tagAxK refl)
        s9   = skipAtTag (natCode tagAxFan) (natCode_isValue tagAxFan)       tagCode_axK payT b body_axFan       next_axFan
                  (teqDiff tagAxFan       tagAxK refl)
        s10  = skipAtTag (natCode tagAxKT) (natCode_isValue tagAxKT)        tagCode_axK payT b body_axZ        next_axKT
                  (teqDiff tagAxKT        tagAxK refl)
        s15  = skipAtTag (natCode tagAxIfLfL) (natCode_isValue tagAxIfLfL)     tagCode_axK payT b body_axIfLfL     next_axIfLfL
                  (teqDiff tagAxIfLfL     tagAxK refl)
        s16  = skipAtTag (natCode tagAxIfLfN) (natCode_isValue tagAxIfLfN)     tagCode_axK payT b body_axIfLfN     next_axIfLfN
                  (teqDiff tagAxIfLfN     tagAxK refl)
        s17  = skipAtTag (natCode tagAxTreeEqLL) (natCode_isValue tagAxTreeEqLL)  tagCode_axK payT b body_axTreeEqLL  next_axTreeEqLL
                  (teqDiff tagAxTreeEqLL  tagAxK refl)
        s18  = skipAtTag (natCode tagAxTreeEqLN) (natCode_isValue tagAxTreeEqLN)  tagCode_axK payT b body_axTreeEqLN  next_axTreeEqLN
                  (teqDiff tagAxTreeEqLN  tagAxK refl)
        s19  = skipAtTag (natCode tagAxTreeEqNL) (natCode_isValue tagAxTreeEqNL)  tagCode_axK payT b body_axTreeEqNL  next_axTreeEqNL
                  (teqDiff tagAxTreeEqNL  tagAxK refl)
        s20  = skipAtTag (natCode tagAxTreeEqNN) (natCode_isValue tagAxTreeEqNN)  tagCode_axK payT b body_axTreeEqNN  next_axTreeEqNN
                  (teqDiff tagAxTreeEqNN  tagAxK refl)
        s21  = skipAtTag (natCode tagAxGoodstein) (natCode_isValue tagAxGoodstein) tagCode_axK payT b body_axGoodstein next_axGoodstein
                  (teqDiff tagAxGoodstein tagAxK refl)
        s22  = skipAtTag (natCode tagAxRefl) (natCode_isValue tagAxRefl)      tagCode_axK payT b body_axRefl      next_axRefl
                  (teqDiff tagAxRefl      tagAxK refl)
        s23  = skipAtTag (natCode tagRuleSym) (natCode_isValue tagRuleSym)     tagCode_axK payT b body_ruleSym     next_ruleSym
                  (teqDiff tagRuleSym     tagAxK refl)
        s24  = skipAtTag (natCode tagRuleTrans) (natCode_isValue tagRuleTrans)   tagCode_axK payT b body_ruleTrans   next_ruleTrans
                  (teqDiff tagRuleTrans   tagAxK refl)
        s25  = skipAtTag (natCode tagCong1) (natCode_isValue tagCong1)       tagCode_axK payT b body_cong1       next_cong1
                  (teqDiff tagCong1       tagAxK refl)
        s26  = skipAtTag (natCode tagCongL) (natCode_isValue tagCongL)       tagCode_axK payT b body_congL       next_congL
                  (teqDiff tagCongL       tagAxK refl)
        s27  = skipAtTag (natCode tagCongR) (natCode_isValue tagCongR)       tagCode_axK payT b body_congR       next_congR
                  (teqDiff tagCongR       tagAxK refl)
        s28  = skipAtTag (natCode tagAxEqTrans) (natCode_isValue tagAxEqTrans)   tagCode_axK payT b body_axEqTrans   next_axEqTrans
                  (teqDiff tagAxEqTrans   tagAxK refl)
        s29  = skipAtTag (natCode tagAxEqCong1) (natCode_isValue tagAxEqCong1)   tagCode_axK payT b body_axEqCong1   next_axEqCong1
                  (teqDiff tagAxEqCong1   tagAxK refl)
        s30  = skipAtTag (natCode tagAxEqCongL) (natCode_isValue tagAxEqCongL)   tagCode_axK payT b body_axEqCongL   next_axEqCongL
                  (teqDiff tagAxEqCongL   tagAxK refl)
        s31  = skipAtTag (natCode tagAxEqCongR) (natCode_isValue tagAxEqCongR)   tagCode_axK payT b body_axEqCongR   next_axEqCongR
                  (teqDiff tagAxEqCongR   tagAxK refl)
        hh   = hitAtTag (natCode tagAxK) (natCode_isValue tagAxK)         tagCode_axK payT b body_axK         next_axK
                  (teqEq tagAxK)
  ...
  thmTDispAxS P Q R =
    let payT = reify (nd (codeFormula P) (nd (codeFormula Q) (codeFormula R)))
        ...
        s1   = skipAtTag (natCode tagAxI) (natCode_isValue tagAxI)         tagCode_axS payT b body_axI         next_axI
                  (teqDiff tagAxI         tagAxS refl)
        s2   = skipAtTag (natCode tagAxFst) (natCode_isValue tagAxFst)       tagCode_axS payT b body_axFst       next_axFst
                  (teqDiff tagAxFst       tagAxS refl)
        s3   = skipAtTag (natCode tagAxSnd) (natCode_isValue tagAxSnd)       tagCode_axS payT b body_axSnd       next_axSnd
                  (teqDiff tagAxSnd       tagAxS refl)
        s4   = skipAtTag (natCode tagAxConst) (natCode_isValue tagAxConst)     tagCode_axS payT b body_axConst     next_axConst
                  (teqDiff tagAxConst     tagAxS refl)
        s5   = skipAtTag (natCode tagAxComp) (natCode_isValue tagAxComp)      tagCode_axS payT b body_axComp      next_axComp
                  (teqDiff tagAxComp      tagAxS refl)
        s6   = skipAtTag (natCode tagAxComp2) (natCode_isValue tagAxComp2)     tagCode_axS payT b body_axComp2     next_axComp2
                  (teqDiff tagAxComp2     tagAxS refl)
        s7   = skipAtTag (natCode tagAxLift) (natCode_isValue tagAxLift)      tagCode_axS payT b body_axLift      next_axLift
                  (teqDiff tagAxLift      tagAxS refl)
        s8   = skipAtTag (natCode tagAxPost) (natCode_isValue tagAxPost)      tagCode_axS payT b body_axPost      next_axPost
                  (teqDiff tagAxPost      tagAxS refl)
        s9   = skipAtTag (natCode tagAxFan) (natCode_isValue tagAxFan)       tagCode_axS payT b body_axFan       next_axFan
                  (teqDiff tagAxFan       tagAxS refl)
        s10  = skipAtTag (natCode tagAxKT) (natCode_isValue tagAxKT)        tagCode_axS payT b body_axZ        next_axKT
                  (teqDiff tagAxKT        tagAxS refl)
        s15  = skipAtTag (natCode tagAxIfLfL) (natCode_isValue tagAxIfLfL)     tagCode_axS payT b body_axIfLfL     next_axIfLfL
                  (teqDiff tagAxIfLfL     tagAxS refl)
        s16  = skipAtTag (natCode tagAxIfLfN) (natCode_isValue tagAxIfLfN)     tagCode_axS payT b body_axIfLfN     next_axIfLfN
                  (teqDiff tagAxIfLfN     tagAxS refl)
        s17  = skipAtTag (natCode tagAxTreeEqLL) (natCode_isValue tagAxTreeEqLL)  tagCode_axS payT b body_axTreeEqLL  next_axTreeEqLL
                  (teqDiff tagAxTreeEqLL  tagAxS refl)
        s18  = skipAtTag (natCode tagAxTreeEqLN) (natCode_isValue tagAxTreeEqLN)  tagCode_axS payT b body_axTreeEqLN  next_axTreeEqLN
                  (teqDiff tagAxTreeEqLN  tagAxS refl)
        s19  = skipAtTag (natCode tagAxTreeEqNL) (natCode_isValue tagAxTreeEqNL)  tagCode_axS payT b body_axTreeEqNL  next_axTreeEqNL
                  (teqDiff tagAxTreeEqNL  tagAxS refl)
        s20  = skipAtTag (natCode tagAxTreeEqNN) (natCode_isValue tagAxTreeEqNN)  tagCode_axS payT b body_axTreeEqNN  next_axTreeEqNN
                  (teqDiff tagAxTreeEqNN  tagAxS refl)
        s21  = skipAtTag (natCode tagAxGoodstein) (natCode_isValue tagAxGoodstein) tagCode_axS payT b body_axGoodstein next_axGoodstein
                  (teqDiff tagAxGoodstein tagAxS refl)
        s22  = skipAtTag (natCode tagAxRefl) (natCode_isValue tagAxRefl)      tagCode_axS payT b body_axRefl      next_axRefl
                  (teqDiff tagAxRefl      tagAxS refl)
        s23  = skipAtTag (natCode tagRuleSym) (natCode_isValue tagRuleSym)     tagCode_axS payT b body_ruleSym     next_ruleSym
                  (teqDiff tagRuleSym     tagAxS refl)
        s24  = skipAtTag (natCode tagRuleTrans) (natCode_isValue tagRuleTrans)   tagCode_axS payT b body_ruleTrans   next_ruleTrans
                  (teqDiff tagRuleTrans   tagAxS refl)
        s25  = skipAtTag (natCode tagCong1) (natCode_isValue tagCong1)       tagCode_axS payT b body_cong1       next_cong1
                  (teqDiff tagCong1       tagAxS refl)
        s26  = skipAtTag (natCode tagCongL) (natCode_isValue tagCongL)       tagCode_axS payT b body_congL       next_congL
                  (teqDiff tagCongL       tagAxS refl)
        s27  = skipAtTag (natCode tagCongR) (natCode_isValue tagCongR)       tagCode_axS payT b body_congR       next_congR
                  (teqDiff tagCongR       tagAxS refl)
        s28  = skipAtTag (natCode tagAxEqTrans) (natCode_isValue tagAxEqTrans)   tagCode_axS payT b body_axEqTrans   next_axEqTrans
                  (teqDiff tagAxEqTrans   tagAxS refl)
        s29  = skipAtTag (natCode tagAxEqCong1) (natCode_isValue tagAxEqCong1)   tagCode_axS payT b body_axEqCong1   next_axEqCong1
                  (teqDiff tagAxEqCong1   tagAxS refl)
        s30  = skipAtTag (natCode tagAxEqCongL) (natCode_isValue tagAxEqCongL)   tagCode_axS payT b body_axEqCongL   next_axEqCongL
                  (teqDiff tagAxEqCongL   tagAxS refl)
        s31  = skipAtTag (natCode tagAxEqCongR) (natCode_isValue tagAxEqCongR)   tagCode_axS payT b body_axEqCongR   next_axEqCongR
                  (teqDiff tagAxEqCongR   tagAxS refl)
        s32  = skipAtTag (natCode tagAxK) (natCode_isValue tagAxK)         tagCode_axS payT b body_axK         next_axK
                  (teqDiff tagAxK         tagAxS refl)
        hh   = hitAtTag (natCode tagAxS) (natCode_isValue tagAxS)         tagCode_axS payT b body_axS         next_axS
                  (teqEq tagAxS)
  ...
  body_axNeg_eval P Q bb =
    let payP   = reify (codeFormula P)
        ...
        negP   = pairOfConst_eval K_negV K_negV_isValue (Lift (Comp Fst Snd)) a bb payP ext_p
        negQ   = pairOfConst_eval K_negV K_negV_isValue (Lift (Comp Snd Snd)) a bb payQ ext_q
        negP_negQ = pairOfFan_eval
                      ...
                      (ap2 Pair K_neg payQ)
                      negP negQ
        impNegPNegQ = pairOfConst_eval K_impV K_impV_isValue
  ...
  thmTDispAxNeg P Q =
    let payT = reify (nd (codeFormula P) (codeFormula Q))
        ...
        s1   = skipAtTag (natCode tagAxI) (natCode_isValue tagAxI)         tagCode_axNeg payT b body_axI         next_axI
                  (teqDiff tagAxI         tagAxNeg refl)
        s2   = skipAtTag (natCode tagAxFst) (natCode_isValue tagAxFst)       tagCode_axNeg payT b body_axFst       next_axFst
                  (teqDiff tagAxFst       tagAxNeg refl)
        s3   = skipAtTag (natCode tagAxSnd) (natCode_isValue tagAxSnd)       tagCode_axNeg payT b body_axSnd       next_axSnd
                  (teqDiff tagAxSnd       tagAxNeg refl)
        s4   = skipAtTag (natCode tagAxConst) (natCode_isValue tagAxConst)     tagCode_axNeg payT b body_axConst     next_axConst
                  (teqDiff tagAxConst     tagAxNeg refl)
        s5   = skipAtTag (natCode tagAxComp) (natCode_isValue tagAxComp)      tagCode_axNeg payT b body_axComp      next_axComp
                  (teqDiff tagAxComp      tagAxNeg refl)
        s6   = skipAtTag (natCode tagAxComp2) (natCode_isValue tagAxComp2)     tagCode_axNeg payT b body_axComp2     next_axComp2
                  (teqDiff tagAxComp2     tagAxNeg refl)
        s7   = skipAtTag (natCode tagAxLift) (natCode_isValue tagAxLift)      tagCode_axNeg payT b body_axLift      next_axLift
                  (teqDiff tagAxLift      tagAxNeg refl)
        s8   = skipAtTag (natCode tagAxPost) (natCode_isValue tagAxPost)      tagCode_axNeg payT b body_axPost      next_axPost
                  (teqDiff tagAxPost      tagAxNeg refl)
        s9   = skipAtTag (natCode tagAxFan) (natCode_isValue tagAxFan)       tagCode_axNeg payT b body_axFan       next_axFan
                  (teqDiff tagAxFan       tagAxNeg refl)
        s10  = skipAtTag (natCode tagAxKT) (natCode_isValue tagAxKT)        tagCode_axNeg payT b body_axZ        next_axKT
                  (teqDiff tagAxKT        tagAxNeg refl)
        s15  = skipAtTag (natCode tagAxIfLfL) (natCode_isValue tagAxIfLfL)     tagCode_axNeg payT b body_axIfLfL     next_axIfLfL
                  (teqDiff tagAxIfLfL     tagAxNeg refl)
        s16  = skipAtTag (natCode tagAxIfLfN) (natCode_isValue tagAxIfLfN)     tagCode_axNeg payT b body_axIfLfN     next_axIfLfN
                  (teqDiff tagAxIfLfN     tagAxNeg refl)
        s17  = skipAtTag (natCode tagAxTreeEqLL) (natCode_isValue tagAxTreeEqLL)  tagCode_axNeg payT b body_axTreeEqLL  next_axTreeEqLL
                  (teqDiff tagAxTreeEqLL  tagAxNeg refl)
        s18  = skipAtTag (natCode tagAxTreeEqLN) (natCode_isValue tagAxTreeEqLN)  tagCode_axNeg payT b body_axTreeEqLN  next_axTreeEqLN
                  (teqDiff tagAxTreeEqLN  tagAxNeg refl)
        s19  = skipAtTag (natCode tagAxTreeEqNL) (natCode_isValue tagAxTreeEqNL)  tagCode_axNeg payT b body_axTreeEqNL  next_axTreeEqNL
                  (teqDiff tagAxTreeEqNL  tagAxNeg refl)
        s20  = skipAtTag (natCode tagAxTreeEqNN) (natCode_isValue tagAxTreeEqNN)  tagCode_axNeg payT b body_axTreeEqNN  next_axTreeEqNN
                  (teqDiff tagAxTreeEqNN  tagAxNeg refl)
        s21  = skipAtTag (natCode tagAxGoodstein) (natCode_isValue tagAxGoodstein) tagCode_axNeg payT b body_axGoodstein next_axGoodstein
                  (teqDiff tagAxGoodstein tagAxNeg refl)
        s22  = skipAtTag (natCode tagAxRefl) (natCode_isValue tagAxRefl)      tagCode_axNeg payT b body_axRefl      next_axRefl
                  (teqDiff tagAxRefl      tagAxNeg refl)
        s23  = skipAtTag (natCode tagRuleSym) (natCode_isValue tagRuleSym)     tagCode_axNeg payT b body_ruleSym     next_ruleSym
                  (teqDiff tagRuleSym     tagAxNeg refl)
        s24  = skipAtTag (natCode tagRuleTrans) (natCode_isValue tagRuleTrans)   tagCode_axNeg payT b body_ruleTrans   next_ruleTrans
                  (teqDiff tagRuleTrans   tagAxNeg refl)
        s25  = skipAtTag (natCode tagCong1) (natCode_isValue tagCong1)       tagCode_axNeg payT b body_cong1       next_cong1
                  (teqDiff tagCong1       tagAxNeg refl)
        s26  = skipAtTag (natCode tagCongL) (natCode_isValue tagCongL)       tagCode_axNeg payT b body_congL       next_congL
                  (teqDiff tagCongL       tagAxNeg refl)
        s27  = skipAtTag (natCode tagCongR) (natCode_isValue tagCongR)       tagCode_axNeg payT b body_congR       next_congR
                  (teqDiff tagCongR       tagAxNeg refl)
        s28  = skipAtTag (natCode tagAxEqTrans) (natCode_isValue tagAxEqTrans)   tagCode_axNeg payT b body_axEqTrans   next_axEqTrans
                  (teqDiff tagAxEqTrans   tagAxNeg refl)
        s29  = skipAtTag (natCode tagAxEqCong1) (natCode_isValue tagAxEqCong1)   tagCode_axNeg payT b body_axEqCong1   next_axEqCong1
                  (teqDiff tagAxEqCong1   tagAxNeg refl)
        s30  = skipAtTag (natCode tagAxEqCongL) (natCode_isValue tagAxEqCongL)   tagCode_axNeg payT b body_axEqCongL   next_axEqCongL
                  (teqDiff tagAxEqCongL   tagAxNeg refl)
        s31  = skipAtTag (natCode tagAxEqCongR) (natCode_isValue tagAxEqCongR)   tagCode_axNeg payT b body_axEqCongR   next_axEqCongR
                  (teqDiff tagAxEqCongR   tagAxNeg refl)
        s32  = skipAtTag (natCode tagAxK) (natCode_isValue tagAxK)         tagCode_axNeg payT b body_axK         next_axK
                  (teqDiff tagAxK         tagAxNeg refl)
        s33  = skipAtTag (natCode tagAxS) (natCode_isValue tagAxS)         tagCode_axNeg payT b body_axS         next_axS
                  (teqDiff tagAxS         tagAxNeg refl)
        hh   = hitAtTag (natCode tagAxNeg) (natCode_isValue tagAxNeg)       tagCode_axNeg payT b body_axNeg       next_axNeg
                  (teqEq tagAxNeg)
  ...
  body_axExFalso_eval P Q bb =
    let payP   = reify (codeFormula P)
        ...
        impNegPQ = pairOfConst_eval K_impV K_impV_isValue
                     (Fan (Fan (Lift (KT K_neg)) (Lift (Comp Fst Snd)) Pair)
  ...
  thmTDispAxExFalso P Q =
    let payT = reify (nd (codeFormula P) (codeFormula Q))
        ...
        s1   = skipAtTag (natCode tagAxI) (natCode_isValue tagAxI)         tagCode_axExFalso payT b body_axI         next_axI
                  (teqDiff tagAxI         tagAxExFalso refl)
        s2   = skipAtTag (natCode tagAxFst) (natCode_isValue tagAxFst)       tagCode_axExFalso payT b body_axFst       next_axFst
                  (teqDiff tagAxFst       tagAxExFalso refl)
        s3   = skipAtTag (natCode tagAxSnd) (natCode_isValue tagAxSnd)       tagCode_axExFalso payT b body_axSnd       next_axSnd
                  (teqDiff tagAxSnd       tagAxExFalso refl)
        s4   = skipAtTag (natCode tagAxConst) (natCode_isValue tagAxConst)     tagCode_axExFalso payT b body_axConst     next_axConst
                  (teqDiff tagAxConst     tagAxExFalso refl)
        s5   = skipAtTag (natCode tagAxComp) (natCode_isValue tagAxComp)      tagCode_axExFalso payT b body_axComp      next_axComp
                  (teqDiff tagAxComp      tagAxExFalso refl)
        s6   = skipAtTag (natCode tagAxComp2) (natCode_isValue tagAxComp2)     tagCode_axExFalso payT b body_axComp2     next_axComp2
                  (teqDiff tagAxComp2     tagAxExFalso refl)
        s7   = skipAtTag (natCode tagAxLift) (natCode_isValue tagAxLift)      tagCode_axExFalso payT b body_axLift      next_axLift
                  (teqDiff tagAxLift      tagAxExFalso refl)
        s8   = skipAtTag (natCode tagAxPost) (natCode_isValue tagAxPost)      tagCode_axExFalso payT b body_axPost      next_axPost
                  (teqDiff tagAxPost      tagAxExFalso refl)
        s9   = skipAtTag (natCode tagAxFan) (natCode_isValue tagAxFan)       tagCode_axExFalso payT b body_axFan       next_axFan
                  (teqDiff tagAxFan       tagAxExFalso refl)
        s10  = skipAtTag (natCode tagAxKT) (natCode_isValue tagAxKT)        tagCode_axExFalso payT b body_axZ        next_axKT
                  (teqDiff tagAxKT        tagAxExFalso refl)
        s15  = skipAtTag (natCode tagAxIfLfL) (natCode_isValue tagAxIfLfL)     tagCode_axExFalso payT b body_axIfLfL     next_axIfLfL
                  (teqDiff tagAxIfLfL     tagAxExFalso refl)
        s16  = skipAtTag (natCode tagAxIfLfN) (natCode_isValue tagAxIfLfN)     tagCode_axExFalso payT b body_axIfLfN     next_axIfLfN
                  (teqDiff tagAxIfLfN     tagAxExFalso refl)
        s17  = skipAtTag (natCode tagAxTreeEqLL) (natCode_isValue tagAxTreeEqLL)  tagCode_axExFalso payT b body_axTreeEqLL  next_axTreeEqLL
                  (teqDiff tagAxTreeEqLL  tagAxExFalso refl)
        s18  = skipAtTag (natCode tagAxTreeEqLN) (natCode_isValue tagAxTreeEqLN)  tagCode_axExFalso payT b body_axTreeEqLN  next_axTreeEqLN
                  (teqDiff tagAxTreeEqLN  tagAxExFalso refl)
        s19  = skipAtTag (natCode tagAxTreeEqNL) (natCode_isValue tagAxTreeEqNL)  tagCode_axExFalso payT b body_axTreeEqNL  next_axTreeEqNL
                  (teqDiff tagAxTreeEqNL  tagAxExFalso refl)
        s20  = skipAtTag (natCode tagAxTreeEqNN) (natCode_isValue tagAxTreeEqNN)  tagCode_axExFalso payT b body_axTreeEqNN  next_axTreeEqNN
                  (teqDiff tagAxTreeEqNN  tagAxExFalso refl)
        s21  = skipAtTag (natCode tagAxGoodstein) (natCode_isValue tagAxGoodstein) tagCode_axExFalso payT b body_axGoodstein next_axGoodstein
                  (teqDiff tagAxGoodstein tagAxExFalso refl)
        s22  = skipAtTag (natCode tagAxRefl) (natCode_isValue tagAxRefl)      tagCode_axExFalso payT b body_axRefl      next_axRefl
                  (teqDiff tagAxRefl      tagAxExFalso refl)
        s23  = skipAtTag (natCode tagRuleSym) (natCode_isValue tagRuleSym)     tagCode_axExFalso payT b body_ruleSym     next_ruleSym
                  (teqDiff tagRuleSym     tagAxExFalso refl)
        s24  = skipAtTag (natCode tagRuleTrans) (natCode_isValue tagRuleTrans)   tagCode_axExFalso payT b body_ruleTrans   next_ruleTrans
                  (teqDiff tagRuleTrans   tagAxExFalso refl)
        s25  = skipAtTag (natCode tagCong1) (natCode_isValue tagCong1)       tagCode_axExFalso payT b body_cong1       next_cong1
                  (teqDiff tagCong1       tagAxExFalso refl)
        s26  = skipAtTag (natCode tagCongL) (natCode_isValue tagCongL)       tagCode_axExFalso payT b body_congL       next_congL
                  (teqDiff tagCongL       tagAxExFalso refl)
        s27  = skipAtTag (natCode tagCongR) (natCode_isValue tagCongR)       tagCode_axExFalso payT b body_congR       next_congR
                  (teqDiff tagCongR       tagAxExFalso refl)
        s28  = skipAtTag (natCode tagAxEqTrans) (natCode_isValue tagAxEqTrans)   tagCode_axExFalso payT b body_axEqTrans   next_axEqTrans
                  (teqDiff tagAxEqTrans   tagAxExFalso refl)
        s29  = skipAtTag (natCode tagAxEqCong1) (natCode_isValue tagAxEqCong1)   tagCode_axExFalso payT b body_axEqCong1   next_axEqCong1
                  (teqDiff tagAxEqCong1   tagAxExFalso refl)
        s30  = skipAtTag (natCode tagAxEqCongL) (natCode_isValue tagAxEqCongL)   tagCode_axExFalso payT b body_axEqCongL   next_axEqCongL
                  (teqDiff tagAxEqCongL   tagAxExFalso refl)
        s31  = skipAtTag (natCode tagAxEqCongR) (natCode_isValue tagAxEqCongR)   tagCode_axExFalso payT b body_axEqCongR   next_axEqCongR
                  (teqDiff tagAxEqCongR   tagAxExFalso refl)
        s32  = skipAtTag (natCode tagAxK) (natCode_isValue tagAxK)         tagCode_axExFalso payT b body_axK         next_axK
                  (teqDiff tagAxK         tagAxExFalso refl)
        s33  = skipAtTag (natCode tagAxS) (natCode_isValue tagAxS)         tagCode_axExFalso payT b body_axS         next_axS
                  (teqDiff tagAxS         tagAxExFalso refl)
        s34  = skipAtTag (natCode tagAxNeg) (natCode_isValue tagAxNeg)       tagCode_axExFalso payT b body_axNeg       next_axNeg
                  (teqDiff tagAxNeg       tagAxExFalso refl)
        hh   = hitAtTag (natCode tagAxExFalso) (natCode_isValue tagAxExFalso)   tagCode_axExFalso payT b body_axExFalso   next_axExFalso
                  (teqEq tagAxExFalso)
  ...
  body_axContrapos_eval P Q bb =
    let payP   = reify (codeFormula P)
        ...
        negQ_negP = pairOfFan_eval
                      ...
                      negQ negP
        impNegQ_negP = pairOfConst_eval K_impV K_impV_isValue
  ...
  thmTDispAxContrapos P Q =
    let payT = reify (nd (codeFormula P) (codeFormula Q))
        ...
        s1   = skipAtTag (natCode tagAxI) (natCode_isValue tagAxI)         tagCode_axContrapos payT b body_axI         next_axI
                  (teqDiff tagAxI         tagAxContrapos refl)
        s2   = skipAtTag (natCode tagAxFst) (natCode_isValue tagAxFst)       tagCode_axContrapos payT b body_axFst       next_axFst
                  (teqDiff tagAxFst       tagAxContrapos refl)
        s3   = skipAtTag (natCode tagAxSnd) (natCode_isValue tagAxSnd)       tagCode_axContrapos payT b body_axSnd       next_axSnd
                  (teqDiff tagAxSnd       tagAxContrapos refl)
        s4   = skipAtTag (natCode tagAxConst) (natCode_isValue tagAxConst)     tagCode_axContrapos payT b body_axConst     next_axConst
                  (teqDiff tagAxConst     tagAxContrapos refl)
        s5   = skipAtTag (natCode tagAxComp) (natCode_isValue tagAxComp)      tagCode_axContrapos payT b body_axComp      next_axComp
                  (teqDiff tagAxComp      tagAxContrapos refl)
        s6   = skipAtTag (natCode tagAxComp2) (natCode_isValue tagAxComp2)     tagCode_axContrapos payT b body_axComp2     next_axComp2
                  (teqDiff tagAxComp2     tagAxContrapos refl)
        s7   = skipAtTag (natCode tagAxLift) (natCode_isValue tagAxLift)      tagCode_axContrapos payT b body_axLift      next_axLift
                  (teqDiff tagAxLift      tagAxContrapos refl)
        s8   = skipAtTag (natCode tagAxPost) (natCode_isValue tagAxPost)      tagCode_axContrapos payT b body_axPost      next_axPost
                  (teqDiff tagAxPost      tagAxContrapos refl)
        s9   = skipAtTag (natCode tagAxFan) (natCode_isValue tagAxFan)       tagCode_axContrapos payT b body_axFan       next_axFan
                  (teqDiff tagAxFan       tagAxContrapos refl)
        s10  = skipAtTag (natCode tagAxKT) (natCode_isValue tagAxKT)        tagCode_axContrapos payT b body_axZ        next_axKT
                  (teqDiff tagAxKT        tagAxContrapos refl)
        s15  = skipAtTag (natCode tagAxIfLfL) (natCode_isValue tagAxIfLfL)     tagCode_axContrapos payT b body_axIfLfL     next_axIfLfL
                  (teqDiff tagAxIfLfL     tagAxContrapos refl)
        s16  = skipAtTag (natCode tagAxIfLfN) (natCode_isValue tagAxIfLfN)     tagCode_axContrapos payT b body_axIfLfN     next_axIfLfN
                  (teqDiff tagAxIfLfN     tagAxContrapos refl)
        s17  = skipAtTag (natCode tagAxTreeEqLL) (natCode_isValue tagAxTreeEqLL)  tagCode_axContrapos payT b body_axTreeEqLL  next_axTreeEqLL
                  (teqDiff tagAxTreeEqLL  tagAxContrapos refl)
        s18  = skipAtTag (natCode tagAxTreeEqLN) (natCode_isValue tagAxTreeEqLN)  tagCode_axContrapos payT b body_axTreeEqLN  next_axTreeEqLN
                  (teqDiff tagAxTreeEqLN  tagAxContrapos refl)
        s19  = skipAtTag (natCode tagAxTreeEqNL) (natCode_isValue tagAxTreeEqNL)  tagCode_axContrapos payT b body_axTreeEqNL  next_axTreeEqNL
                  (teqDiff tagAxTreeEqNL  tagAxContrapos refl)
        s20  = skipAtTag (natCode tagAxTreeEqNN) (natCode_isValue tagAxTreeEqNN)  tagCode_axContrapos payT b body_axTreeEqNN  next_axTreeEqNN
                  (teqDiff tagAxTreeEqNN  tagAxContrapos refl)
        s21  = skipAtTag (natCode tagAxGoodstein) (natCode_isValue tagAxGoodstein) tagCode_axContrapos payT b body_axGoodstein next_axGoodstein
                  (teqDiff tagAxGoodstein tagAxContrapos refl)
        s22  = skipAtTag (natCode tagAxRefl) (natCode_isValue tagAxRefl)      tagCode_axContrapos payT b body_axRefl      next_axRefl
                  (teqDiff tagAxRefl      tagAxContrapos refl)
        s23  = skipAtTag (natCode tagRuleSym) (natCode_isValue tagRuleSym)     tagCode_axContrapos payT b body_ruleSym     next_ruleSym
                  (teqDiff tagRuleSym     tagAxContrapos refl)
        s24  = skipAtTag (natCode tagRuleTrans) (natCode_isValue tagRuleTrans)   tagCode_axContrapos payT b body_ruleTrans   next_ruleTrans
                  (teqDiff tagRuleTrans   tagAxContrapos refl)
        s25  = skipAtTag (natCode tagCong1) (natCode_isValue tagCong1)       tagCode_axContrapos payT b body_cong1       next_cong1
                  (teqDiff tagCong1       tagAxContrapos refl)
        s26  = skipAtTag (natCode tagCongL) (natCode_isValue tagCongL)       tagCode_axContrapos payT b body_congL       next_congL
                  (teqDiff tagCongL       tagAxContrapos refl)
        s27  = skipAtTag (natCode tagCongR) (natCode_isValue tagCongR)       tagCode_axContrapos payT b body_congR       next_congR
                  (teqDiff tagCongR       tagAxContrapos refl)
        s28  = skipAtTag (natCode tagAxEqTrans) (natCode_isValue tagAxEqTrans)   tagCode_axContrapos payT b body_axEqTrans   next_axEqTrans
                  (teqDiff tagAxEqTrans   tagAxContrapos refl)
        s29  = skipAtTag (natCode tagAxEqCong1) (natCode_isValue tagAxEqCong1)   tagCode_axContrapos payT b body_axEqCong1   next_axEqCong1
                  (teqDiff tagAxEqCong1   tagAxContrapos refl)
        s30  = skipAtTag (natCode tagAxEqCongL) (natCode_isValue tagAxEqCongL)   tagCode_axContrapos payT b body_axEqCongL   next_axEqCongL
                  (teqDiff tagAxEqCongL   tagAxContrapos refl)
        s31  = skipAtTag (natCode tagAxEqCongR) (natCode_isValue tagAxEqCongR)   tagCode_axContrapos payT b body_axEqCongR   next_axEqCongR
                  (teqDiff tagAxEqCongR   tagAxContrapos refl)
        s32  = skipAtTag (natCode tagAxK) (natCode_isValue tagAxK)         tagCode_axContrapos payT b body_axK         next_axK
                  (teqDiff tagAxK         tagAxContrapos refl)
        s33  = skipAtTag (natCode tagAxS) (natCode_isValue tagAxS)         tagCode_axContrapos payT b body_axS         next_axS
                  (teqDiff tagAxS         tagAxContrapos refl)
        s34  = skipAtTag (natCode tagAxNeg) (natCode_isValue tagAxNeg)       tagCode_axContrapos payT b body_axNeg       next_axNeg
                  (teqDiff tagAxNeg       tagAxContrapos refl)
        s35  = skipAtTag (natCode tagAxExFalso) (natCode_isValue tagAxExFalso)   tagCode_axContrapos payT b body_axExFalso   next_axExFalso
                  (teqDiff tagAxExFalso   tagAxContrapos refl)
        hh   = hitAtTag (natCode tagAxContrapos) (natCode_isValue tagAxContrapos) tagCode_axContrapos payT b body_axContrapos next_axContrapos
  ...
  thmTDispRuleSym t u y_h d_h =
    let payT = reify y_h
        ...
        s1   = skipAtTag (natCode tagAxI) (natCode_isValue tagAxI)         tagCode_ruleSym payT b body_axI         next_axI
                  (teqDiff tagAxI         tagRuleSym refl)
        s2   = skipAtTag (natCode tagAxFst) (natCode_isValue tagAxFst)       tagCode_ruleSym payT b body_axFst       next_axFst
                  (teqDiff tagAxFst       tagRuleSym refl)
        s3   = skipAtTag (natCode tagAxSnd) (natCode_isValue tagAxSnd)       tagCode_ruleSym payT b body_axSnd       next_axSnd
                  (teqDiff tagAxSnd       tagRuleSym refl)
        s4   = skipAtTag (natCode tagAxConst) (natCode_isValue tagAxConst)     tagCode_ruleSym payT b body_axConst     next_axConst
                  (teqDiff tagAxConst     tagRuleSym refl)
        s5   = skipAtTag (natCode tagAxComp) (natCode_isValue tagAxComp)      tagCode_ruleSym payT b body_axComp      next_axComp
                  (teqDiff tagAxComp      tagRuleSym refl)
        s6   = skipAtTag (natCode tagAxComp2) (natCode_isValue tagAxComp2)     tagCode_ruleSym payT b body_axComp2     next_axComp2
                  (teqDiff tagAxComp2     tagRuleSym refl)
        s7   = skipAtTag (natCode tagAxLift) (natCode_isValue tagAxLift)      tagCode_ruleSym payT b body_axLift      next_axLift
                  (teqDiff tagAxLift      tagRuleSym refl)
        s8   = skipAtTag (natCode tagAxPost) (natCode_isValue tagAxPost)      tagCode_ruleSym payT b body_axPost      next_axPost
                  (teqDiff tagAxPost      tagRuleSym refl)
        s9   = skipAtTag (natCode tagAxFan) (natCode_isValue tagAxFan)       tagCode_ruleSym payT b body_axFan       next_axFan
                  (teqDiff tagAxFan       tagRuleSym refl)
        s10  = skipAtTag (natCode tagAxKT) (natCode_isValue tagAxKT)        tagCode_ruleSym payT b body_axZ        next_axKT
                  (teqDiff tagAxKT        tagRuleSym refl)
        s15  = skipAtTag (natCode tagAxIfLfL) (natCode_isValue tagAxIfLfL)     tagCode_ruleSym payT b body_axIfLfL     next_axIfLfL
                  (teqDiff tagAxIfLfL     tagRuleSym refl)
        s16  = skipAtTag (natCode tagAxIfLfN) (natCode_isValue tagAxIfLfN)     tagCode_ruleSym payT b body_axIfLfN     next_axIfLfN
                  (teqDiff tagAxIfLfN     tagRuleSym refl)
        s17  = skipAtTag (natCode tagAxTreeEqLL) (natCode_isValue tagAxTreeEqLL)  tagCode_ruleSym payT b body_axTreeEqLL  next_axTreeEqLL
                  (teqDiff tagAxTreeEqLL  tagRuleSym refl)
        s18  = skipAtTag (natCode tagAxTreeEqLN) (natCode_isValue tagAxTreeEqLN)  tagCode_ruleSym payT b body_axTreeEqLN  next_axTreeEqLN
                  (teqDiff tagAxTreeEqLN  tagRuleSym refl)
        s19  = skipAtTag (natCode tagAxTreeEqNL) (natCode_isValue tagAxTreeEqNL)  tagCode_ruleSym payT b body_axTreeEqNL  next_axTreeEqNL
                  (teqDiff tagAxTreeEqNL  tagRuleSym refl)
        s20  = skipAtTag (natCode tagAxTreeEqNN) (natCode_isValue tagAxTreeEqNN)  tagCode_ruleSym payT b body_axTreeEqNN  next_axTreeEqNN
                  (teqDiff tagAxTreeEqNN  tagRuleSym refl)
        s21  = skipAtTag (natCode tagAxGoodstein) (natCode_isValue tagAxGoodstein) tagCode_ruleSym payT b body_axGoodstein next_axGoodstein
                  (teqDiff tagAxGoodstein tagRuleSym refl)
        s22  = skipAtTag (natCode tagAxRefl) (natCode_isValue tagAxRefl)      tagCode_ruleSym payT b body_axRefl      next_axRefl
                  (teqDiff tagAxRefl      tagRuleSym refl)
        hh   = hitAtTag (natCode tagRuleSym) (natCode_isValue tagRuleSym)     tagCode_ruleSym payT b body_ruleSym     next_ruleSym
                  (teqEq tagRuleSym)
  ...
  thmTDispRuleIndBT P v1 v2 y_base y_step _ _ =
    let payT = reify (nd (codeFormula P)
        ...
        s1   = skipAtTag (natCode tagAxI) (natCode_isValue tagAxI)         tagCode_ruleIndBT payT b body_axI         next_axI
                  (teqDiff tagAxI         tagRuleIndBT refl)
        s2   = skipAtTag (natCode tagAxFst) (natCode_isValue tagAxFst)       tagCode_ruleIndBT payT b body_axFst       next_axFst
                  (teqDiff tagAxFst       tagRuleIndBT refl)
        s3   = skipAtTag (natCode tagAxSnd) (natCode_isValue tagAxSnd)       tagCode_ruleIndBT payT b body_axSnd       next_axSnd
                  (teqDiff tagAxSnd       tagRuleIndBT refl)
        s4   = skipAtTag (natCode tagAxConst) (natCode_isValue tagAxConst)     tagCode_ruleIndBT payT b body_axConst     next_axConst
                  (teqDiff tagAxConst     tagRuleIndBT refl)
        s5   = skipAtTag (natCode tagAxComp) (natCode_isValue tagAxComp)      tagCode_ruleIndBT payT b body_axComp      next_axComp
                  (teqDiff tagAxComp      tagRuleIndBT refl)
        s6   = skipAtTag (natCode tagAxComp2) (natCode_isValue tagAxComp2)     tagCode_ruleIndBT payT b body_axComp2     next_axComp2
                  (teqDiff tagAxComp2     tagRuleIndBT refl)
        s7   = skipAtTag (natCode tagAxLift) (natCode_isValue tagAxLift)      tagCode_ruleIndBT payT b body_axLift      next_axLift
                  (teqDiff tagAxLift      tagRuleIndBT refl)
        s8   = skipAtTag (natCode tagAxPost) (natCode_isValue tagAxPost)      tagCode_ruleIndBT payT b body_axPost      next_axPost
                  (teqDiff tagAxPost      tagRuleIndBT refl)
        s9   = skipAtTag (natCode tagAxFan) (natCode_isValue tagAxFan)       tagCode_ruleIndBT payT b body_axFan       next_axFan
                  (teqDiff tagAxFan       tagRuleIndBT refl)
        s10  = skipAtTag (natCode tagAxKT) (natCode_isValue tagAxKT)        tagCode_ruleIndBT payT b body_axZ        next_axKT
                  (teqDiff tagAxKT        tagRuleIndBT refl)
        s15  = skipAtTag (natCode tagAxIfLfL) (natCode_isValue tagAxIfLfL)     tagCode_ruleIndBT payT b body_axIfLfL     next_axIfLfL
                  (teqDiff tagAxIfLfL     tagRuleIndBT refl)
        s16  = skipAtTag (natCode tagAxIfLfN) (natCode_isValue tagAxIfLfN)     tagCode_ruleIndBT payT b body_axIfLfN     next_axIfLfN
                  (teqDiff tagAxIfLfN     tagRuleIndBT refl)
        s17  = skipAtTag (natCode tagAxTreeEqLL) (natCode_isValue tagAxTreeEqLL)  tagCode_ruleIndBT payT b body_axTreeEqLL  next_axTreeEqLL
                  (teqDiff tagAxTreeEqLL  tagRuleIndBT refl)
        s18  = skipAtTag (natCode tagAxTreeEqLN) (natCode_isValue tagAxTreeEqLN)  tagCode_ruleIndBT payT b body_axTreeEqLN  next_axTreeEqLN
                  (teqDiff tagAxTreeEqLN  tagRuleIndBT refl)
        s19  = skipAtTag (natCode tagAxTreeEqNL) (natCode_isValue tagAxTreeEqNL)  tagCode_ruleIndBT payT b body_axTreeEqNL  next_axTreeEqNL
                  (teqDiff tagAxTreeEqNL  tagRuleIndBT refl)
        s20  = skipAtTag (natCode tagAxTreeEqNN) (natCode_isValue tagAxTreeEqNN)  tagCode_ruleIndBT payT b body_axTreeEqNN  next_axTreeEqNN
                  (teqDiff tagAxTreeEqNN  tagRuleIndBT refl)
        s21  = skipAtTag (natCode tagAxGoodstein) (natCode_isValue tagAxGoodstein) tagCode_ruleIndBT payT b body_axGoodstein next_axGoodstein
                  (teqDiff tagAxGoodstein tagRuleIndBT refl)
        s22  = skipAtTag (natCode tagAxRefl) (natCode_isValue tagAxRefl)      tagCode_ruleIndBT payT b body_axRefl      next_axRefl
                  (teqDiff tagAxRefl      tagRuleIndBT refl)
        s23  = skipAtTag (natCode tagRuleSym) (natCode_isValue tagRuleSym)     tagCode_ruleIndBT payT b body_ruleSym     next_ruleSym
                  (teqDiff tagRuleSym     tagRuleIndBT refl)
        s24  = skipAtTag (natCode tagRuleTrans) (natCode_isValue tagRuleTrans)   tagCode_ruleIndBT payT b body_ruleTrans   next_ruleTrans
                  (teqDiff tagRuleTrans   tagRuleIndBT refl)
        s25  = skipAtTag (natCode tagCong1) (natCode_isValue tagCong1)       tagCode_ruleIndBT payT b body_cong1       next_cong1
                  (teqDiff tagCong1       tagRuleIndBT refl)
        s26  = skipAtTag (natCode tagCongL) (natCode_isValue tagCongL)       tagCode_ruleIndBT payT b body_congL       next_congL
                  (teqDiff tagCongL       tagRuleIndBT refl)
        s27  = skipAtTag (natCode tagCongR) (natCode_isValue tagCongR)       tagCode_ruleIndBT payT b body_congR       next_congR
                  (teqDiff tagCongR       tagRuleIndBT refl)
        s28  = skipAtTag (natCode tagAxEqTrans) (natCode_isValue tagAxEqTrans)   tagCode_ruleIndBT payT b body_axEqTrans   next_axEqTrans
                  (teqDiff tagAxEqTrans   tagRuleIndBT refl)
        s29  = skipAtTag (natCode tagAxEqCong1) (natCode_isValue tagAxEqCong1)   tagCode_ruleIndBT payT b body_axEqCong1   next_axEqCong1
                  (teqDiff tagAxEqCong1   tagRuleIndBT refl)
        s30  = skipAtTag (natCode tagAxEqCongL) (natCode_isValue tagAxEqCongL)   tagCode_ruleIndBT payT b body_axEqCongL   next_axEqCongL
                  (teqDiff tagAxEqCongL   tagRuleIndBT refl)
        s31  = skipAtTag (natCode tagAxEqCongR) (natCode_isValue tagAxEqCongR)   tagCode_ruleIndBT payT b body_axEqCongR   next_axEqCongR
                  (teqDiff tagAxEqCongR   tagRuleIndBT refl)
        s32  = skipAtTag (natCode tagAxK) (natCode_isValue tagAxK)         tagCode_ruleIndBT payT b body_axK         next_axK
                  (teqDiff tagAxK         tagRuleIndBT refl)
        s33  = skipAtTag (natCode tagAxS) (natCode_isValue tagAxS)         tagCode_ruleIndBT payT b body_axS         next_axS
                  (teqDiff tagAxS         tagRuleIndBT refl)
        s34  = skipAtTag (natCode tagAxNeg) (natCode_isValue tagAxNeg)       tagCode_ruleIndBT payT b body_axNeg       next_axNeg
                  (teqDiff tagAxNeg       tagRuleIndBT refl)
        s35  = skipAtTag (natCode tagAxExFalso) (natCode_isValue tagAxExFalso)   tagCode_ruleIndBT payT b body_axExFalso   next_axExFalso
                  (teqDiff tagAxExFalso   tagRuleIndBT refl)
        s36  = skipAtTag (natCode tagAxContrapos) (natCode_isValue tagAxContrapos) tagCode_ruleIndBT payT b body_axContrapos next_axContrapos
                  (teqDiff tagAxContrapos tagRuleIndBT refl)
        s37  = skipAtTag (natCode tagMp) (natCode_isValue tagMp)          tagCode_ruleIndBT payT b body_mp          next_mp
                  (teqDiff tagMp          tagRuleIndBT refl)
        s38  = skipAtTag (natCode tagRuleInst) (natCode_isValue tagRuleInst)    tagCode_ruleIndBT payT b body_ruleInst    next_ruleInst
                  (teqDiff tagRuleInst    tagRuleIndBT refl)
        hh   = hitAtTag (natCode tagRuleIndBT) (natCode_isValue tagRuleIndBT)   tagCode_ruleIndBT payT b body_ruleIndBT   next_ruleIndBT
                  (teqEq tagRuleIndBT)
  ...
  thmTDispAxFstLf =
    let payT = O
        ...
        s1   = skipAtTag (natCode tagAxI) (natCode_isValue tagAxI)         tagCode_axFstLf payT b body_axI         next_axI
                  (teqDiff tagAxI         tagAxFstLf refl)
        s2   = skipAtTag (natCode tagAxFst) (natCode_isValue tagAxFst)       tagCode_axFstLf payT b body_axFst       next_axFst
                  (teqDiff tagAxFst       tagAxFstLf refl)
        s3   = skipAtTag (natCode tagAxSnd) (natCode_isValue tagAxSnd)       tagCode_axFstLf payT b body_axSnd       next_axSnd
                  (teqDiff tagAxSnd       tagAxFstLf refl)
        s4   = skipAtTag (natCode tagAxConst) (natCode_isValue tagAxConst)     tagCode_axFstLf payT b body_axConst     next_axConst
                  (teqDiff tagAxConst     tagAxFstLf refl)
        s5   = skipAtTag (natCode tagAxComp) (natCode_isValue tagAxComp)      tagCode_axFstLf payT b body_axComp      next_axComp
                  (teqDiff tagAxComp      tagAxFstLf refl)
        s6   = skipAtTag (natCode tagAxComp2) (natCode_isValue tagAxComp2)     tagCode_axFstLf payT b body_axComp2     next_axComp2
                  (teqDiff tagAxComp2     tagAxFstLf refl)
        s7   = skipAtTag (natCode tagAxLift) (natCode_isValue tagAxLift)      tagCode_axFstLf payT b body_axLift      next_axLift
                  (teqDiff tagAxLift      tagAxFstLf refl)
        s8   = skipAtTag (natCode tagAxPost) (natCode_isValue tagAxPost)      tagCode_axFstLf payT b body_axPost      next_axPost
                  (teqDiff tagAxPost      tagAxFstLf refl)
        s9   = skipAtTag (natCode tagAxFan) (natCode_isValue tagAxFan)       tagCode_axFstLf payT b body_axFan       next_axFan
                  (teqDiff tagAxFan       tagAxFstLf refl)
        s10  = skipAtTag (natCode tagAxKT) (natCode_isValue tagAxKT)        tagCode_axFstLf payT b body_axZ         next_axKT
                  (teqDiff tagAxKT        tagAxFstLf refl)
        s15  = skipAtTag (natCode tagAxIfLfL) (natCode_isValue tagAxIfLfL)     tagCode_axFstLf payT b body_axIfLfL     next_axIfLfL
                  (teqDiff tagAxIfLfL     tagAxFstLf refl)
        s16  = skipAtTag (natCode tagAxIfLfN) (natCode_isValue tagAxIfLfN)     tagCode_axFstLf payT b body_axIfLfN     next_axIfLfN
                  (teqDiff tagAxIfLfN     tagAxFstLf refl)
        s17  = skipAtTag (natCode tagAxTreeEqLL) (natCode_isValue tagAxTreeEqLL)  tagCode_axFstLf payT b body_axTreeEqLL  next_axTreeEqLL
                  (teqDiff tagAxTreeEqLL  tagAxFstLf refl)
        s18  = skipAtTag (natCode tagAxTreeEqLN) (natCode_isValue tagAxTreeEqLN)  tagCode_axFstLf payT b body_axTreeEqLN  next_axTreeEqLN
                  (teqDiff tagAxTreeEqLN  tagAxFstLf refl)
        s19  = skipAtTag (natCode tagAxTreeEqNL) (natCode_isValue tagAxTreeEqNL)  tagCode_axFstLf payT b body_axTreeEqNL  next_axTreeEqNL
                  (teqDiff tagAxTreeEqNL  tagAxFstLf refl)
        s20  = skipAtTag (natCode tagAxTreeEqNN) (natCode_isValue tagAxTreeEqNN)  tagCode_axFstLf payT b body_axTreeEqNN  next_axTreeEqNN
                  (teqDiff tagAxTreeEqNN  tagAxFstLf refl)
        s21  = skipAtTag (natCode tagAxGoodstein) (natCode_isValue tagAxGoodstein) tagCode_axFstLf payT b body_axGoodstein next_axGoodstein
                  (teqDiff tagAxGoodstein tagAxFstLf refl)
        s22  = skipAtTag (natCode tagAxRefl) (natCode_isValue tagAxRefl)      tagCode_axFstLf payT b body_axRefl      next_axRefl
                  (teqDiff tagAxRefl      tagAxFstLf refl)
        s23  = skipAtTag (natCode tagRuleSym) (natCode_isValue tagRuleSym)     tagCode_axFstLf payT b body_ruleSym     next_ruleSym
                  (teqDiff tagRuleSym     tagAxFstLf refl)
        s24  = skipAtTag (natCode tagRuleTrans) (natCode_isValue tagRuleTrans)   tagCode_axFstLf payT b body_ruleTrans   next_ruleTrans
                  (teqDiff tagRuleTrans   tagAxFstLf refl)
        s25  = skipAtTag (natCode tagCong1) (natCode_isValue tagCong1)       tagCode_axFstLf payT b body_cong1       next_cong1
                  (teqDiff tagCong1       tagAxFstLf refl)
        s26  = skipAtTag (natCode tagCongL) (natCode_isValue tagCongL)       tagCode_axFstLf payT b body_congL       next_congL
                  (teqDiff tagCongL       tagAxFstLf refl)
        s27  = skipAtTag (natCode tagCongR) (natCode_isValue tagCongR)       tagCode_axFstLf payT b body_congR       next_congR
                  (teqDiff tagCongR       tagAxFstLf refl)
        s28  = skipAtTag (natCode tagAxEqTrans) (natCode_isValue tagAxEqTrans)   tagCode_axFstLf payT b body_axEqTrans   next_axEqTrans
                  (teqDiff tagAxEqTrans   tagAxFstLf refl)
        s29  = skipAtTag (natCode tagAxEqCong1) (natCode_isValue tagAxEqCong1)   tagCode_axFstLf payT b body_axEqCong1   next_axEqCong1
                  (teqDiff tagAxEqCong1   tagAxFstLf refl)
        s30  = skipAtTag (natCode tagAxEqCongL) (natCode_isValue tagAxEqCongL)   tagCode_axFstLf payT b body_axEqCongL   next_axEqCongL
                  (teqDiff tagAxEqCongL   tagAxFstLf refl)
        s31  = skipAtTag (natCode tagAxEqCongR) (natCode_isValue tagAxEqCongR)   tagCode_axFstLf payT b body_axEqCongR   next_axEqCongR
                  (teqDiff tagAxEqCongR   tagAxFstLf refl)
        s32  = skipAtTag (natCode tagAxK) (natCode_isValue tagAxK)         tagCode_axFstLf payT b body_axK         next_axK
                  (teqDiff tagAxK         tagAxFstLf refl)
        s33  = skipAtTag (natCode tagAxS) (natCode_isValue tagAxS)         tagCode_axFstLf payT b body_axS         next_axS
                  (teqDiff tagAxS         tagAxFstLf refl)
        s34  = skipAtTag (natCode tagAxNeg) (natCode_isValue tagAxNeg)       tagCode_axFstLf payT b body_axNeg       next_axNeg
                  (teqDiff tagAxNeg       tagAxFstLf refl)
        s35  = skipAtTag (natCode tagAxExFalso) (natCode_isValue tagAxExFalso)   tagCode_axFstLf payT b body_axExFalso   next_axExFalso
                  (teqDiff tagAxExFalso   tagAxFstLf refl)
        s36  = skipAtTag (natCode tagAxContrapos) (natCode_isValue tagAxContrapos) tagCode_axFstLf payT b body_axContrapos next_axContrapos
                  (teqDiff tagAxContrapos tagAxFstLf refl)
        s37  = skipAtTag (natCode tagMp) (natCode_isValue tagMp)          tagCode_axFstLf payT b body_mp          next_mp
                  (teqDiff tagMp          tagAxFstLf refl)
        s38  = skipAtTag (natCode tagRuleInst) (natCode_isValue tagRuleInst)    tagCode_axFstLf payT b body_ruleInst    next_ruleInst
                  (teqDiff tagRuleInst    tagAxFstLf refl)
        s39  = skipAtTag (natCode tagRuleIndBT) (natCode_isValue tagRuleIndBT)   tagCode_axFstLf payT b body_ruleIndBT   next_ruleIndBT
                  (teqDiff tagRuleIndBT   tagAxFstLf refl)
        hh   = hitAtTag (natCode tagAxFstLf) (natCode_isValue tagAxFstLf)     tagCode_axFstLf payT b body_axFstLf     next_axFstLf
                  (teqEq tagAxFstLf)
  ...
  body_axFstLf_eval_param payT bb =
    liftKT_eval outAxFstLf
                ...
                (ap2 Pair tagCode_axFstLf payT) bb
  ...
  thmTDispAxSndLf =
    let payT = O
        ...
        s1   = skipAtTag (natCode tagAxI) (natCode_isValue tagAxI)         tagCode_axSndLf payT b body_axI         next_axI
                  (teqDiff tagAxI         tagAxSndLf refl)
        s2   = skipAtTag (natCode tagAxFst) (natCode_isValue tagAxFst)       tagCode_axSndLf payT b body_axFst       next_axFst
                  (teqDiff tagAxFst       tagAxSndLf refl)
        s3   = skipAtTag (natCode tagAxSnd) (natCode_isValue tagAxSnd)       tagCode_axSndLf payT b body_axSnd       next_axSnd
                  (teqDiff tagAxSnd       tagAxSndLf refl)
        s4   = skipAtTag (natCode tagAxConst) (natCode_isValue tagAxConst)     tagCode_axSndLf payT b body_axConst     next_axConst
                  (teqDiff tagAxConst     tagAxSndLf refl)
        s5   = skipAtTag (natCode tagAxComp) (natCode_isValue tagAxComp)      tagCode_axSndLf payT b body_axComp      next_axComp
                  (teqDiff tagAxComp      tagAxSndLf refl)
        s6   = skipAtTag (natCode tagAxComp2) (natCode_isValue tagAxComp2)     tagCode_axSndLf payT b body_axComp2     next_axComp2
                  (teqDiff tagAxComp2     tagAxSndLf refl)
        s7   = skipAtTag (natCode tagAxLift) (natCode_isValue tagAxLift)      tagCode_axSndLf payT b body_axLift      next_axLift
                  (teqDiff tagAxLift      tagAxSndLf refl)
        s8   = skipAtTag (natCode tagAxPost) (natCode_isValue tagAxPost)      tagCode_axSndLf payT b body_axPost      next_axPost
                  (teqDiff tagAxPost      tagAxSndLf refl)
        s9   = skipAtTag (natCode tagAxFan) (natCode_isValue tagAxFan)       tagCode_axSndLf payT b body_axFan       next_axFan
                  (teqDiff tagAxFan       tagAxSndLf refl)
        s10  = skipAtTag (natCode tagAxKT) (natCode_isValue tagAxKT)        tagCode_axSndLf payT b body_axZ         next_axKT
                  (teqDiff tagAxKT        tagAxSndLf refl)
        s15  = skipAtTag (natCode tagAxIfLfL) (natCode_isValue tagAxIfLfL)     tagCode_axSndLf payT b body_axIfLfL     next_axIfLfL
                  (teqDiff tagAxIfLfL     tagAxSndLf refl)
        s16  = skipAtTag (natCode tagAxIfLfN) (natCode_isValue tagAxIfLfN)     tagCode_axSndLf payT b body_axIfLfN     next_axIfLfN
                  (teqDiff tagAxIfLfN     tagAxSndLf refl)
        s17  = skipAtTag (natCode tagAxTreeEqLL) (natCode_isValue tagAxTreeEqLL)  tagCode_axSndLf payT b body_axTreeEqLL  next_axTreeEqLL
                  (teqDiff tagAxTreeEqLL  tagAxSndLf refl)
        s18  = skipAtTag (natCode tagAxTreeEqLN) (natCode_isValue tagAxTreeEqLN)  tagCode_axSndLf payT b body_axTreeEqLN  next_axTreeEqLN
                  (teqDiff tagAxTreeEqLN  tagAxSndLf refl)
        s19  = skipAtTag (natCode tagAxTreeEqNL) (natCode_isValue tagAxTreeEqNL)  tagCode_axSndLf payT b body_axTreeEqNL  next_axTreeEqNL
                  (teqDiff tagAxTreeEqNL  tagAxSndLf refl)
        s20  = skipAtTag (natCode tagAxTreeEqNN) (natCode_isValue tagAxTreeEqNN)  tagCode_axSndLf payT b body_axTreeEqNN  next_axTreeEqNN
                  (teqDiff tagAxTreeEqNN  tagAxSndLf refl)
        s21  = skipAtTag (natCode tagAxGoodstein) (natCode_isValue tagAxGoodstein) tagCode_axSndLf payT b body_axGoodstein next_axGoodstein
                  (teqDiff tagAxGoodstein tagAxSndLf refl)
        s22  = skipAtTag (natCode tagAxRefl) (natCode_isValue tagAxRefl)      tagCode_axSndLf payT b body_axRefl      next_axRefl
                  (teqDiff tagAxRefl      tagAxSndLf refl)
        s23  = skipAtTag (natCode tagRuleSym) (natCode_isValue tagRuleSym)     tagCode_axSndLf payT b body_ruleSym     next_ruleSym
                  (teqDiff tagRuleSym     tagAxSndLf refl)
        s24  = skipAtTag (natCode tagRuleTrans) (natCode_isValue tagRuleTrans)   tagCode_axSndLf payT b body_ruleTrans   next_ruleTrans
                  (teqDiff tagRuleTrans   tagAxSndLf refl)
        s25  = skipAtTag (natCode tagCong1) (natCode_isValue tagCong1)       tagCode_axSndLf payT b body_cong1       next_cong1
                  (teqDiff tagCong1       tagAxSndLf refl)
        s26  = skipAtTag (natCode tagCongL) (natCode_isValue tagCongL)       tagCode_axSndLf payT b body_congL       next_congL
                  (teqDiff tagCongL       tagAxSndLf refl)
        s27  = skipAtTag (natCode tagCongR) (natCode_isValue tagCongR)       tagCode_axSndLf payT b body_congR       next_congR
                  (teqDiff tagCongR       tagAxSndLf refl)
        s28  = skipAtTag (natCode tagAxEqTrans) (natCode_isValue tagAxEqTrans)   tagCode_axSndLf payT b body_axEqTrans   next_axEqTrans
                  (teqDiff tagAxEqTrans   tagAxSndLf refl)
        s29  = skipAtTag (natCode tagAxEqCong1) (natCode_isValue tagAxEqCong1)   tagCode_axSndLf payT b body_axEqCong1   next_axEqCong1
                  (teqDiff tagAxEqCong1   tagAxSndLf refl)
        s30  = skipAtTag (natCode tagAxEqCongL) (natCode_isValue tagAxEqCongL)   tagCode_axSndLf payT b body_axEqCongL   next_axEqCongL
                  (teqDiff tagAxEqCongL   tagAxSndLf refl)
        s31  = skipAtTag (natCode tagAxEqCongR) (natCode_isValue tagAxEqCongR)   tagCode_axSndLf payT b body_axEqCongR   next_axEqCongR
                  (teqDiff tagAxEqCongR   tagAxSndLf refl)
        s32  = skipAtTag (natCode tagAxK) (natCode_isValue tagAxK)         tagCode_axSndLf payT b body_axK         next_axK
                  (teqDiff tagAxK         tagAxSndLf refl)
        s33  = skipAtTag (natCode tagAxS) (natCode_isValue tagAxS)         tagCode_axSndLf payT b body_axS         next_axS
                  (teqDiff tagAxS         tagAxSndLf refl)
        s34  = skipAtTag (natCode tagAxNeg) (natCode_isValue tagAxNeg)       tagCode_axSndLf payT b body_axNeg       next_axNeg
                  (teqDiff tagAxNeg       tagAxSndLf refl)
        s35  = skipAtTag (natCode tagAxExFalso) (natCode_isValue tagAxExFalso)   tagCode_axSndLf payT b body_axExFalso   next_axExFalso
                  (teqDiff tagAxExFalso   tagAxSndLf refl)
        s36  = skipAtTag (natCode tagAxContrapos) (natCode_isValue tagAxContrapos) tagCode_axSndLf payT b body_axContrapos next_axContrapos
                  (teqDiff tagAxContrapos tagAxSndLf refl)
        s37  = skipAtTag (natCode tagMp) (natCode_isValue tagMp)          tagCode_axSndLf payT b body_mp          next_mp
                  (teqDiff tagMp          tagAxSndLf refl)
        s38  = skipAtTag (natCode tagRuleInst) (natCode_isValue tagRuleInst)    tagCode_axSndLf payT b body_ruleInst    next_ruleInst
                  (teqDiff tagRuleInst    tagAxSndLf refl)
        s39  = skipAtTag (natCode tagRuleIndBT) (natCode_isValue tagRuleIndBT)   tagCode_axSndLf payT b body_ruleIndBT   next_ruleIndBT
                  (teqDiff tagRuleIndBT   tagAxSndLf refl)
        s40  = skipAtTag (natCode tagAxFstLf) (natCode_isValue tagAxFstLf)     tagCode_axSndLf payT b body_axFstLf     next_axFstLf
                  (teqDiff tagAxFstLf     tagAxSndLf refl)
        hh   = hitAtTag (natCode tagAxSndLf) (natCode_isValue tagAxSndLf)     tagCode_axSndLf payT b body_axSndLf     next_axSndLf
                  (teqEq tagAxSndLf)
  ...
  body_axSndLf_eval_param payT bb =
    liftKT_eval outAxSndLf
                ...
                (ap2 Pair tagCode_axSndLf payT) bb
  ...
  -- body_axIfLfLL_eval moved to BRA2.Thm.Parts.AxIfLfLL .
  ...
  thmTDispAxIfLfLL =
    let payT = O
        ...
        s1   = skipAtTag (natCode tagAxI) (natCode_isValue tagAxI)         tagCode_axIfLfLL payT b body_axI         next_axI
                  (teqDiff tagAxI         tagAxIfLfLL refl)
        s2   = skipAtTag (natCode tagAxFst) (natCode_isValue tagAxFst)       tagCode_axIfLfLL payT b body_axFst       next_axFst
                  (teqDiff tagAxFst       tagAxIfLfLL refl)
        s3   = skipAtTag (natCode tagAxSnd) (natCode_isValue tagAxSnd)       tagCode_axIfLfLL payT b body_axSnd       next_axSnd
                  (teqDiff tagAxSnd       tagAxIfLfLL refl)
        s4   = skipAtTag (natCode tagAxConst) (natCode_isValue tagAxConst)     tagCode_axIfLfLL payT b body_axConst     next_axConst
                  (teqDiff tagAxConst     tagAxIfLfLL refl)
        s5   = skipAtTag (natCode tagAxComp) (natCode_isValue tagAxComp)      tagCode_axIfLfLL payT b body_axComp      next_axComp
                  (teqDiff tagAxComp      tagAxIfLfLL refl)
        s6   = skipAtTag (natCode tagAxComp2) (natCode_isValue tagAxComp2)     tagCode_axIfLfLL payT b body_axComp2     next_axComp2
                  (teqDiff tagAxComp2     tagAxIfLfLL refl)
        s7   = skipAtTag (natCode tagAxLift) (natCode_isValue tagAxLift)      tagCode_axIfLfLL payT b body_axLift      next_axLift
                  (teqDiff tagAxLift      tagAxIfLfLL refl)
        s8   = skipAtTag (natCode tagAxPost) (natCode_isValue tagAxPost)      tagCode_axIfLfLL payT b body_axPost      next_axPost
                  (teqDiff tagAxPost      tagAxIfLfLL refl)
        s9   = skipAtTag (natCode tagAxFan) (natCode_isValue tagAxFan)       tagCode_axIfLfLL payT b body_axFan       next_axFan
                  (teqDiff tagAxFan       tagAxIfLfLL refl)
        s10  = skipAtTag (natCode tagAxKT) (natCode_isValue tagAxKT)        tagCode_axIfLfLL payT b body_axZ         next_axKT
                  (teqDiff tagAxKT        tagAxIfLfLL refl)
        s15  = skipAtTag (natCode tagAxIfLfL) (natCode_isValue tagAxIfLfL)     tagCode_axIfLfLL payT b body_axIfLfL     next_axIfLfL
                  (teqDiff tagAxIfLfL     tagAxIfLfLL refl)
        s16  = skipAtTag (natCode tagAxIfLfN) (natCode_isValue tagAxIfLfN)     tagCode_axIfLfLL payT b body_axIfLfN     next_axIfLfN
                  (teqDiff tagAxIfLfN     tagAxIfLfLL refl)
        s17  = skipAtTag (natCode tagAxTreeEqLL) (natCode_isValue tagAxTreeEqLL)  tagCode_axIfLfLL payT b body_axTreeEqLL  next_axTreeEqLL
                  (teqDiff tagAxTreeEqLL  tagAxIfLfLL refl)
        s18  = skipAtTag (natCode tagAxTreeEqLN) (natCode_isValue tagAxTreeEqLN)  tagCode_axIfLfLL payT b body_axTreeEqLN  next_axTreeEqLN
                  (teqDiff tagAxTreeEqLN  tagAxIfLfLL refl)
        s19  = skipAtTag (natCode tagAxTreeEqNL) (natCode_isValue tagAxTreeEqNL)  tagCode_axIfLfLL payT b body_axTreeEqNL  next_axTreeEqNL
                  (teqDiff tagAxTreeEqNL  tagAxIfLfLL refl)
        s20  = skipAtTag (natCode tagAxTreeEqNN) (natCode_isValue tagAxTreeEqNN)  tagCode_axIfLfLL payT b body_axTreeEqNN  next_axTreeEqNN
                  (teqDiff tagAxTreeEqNN  tagAxIfLfLL refl)
        s21  = skipAtTag (natCode tagAxGoodstein) (natCode_isValue tagAxGoodstein) tagCode_axIfLfLL payT b body_axGoodstein next_axGoodstein
                  (teqDiff tagAxGoodstein tagAxIfLfLL refl)
        s22  = skipAtTag (natCode tagAxRefl) (natCode_isValue tagAxRefl)      tagCode_axIfLfLL payT b body_axRefl      next_axRefl
                  (teqDiff tagAxRefl      tagAxIfLfLL refl)
        s23  = skipAtTag (natCode tagRuleSym) (natCode_isValue tagRuleSym)     tagCode_axIfLfLL payT b body_ruleSym     next_ruleSym
                  (teqDiff tagRuleSym     tagAxIfLfLL refl)
        s24  = skipAtTag (natCode tagRuleTrans) (natCode_isValue tagRuleTrans)   tagCode_axIfLfLL payT b body_ruleTrans   next_ruleTrans
                  (teqDiff tagRuleTrans   tagAxIfLfLL refl)
        s25  = skipAtTag (natCode tagCong1) (natCode_isValue tagCong1)       tagCode_axIfLfLL payT b body_cong1       next_cong1
                  (teqDiff tagCong1       tagAxIfLfLL refl)
        s26  = skipAtTag (natCode tagCongL) (natCode_isValue tagCongL)       tagCode_axIfLfLL payT b body_congL       next_congL
                  (teqDiff tagCongL       tagAxIfLfLL refl)
        s27  = skipAtTag (natCode tagCongR) (natCode_isValue tagCongR)       tagCode_axIfLfLL payT b body_congR       next_congR
                  (teqDiff tagCongR       tagAxIfLfLL refl)
        s28  = skipAtTag (natCode tagAxEqTrans) (natCode_isValue tagAxEqTrans)   tagCode_axIfLfLL payT b body_axEqTrans   next_axEqTrans
                  (teqDiff tagAxEqTrans   tagAxIfLfLL refl)
        s29  = skipAtTag (natCode tagAxEqCong1) (natCode_isValue tagAxEqCong1)   tagCode_axIfLfLL payT b body_axEqCong1   next_axEqCong1
                  (teqDiff tagAxEqCong1   tagAxIfLfLL refl)
        s30  = skipAtTag (natCode tagAxEqCongL) (natCode_isValue tagAxEqCongL)   tagCode_axIfLfLL payT b body_axEqCongL   next_axEqCongL
                  (teqDiff tagAxEqCongL   tagAxIfLfLL refl)
        s31  = skipAtTag (natCode tagAxEqCongR) (natCode_isValue tagAxEqCongR)   tagCode_axIfLfLL payT b body_axEqCongR   next_axEqCongR
                  (teqDiff tagAxEqCongR   tagAxIfLfLL refl)
        s32  = skipAtTag (natCode tagAxK) (natCode_isValue tagAxK)         tagCode_axIfLfLL payT b body_axK         next_axK
                  (teqDiff tagAxK         tagAxIfLfLL refl)
        s33  = skipAtTag (natCode tagAxS) (natCode_isValue tagAxS)         tagCode_axIfLfLL payT b body_axS         next_axS
                  (teqDiff tagAxS         tagAxIfLfLL refl)
        s34  = skipAtTag (natCode tagAxNeg) (natCode_isValue tagAxNeg)       tagCode_axIfLfLL payT b body_axNeg       next_axNeg
                  (teqDiff tagAxNeg       tagAxIfLfLL refl)
        s35  = skipAtTag (natCode tagAxExFalso) (natCode_isValue tagAxExFalso)   tagCode_axIfLfLL payT b body_axExFalso   next_axExFalso
                  (teqDiff tagAxExFalso   tagAxIfLfLL refl)
        s36  = skipAtTag (natCode tagAxContrapos) (natCode_isValue tagAxContrapos) tagCode_axIfLfLL payT b body_axContrapos next_axContrapos
                  (teqDiff tagAxContrapos tagAxIfLfLL refl)
        s37  = skipAtTag (natCode tagMp) (natCode_isValue tagMp)          tagCode_axIfLfLL payT b body_mp          next_mp
                  (teqDiff tagMp          tagAxIfLfLL refl)
        s38  = skipAtTag (natCode tagRuleInst) (natCode_isValue tagRuleInst)    tagCode_axIfLfLL payT b body_ruleInst    next_ruleInst
                  (teqDiff tagRuleInst    tagAxIfLfLL refl)
        s39  = skipAtTag (natCode tagRuleIndBT) (natCode_isValue tagRuleIndBT)   tagCode_axIfLfLL payT b body_ruleIndBT   next_ruleIndBT
                  (teqDiff tagRuleIndBT   tagAxIfLfLL refl)
        s40  = skipAtTag (natCode tagAxFstLf) (natCode_isValue tagAxFstLf)     tagCode_axIfLfLL payT b body_axFstLf     next_axFstLf
                  (teqDiff tagAxFstLf     tagAxIfLfLL refl)
        s41  = skipAtTag (natCode tagAxSndLf) (natCode_isValue tagAxSndLf)     tagCode_axIfLfLL payT b body_axSndLf     next_axSndLf
                  (teqDiff tagAxSndLf     tagAxIfLfLL refl)
        hh   = hitAtTag (natCode tagAxIfLfLL) (natCode_isValue tagAxIfLfLL)    tagCode_axIfLfLL payT b body_axIfLfLL    next_axIfLfLL
                  (teqEq tagAxIfLfLL)
  ...
  body_axIfLfLL_eval_param payT bb =
    liftKT_eval outAxIfLfLL
                ...
                (ap2 Pair tagCode_axIfLfLL payT) bb
  ...
  body_axIfLfNL_eval x' y' bb =
    let payX  = reify (code x')
        ...
        l1 = pairOfConst_eval K_pairV K_pairV_isValue (Lift Snd) a bb payT snd_a
        l2 = pairOfConst_eval K_a2V K_a2V_isValue
                (Fan (Lift (KT K_pair)) (Lift Snd) Pair) a bb
        ...
        l3 = pairOfFan_eval
                ...
                l2 (liftKT_eval lf valO a bb)
        l4 = pairOfConst_eval K_ifLfV K_ifLfV_isValue
                (Fan (Fan (Lift (KT K_a2))
                ...
                l3
        l5 = pairOfConst_eval K_a2V K_a2V_isValue
                (Fan (Lift (KT K_ifLf))
                     (Fan (Fan (Lift (KT K_a2))
                               (Fan (Lift (KT K_pair)) (Lift Snd) Pair)
                               Pair)
  ...
  thmTDispAxIfLfNL x' y' =
    let payT = reify (nd (code x') (code y'))
        ...
        s1   = skipAtTag (natCode tagAxI) (natCode_isValue tagAxI)         tagCode_axIfLfNL payT b body_axI         next_axI
                  (teqDiff tagAxI         tagAxIfLfNL refl)
        s2   = skipAtTag (natCode tagAxFst) (natCode_isValue tagAxFst)       tagCode_axIfLfNL payT b body_axFst       next_axFst
                  (teqDiff tagAxFst       tagAxIfLfNL refl)
        s3   = skipAtTag (natCode tagAxSnd) (natCode_isValue tagAxSnd)       tagCode_axIfLfNL payT b body_axSnd       next_axSnd
                  (teqDiff tagAxSnd       tagAxIfLfNL refl)
        s4   = skipAtTag (natCode tagAxConst) (natCode_isValue tagAxConst)     tagCode_axIfLfNL payT b body_axConst     next_axConst
                  (teqDiff tagAxConst     tagAxIfLfNL refl)
        s5   = skipAtTag (natCode tagAxComp) (natCode_isValue tagAxComp)      tagCode_axIfLfNL payT b body_axComp      next_axComp
                  (teqDiff tagAxComp      tagAxIfLfNL refl)
        s6   = skipAtTag (natCode tagAxComp2) (natCode_isValue tagAxComp2)     tagCode_axIfLfNL payT b body_axComp2     next_axComp2
                  (teqDiff tagAxComp2     tagAxIfLfNL refl)
        s7   = skipAtTag (natCode tagAxLift) (natCode_isValue tagAxLift)      tagCode_axIfLfNL payT b body_axLift      next_axLift
                  (teqDiff tagAxLift      tagAxIfLfNL refl)
        s8   = skipAtTag (natCode tagAxPost) (natCode_isValue tagAxPost)      tagCode_axIfLfNL payT b body_axPost      next_axPost
                  (teqDiff tagAxPost      tagAxIfLfNL refl)
        s9   = skipAtTag (natCode tagAxFan) (natCode_isValue tagAxFan)       tagCode_axIfLfNL payT b body_axFan       next_axFan
                  (teqDiff tagAxFan       tagAxIfLfNL refl)
        s10  = skipAtTag (natCode tagAxKT) (natCode_isValue tagAxKT)        tagCode_axIfLfNL payT b body_axZ         next_axKT
                  (teqDiff tagAxKT        tagAxIfLfNL refl)
        s15  = skipAtTag (natCode tagAxIfLfL) (natCode_isValue tagAxIfLfL)     tagCode_axIfLfNL payT b body_axIfLfL     next_axIfLfL
                  (teqDiff tagAxIfLfL     tagAxIfLfNL refl)
        s16  = skipAtTag (natCode tagAxIfLfN) (natCode_isValue tagAxIfLfN)     tagCode_axIfLfNL payT b body_axIfLfN     next_axIfLfN
                  (teqDiff tagAxIfLfN     tagAxIfLfNL refl)
        s17  = skipAtTag (natCode tagAxTreeEqLL) (natCode_isValue tagAxTreeEqLL)  tagCode_axIfLfNL payT b body_axTreeEqLL  next_axTreeEqLL
                  (teqDiff tagAxTreeEqLL  tagAxIfLfNL refl)
        s18  = skipAtTag (natCode tagAxTreeEqLN) (natCode_isValue tagAxTreeEqLN)  tagCode_axIfLfNL payT b body_axTreeEqLN  next_axTreeEqLN
                  (teqDiff tagAxTreeEqLN  tagAxIfLfNL refl)
        s19  = skipAtTag (natCode tagAxTreeEqNL) (natCode_isValue tagAxTreeEqNL)  tagCode_axIfLfNL payT b body_axTreeEqNL  next_axTreeEqNL
                  (teqDiff tagAxTreeEqNL  tagAxIfLfNL refl)
        s20  = skipAtTag (natCode tagAxTreeEqNN) (natCode_isValue tagAxTreeEqNN)  tagCode_axIfLfNL payT b body_axTreeEqNN  next_axTreeEqNN
                  (teqDiff tagAxTreeEqNN  tagAxIfLfNL refl)
        s21  = skipAtTag (natCode tagAxGoodstein) (natCode_isValue tagAxGoodstein) tagCode_axIfLfNL payT b body_axGoodstein next_axGoodstein
                  (teqDiff tagAxGoodstein tagAxIfLfNL refl)
        s22  = skipAtTag (natCode tagAxRefl) (natCode_isValue tagAxRefl)      tagCode_axIfLfNL payT b body_axRefl      next_axRefl
                  (teqDiff tagAxRefl      tagAxIfLfNL refl)
        s23  = skipAtTag (natCode tagRuleSym) (natCode_isValue tagRuleSym)     tagCode_axIfLfNL payT b body_ruleSym     next_ruleSym
                  (teqDiff tagRuleSym     tagAxIfLfNL refl)
        s24  = skipAtTag (natCode tagRuleTrans) (natCode_isValue tagRuleTrans)   tagCode_axIfLfNL payT b body_ruleTrans   next_ruleTrans
                  (teqDiff tagRuleTrans   tagAxIfLfNL refl)
        s25  = skipAtTag (natCode tagCong1) (natCode_isValue tagCong1)       tagCode_axIfLfNL payT b body_cong1       next_cong1
                  (teqDiff tagCong1       tagAxIfLfNL refl)
        s26  = skipAtTag (natCode tagCongL) (natCode_isValue tagCongL)       tagCode_axIfLfNL payT b body_congL       next_congL
                  (teqDiff tagCongL       tagAxIfLfNL refl)
        s27  = skipAtTag (natCode tagCongR) (natCode_isValue tagCongR)       tagCode_axIfLfNL payT b body_congR       next_congR
                  (teqDiff tagCongR       tagAxIfLfNL refl)
        s28  = skipAtTag (natCode tagAxEqTrans) (natCode_isValue tagAxEqTrans)   tagCode_axIfLfNL payT b body_axEqTrans   next_axEqTrans
                  (teqDiff tagAxEqTrans   tagAxIfLfNL refl)
        s29  = skipAtTag (natCode tagAxEqCong1) (natCode_isValue tagAxEqCong1)   tagCode_axIfLfNL payT b body_axEqCong1   next_axEqCong1
                  (teqDiff tagAxEqCong1   tagAxIfLfNL refl)
        s30  = skipAtTag (natCode tagAxEqCongL) (natCode_isValue tagAxEqCongL)   tagCode_axIfLfNL payT b body_axEqCongL   next_axEqCongL
                  (teqDiff tagAxEqCongL   tagAxIfLfNL refl)
        s31  = skipAtTag (natCode tagAxEqCongR) (natCode_isValue tagAxEqCongR)   tagCode_axIfLfNL payT b body_axEqCongR   next_axEqCongR
                  (teqDiff tagAxEqCongR   tagAxIfLfNL refl)
        s32  = skipAtTag (natCode tagAxK) (natCode_isValue tagAxK)         tagCode_axIfLfNL payT b body_axK         next_axK
                  (teqDiff tagAxK         tagAxIfLfNL refl)
        s33  = skipAtTag (natCode tagAxS) (natCode_isValue tagAxS)         tagCode_axIfLfNL payT b body_axS         next_axS
                  (teqDiff tagAxS         tagAxIfLfNL refl)
        s34  = skipAtTag (natCode tagAxNeg) (natCode_isValue tagAxNeg)       tagCode_axIfLfNL payT b body_axNeg       next_axNeg
                  (teqDiff tagAxNeg       tagAxIfLfNL refl)
        s35  = skipAtTag (natCode tagAxExFalso) (natCode_isValue tagAxExFalso)   tagCode_axIfLfNL payT b body_axExFalso   next_axExFalso
                  (teqDiff tagAxExFalso   tagAxIfLfNL refl)
        s36  = skipAtTag (natCode tagAxContrapos) (natCode_isValue tagAxContrapos) tagCode_axIfLfNL payT b body_axContrapos next_axContrapos
                  (teqDiff tagAxContrapos tagAxIfLfNL refl)
        s37  = skipAtTag (natCode tagMp) (natCode_isValue tagMp)          tagCode_axIfLfNL payT b body_mp          next_mp
                  (teqDiff tagMp          tagAxIfLfNL refl)
        s38  = skipAtTag (natCode tagRuleInst) (natCode_isValue tagRuleInst)    tagCode_axIfLfNL payT b body_ruleInst    next_ruleInst
                  (teqDiff tagRuleInst    tagAxIfLfNL refl)
        s39  = skipAtTag (natCode tagRuleIndBT) (natCode_isValue tagRuleIndBT)   tagCode_axIfLfNL payT b body_ruleIndBT   next_ruleIndBT
                  (teqDiff tagRuleIndBT   tagAxIfLfNL refl)
        s40  = skipAtTag (natCode tagAxFstLf) (natCode_isValue tagAxFstLf)     tagCode_axIfLfNL payT b body_axFstLf     next_axFstLf
                  (teqDiff tagAxFstLf     tagAxIfLfNL refl)
        s41  = skipAtTag (natCode tagAxSndLf) (natCode_isValue tagAxSndLf)     tagCode_axIfLfNL payT b body_axSndLf     next_axSndLf
                  (teqDiff tagAxSndLf     tagAxIfLfNL refl)
        s42  = skipAtTag (natCode tagAxIfLfLL) (natCode_isValue tagAxIfLfLL)    tagCode_axIfLfNL payT b body_axIfLfLL    next_axIfLfLL
                  (teqDiff tagAxIfLfLL    tagAxIfLfNL refl)
        hh   = hitAtTag (natCode tagAxIfLfNL) (natCode_isValue tagAxIfLfNL)    tagCode_axIfLfNL payT b body_axIfLfNL    next_axIfLfNL
                  (teqEq tagAxIfLfNL)
  ...
  thmTDispMp P Q y1 y2 y1' shape d1 dh =
    let payT = reify (nd y1 y2)
        ...
        s1   = skipAtTag (natCode tagAxI) (natCode_isValue tagAxI)         tagCode_mp payT b body_axI         next_axI
                  (teqDiff tagAxI         tagMp refl)
        s2   = skipAtTag (natCode tagAxFst) (natCode_isValue tagAxFst)       tagCode_mp payT b body_axFst       next_axFst
                  (teqDiff tagAxFst       tagMp refl)
        s3   = skipAtTag (natCode tagAxSnd) (natCode_isValue tagAxSnd)       tagCode_mp payT b body_axSnd       next_axSnd
                  (teqDiff tagAxSnd       tagMp refl)
        s4   = skipAtTag (natCode tagAxConst) (natCode_isValue tagAxConst)     tagCode_mp payT b body_axConst     next_axConst
                  (teqDiff tagAxConst     tagMp refl)
        s5   = skipAtTag (natCode tagAxComp) (natCode_isValue tagAxComp)      tagCode_mp payT b body_axComp      next_axComp
                  (teqDiff tagAxComp      tagMp refl)
        s6   = skipAtTag (natCode tagAxComp2) (natCode_isValue tagAxComp2)     tagCode_mp payT b body_axComp2     next_axComp2
                  (teqDiff tagAxComp2     tagMp refl)
        s7   = skipAtTag (natCode tagAxLift) (natCode_isValue tagAxLift)      tagCode_mp payT b body_axLift      next_axLift
                  (teqDiff tagAxLift      tagMp refl)
        s8   = skipAtTag (natCode tagAxPost) (natCode_isValue tagAxPost)      tagCode_mp payT b body_axPost      next_axPost
                  (teqDiff tagAxPost      tagMp refl)
        s9   = skipAtTag (natCode tagAxFan) (natCode_isValue tagAxFan)       tagCode_mp payT b body_axFan       next_axFan
                  (teqDiff tagAxFan       tagMp refl)
        s10  = skipAtTag (natCode tagAxKT) (natCode_isValue tagAxKT)        tagCode_mp payT b body_axZ        next_axKT
                  (teqDiff tagAxKT        tagMp refl)
        s15  = skipAtTag (natCode tagAxIfLfL) (natCode_isValue tagAxIfLfL)     tagCode_mp payT b body_axIfLfL     next_axIfLfL
                  (teqDiff tagAxIfLfL     tagMp refl)
        s16  = skipAtTag (natCode tagAxIfLfN) (natCode_isValue tagAxIfLfN)     tagCode_mp payT b body_axIfLfN     next_axIfLfN
                  (teqDiff tagAxIfLfN     tagMp refl)
        s17  = skipAtTag (natCode tagAxTreeEqLL) (natCode_isValue tagAxTreeEqLL)  tagCode_mp payT b body_axTreeEqLL  next_axTreeEqLL
                  (teqDiff tagAxTreeEqLL  tagMp refl)
        s18  = skipAtTag (natCode tagAxTreeEqLN) (natCode_isValue tagAxTreeEqLN)  tagCode_mp payT b body_axTreeEqLN  next_axTreeEqLN
                  (teqDiff tagAxTreeEqLN  tagMp refl)
        s19  = skipAtTag (natCode tagAxTreeEqNL) (natCode_isValue tagAxTreeEqNL)  tagCode_mp payT b body_axTreeEqNL  next_axTreeEqNL
                  (teqDiff tagAxTreeEqNL  tagMp refl)
        s20  = skipAtTag (natCode tagAxTreeEqNN) (natCode_isValue tagAxTreeEqNN)  tagCode_mp payT b body_axTreeEqNN  next_axTreeEqNN
                  (teqDiff tagAxTreeEqNN  tagMp refl)
        s21  = skipAtTag (natCode tagAxGoodstein) (natCode_isValue tagAxGoodstein) tagCode_mp payT b body_axGoodstein next_axGoodstein
                  (teqDiff tagAxGoodstein tagMp refl)
        s22  = skipAtTag (natCode tagAxRefl) (natCode_isValue tagAxRefl)      tagCode_mp payT b body_axRefl      next_axRefl
                  (teqDiff tagAxRefl      tagMp refl)
        s23  = skipAtTag (natCode tagRuleSym) (natCode_isValue tagRuleSym)     tagCode_mp payT b body_ruleSym     next_ruleSym
                  (teqDiff tagRuleSym     tagMp refl)
        s24  = skipAtTag (natCode tagRuleTrans) (natCode_isValue tagRuleTrans)   tagCode_mp payT b body_ruleTrans   next_ruleTrans
                  (teqDiff tagRuleTrans   tagMp refl)
        s25  = skipAtTag (natCode tagCong1) (natCode_isValue tagCong1)       tagCode_mp payT b body_cong1       next_cong1
                  (teqDiff tagCong1       tagMp refl)
        s26  = skipAtTag (natCode tagCongL) (natCode_isValue tagCongL)       tagCode_mp payT b body_congL       next_congL
                  (teqDiff tagCongL       tagMp refl)
        s27  = skipAtTag (natCode tagCongR) (natCode_isValue tagCongR)       tagCode_mp payT b body_congR       next_congR
                  (teqDiff tagCongR       tagMp refl)
        s28  = skipAtTag (natCode tagAxEqTrans) (natCode_isValue tagAxEqTrans)   tagCode_mp payT b body_axEqTrans   next_axEqTrans
                  (teqDiff tagAxEqTrans   tagMp refl)
        s29  = skipAtTag (natCode tagAxEqCong1) (natCode_isValue tagAxEqCong1)   tagCode_mp payT b body_axEqCong1   next_axEqCong1
                  (teqDiff tagAxEqCong1   tagMp refl)
        s30  = skipAtTag (natCode tagAxEqCongL) (natCode_isValue tagAxEqCongL)   tagCode_mp payT b body_axEqCongL   next_axEqCongL
                  (teqDiff tagAxEqCongL   tagMp refl)
        s31  = skipAtTag (natCode tagAxEqCongR) (natCode_isValue tagAxEqCongR)   tagCode_mp payT b body_axEqCongR   next_axEqCongR
                  (teqDiff tagAxEqCongR   tagMp refl)
        s32  = skipAtTag (natCode tagAxK) (natCode_isValue tagAxK)         tagCode_mp payT b body_axK         next_axK
                  (teqDiff tagAxK         tagMp refl)
        s33  = skipAtTag (natCode tagAxS) (natCode_isValue tagAxS)         tagCode_mp payT b body_axS         next_axS
                  (teqDiff tagAxS         tagMp refl)
        s34  = skipAtTag (natCode tagAxNeg) (natCode_isValue tagAxNeg)       tagCode_mp payT b body_axNeg       next_axNeg
                  (teqDiff tagAxNeg       tagMp refl)
        s35  = skipAtTag (natCode tagAxExFalso) (natCode_isValue tagAxExFalso)   tagCode_mp payT b body_axExFalso   next_axExFalso
                  (teqDiff tagAxExFalso   tagMp refl)
        s36  = skipAtTag (natCode tagAxContrapos) (natCode_isValue tagAxContrapos) tagCode_mp payT b body_axContrapos next_axContrapos
                  (teqDiff tagAxContrapos tagMp refl)
        hh   = hitAtTag (natCode tagMp) (natCode_isValue tagMp)          tagCode_mp payT b body_mp          next_mp
                  (teqEq tagMp)
        sndB_unfold : Deriv (atomic (eqn (ap1 Snd b) (ap1 thmT payT)))
  ...
  thmTDispRuleTrans t u v y1 y2 y1' shape d1 d2 =
    let payT = reify (nd y1 y2)
        ...
        s1   = skipAtTag (natCode tagAxI) (natCode_isValue tagAxI)         tagCode_ruleTrans payT b body_axI         next_axI
                  (teqDiff tagAxI         tagRuleTrans refl)
        s2   = skipAtTag (natCode tagAxFst) (natCode_isValue tagAxFst)       tagCode_ruleTrans payT b body_axFst       next_axFst
                  (teqDiff tagAxFst       tagRuleTrans refl)
        s3   = skipAtTag (natCode tagAxSnd) (natCode_isValue tagAxSnd)       tagCode_ruleTrans payT b body_axSnd       next_axSnd
                  (teqDiff tagAxSnd       tagRuleTrans refl)
        s4   = skipAtTag (natCode tagAxConst) (natCode_isValue tagAxConst)     tagCode_ruleTrans payT b body_axConst     next_axConst
                  (teqDiff tagAxConst     tagRuleTrans refl)
        s5   = skipAtTag (natCode tagAxComp) (natCode_isValue tagAxComp)      tagCode_ruleTrans payT b body_axComp      next_axComp
                  (teqDiff tagAxComp      tagRuleTrans refl)
        s6   = skipAtTag (natCode tagAxComp2) (natCode_isValue tagAxComp2)     tagCode_ruleTrans payT b body_axComp2     next_axComp2
                  (teqDiff tagAxComp2     tagRuleTrans refl)
        s7   = skipAtTag (natCode tagAxLift) (natCode_isValue tagAxLift)      tagCode_ruleTrans payT b body_axLift      next_axLift
                  (teqDiff tagAxLift      tagRuleTrans refl)
        s8   = skipAtTag (natCode tagAxPost) (natCode_isValue tagAxPost)      tagCode_ruleTrans payT b body_axPost      next_axPost
                  (teqDiff tagAxPost      tagRuleTrans refl)
        s9   = skipAtTag (natCode tagAxFan) (natCode_isValue tagAxFan)       tagCode_ruleTrans payT b body_axFan       next_axFan
                  (teqDiff tagAxFan       tagRuleTrans refl)
        s10  = skipAtTag (natCode tagAxKT) (natCode_isValue tagAxKT)        tagCode_ruleTrans payT b body_axZ        next_axKT
                  (teqDiff tagAxKT        tagRuleTrans refl)
        s15  = skipAtTag (natCode tagAxIfLfL) (natCode_isValue tagAxIfLfL)     tagCode_ruleTrans payT b body_axIfLfL     next_axIfLfL
                  (teqDiff tagAxIfLfL     tagRuleTrans refl)
        s16  = skipAtTag (natCode tagAxIfLfN) (natCode_isValue tagAxIfLfN)     tagCode_ruleTrans payT b body_axIfLfN     next_axIfLfN
                  (teqDiff tagAxIfLfN     tagRuleTrans refl)
        s17  = skipAtTag (natCode tagAxTreeEqLL) (natCode_isValue tagAxTreeEqLL)  tagCode_ruleTrans payT b body_axTreeEqLL  next_axTreeEqLL
                  (teqDiff tagAxTreeEqLL  tagRuleTrans refl)
        s18  = skipAtTag (natCode tagAxTreeEqLN) (natCode_isValue tagAxTreeEqLN)  tagCode_ruleTrans payT b body_axTreeEqLN  next_axTreeEqLN
                  (teqDiff tagAxTreeEqLN  tagRuleTrans refl)
        s19  = skipAtTag (natCode tagAxTreeEqNL) (natCode_isValue tagAxTreeEqNL)  tagCode_ruleTrans payT b body_axTreeEqNL  next_axTreeEqNL
                  (teqDiff tagAxTreeEqNL  tagRuleTrans refl)
        s20  = skipAtTag (natCode tagAxTreeEqNN) (natCode_isValue tagAxTreeEqNN)  tagCode_ruleTrans payT b body_axTreeEqNN  next_axTreeEqNN
                  (teqDiff tagAxTreeEqNN  tagRuleTrans refl)
        s21  = skipAtTag (natCode tagAxGoodstein) (natCode_isValue tagAxGoodstein) tagCode_ruleTrans payT b body_axGoodstein next_axGoodstein
                  (teqDiff tagAxGoodstein tagRuleTrans refl)
        s22  = skipAtTag (natCode tagAxRefl) (natCode_isValue tagAxRefl)      tagCode_ruleTrans payT b body_axRefl      next_axRefl
                  (teqDiff tagAxRefl      tagRuleTrans refl)
        s23  = skipAtTag (natCode tagRuleSym) (natCode_isValue tagRuleSym)     tagCode_ruleTrans payT b body_ruleSym     next_ruleSym
                  (teqDiff tagRuleSym     tagRuleTrans refl)
        hh   = hitAtTag (natCode tagRuleTrans) (natCode_isValue tagRuleTrans)   tagCode_ruleTrans payT b body_ruleTrans   next_ruleTrans
                  (teqEq tagRuleTrans)
        sndB_unfold : Deriv (atomic (eqn (ap1 Snd b) (ap1 thmT payT)))
  ...
  thmTDispCong1 f t u y_h d_h =
    let payT = reify (nd (codeF1 f) y_h)
        ...
        s1   = skipAtTag (natCode tagAxI) (natCode_isValue tagAxI)         tagCode_cong1 payT b body_axI         next_axI
                  (teqDiff tagAxI         tagCong1 refl)
        s2   = skipAtTag (natCode tagAxFst) (natCode_isValue tagAxFst)       tagCode_cong1 payT b body_axFst       next_axFst
                  (teqDiff tagAxFst       tagCong1 refl)
        s3   = skipAtTag (natCode tagAxSnd) (natCode_isValue tagAxSnd)       tagCode_cong1 payT b body_axSnd       next_axSnd
                  (teqDiff tagAxSnd       tagCong1 refl)
        s4   = skipAtTag (natCode tagAxConst) (natCode_isValue tagAxConst)     tagCode_cong1 payT b body_axConst     next_axConst
                  (teqDiff tagAxConst     tagCong1 refl)
        s5   = skipAtTag (natCode tagAxComp) (natCode_isValue tagAxComp)      tagCode_cong1 payT b body_axComp      next_axComp
                  (teqDiff tagAxComp      tagCong1 refl)
        s6   = skipAtTag (natCode tagAxComp2) (natCode_isValue tagAxComp2)     tagCode_cong1 payT b body_axComp2     next_axComp2
                  (teqDiff tagAxComp2     tagCong1 refl)
        s7   = skipAtTag (natCode tagAxLift) (natCode_isValue tagAxLift)      tagCode_cong1 payT b body_axLift      next_axLift
                  (teqDiff tagAxLift      tagCong1 refl)
        s8   = skipAtTag (natCode tagAxPost) (natCode_isValue tagAxPost)      tagCode_cong1 payT b body_axPost      next_axPost
                  (teqDiff tagAxPost      tagCong1 refl)
        s9   = skipAtTag (natCode tagAxFan) (natCode_isValue tagAxFan)       tagCode_cong1 payT b body_axFan       next_axFan
                  (teqDiff tagAxFan       tagCong1 refl)
        s10  = skipAtTag (natCode tagAxKT) (natCode_isValue tagAxKT)        tagCode_cong1 payT b body_axZ        next_axKT
                  (teqDiff tagAxKT        tagCong1 refl)
        s15  = skipAtTag (natCode tagAxIfLfL) (natCode_isValue tagAxIfLfL)     tagCode_cong1 payT b body_axIfLfL     next_axIfLfL
                  (teqDiff tagAxIfLfL     tagCong1 refl)
        s16  = skipAtTag (natCode tagAxIfLfN) (natCode_isValue tagAxIfLfN)     tagCode_cong1 payT b body_axIfLfN     next_axIfLfN
                  (teqDiff tagAxIfLfN     tagCong1 refl)
        s17  = skipAtTag (natCode tagAxTreeEqLL) (natCode_isValue tagAxTreeEqLL)  tagCode_cong1 payT b body_axTreeEqLL  next_axTreeEqLL
                  (teqDiff tagAxTreeEqLL  tagCong1 refl)
        s18  = skipAtTag (natCode tagAxTreeEqLN) (natCode_isValue tagAxTreeEqLN)  tagCode_cong1 payT b body_axTreeEqLN  next_axTreeEqLN
                  (teqDiff tagAxTreeEqLN  tagCong1 refl)
        s19  = skipAtTag (natCode tagAxTreeEqNL) (natCode_isValue tagAxTreeEqNL)  tagCode_cong1 payT b body_axTreeEqNL  next_axTreeEqNL
                  (teqDiff tagAxTreeEqNL  tagCong1 refl)
        s20  = skipAtTag (natCode tagAxTreeEqNN) (natCode_isValue tagAxTreeEqNN)  tagCode_cong1 payT b body_axTreeEqNN  next_axTreeEqNN
                  (teqDiff tagAxTreeEqNN  tagCong1 refl)
        s21  = skipAtTag (natCode tagAxGoodstein) (natCode_isValue tagAxGoodstein) tagCode_cong1 payT b body_axGoodstein next_axGoodstein
                  (teqDiff tagAxGoodstein tagCong1 refl)
        s22  = skipAtTag (natCode tagAxRefl) (natCode_isValue tagAxRefl)      tagCode_cong1 payT b body_axRefl      next_axRefl
                  (teqDiff tagAxRefl      tagCong1 refl)
        s23  = skipAtTag (natCode tagRuleSym) (natCode_isValue tagRuleSym)     tagCode_cong1 payT b body_ruleSym     next_ruleSym
                  (teqDiff tagRuleSym     tagCong1 refl)
        s24  = skipAtTag (natCode tagRuleTrans) (natCode_isValue tagRuleTrans)   tagCode_cong1 payT b body_ruleTrans   next_ruleTrans
                  (teqDiff tagRuleTrans   tagCong1 refl)
        hh   = hitAtTag (natCode tagCong1) (natCode_isValue tagCong1)       tagCode_cong1 payT b body_cong1       next_cong1
                  (teqEq tagCong1)
        sndB_unfold : Deriv (atomic (eqn (ap1 Snd b) (ap1 thmT payT)))
  ...
  thmTDispCongL g x t u y_h y_h' shape_h d_h =
    let payG : Term
        ...
        s1   = skipAtTag (natCode tagAxI) (natCode_isValue tagAxI)         tagCode_congL payT b body_axI         next_axI
                  (teqDiff tagAxI         tagCongL refl)
        s2   = skipAtTag (natCode tagAxFst) (natCode_isValue tagAxFst)       tagCode_congL payT b body_axFst       next_axFst
                  (teqDiff tagAxFst       tagCongL refl)
        s3   = skipAtTag (natCode tagAxSnd) (natCode_isValue tagAxSnd)       tagCode_congL payT b body_axSnd       next_axSnd
                  (teqDiff tagAxSnd       tagCongL refl)
        s4   = skipAtTag (natCode tagAxConst) (natCode_isValue tagAxConst)     tagCode_congL payT b body_axConst     next_axConst
                  (teqDiff tagAxConst     tagCongL refl)
        s5   = skipAtTag (natCode tagAxComp) (natCode_isValue tagAxComp)      tagCode_congL payT b body_axComp      next_axComp
                  (teqDiff tagAxComp      tagCongL refl)
        s6   = skipAtTag (natCode tagAxComp2) (natCode_isValue tagAxComp2)     tagCode_congL payT b body_axComp2     next_axComp2
                  (teqDiff tagAxComp2     tagCongL refl)
        s7   = skipAtTag (natCode tagAxLift) (natCode_isValue tagAxLift)      tagCode_congL payT b body_axLift      next_axLift
                  (teqDiff tagAxLift      tagCongL refl)
        s8   = skipAtTag (natCode tagAxPost) (natCode_isValue tagAxPost)      tagCode_congL payT b body_axPost      next_axPost
                  (teqDiff tagAxPost      tagCongL refl)
        s9   = skipAtTag (natCode tagAxFan) (natCode_isValue tagAxFan)       tagCode_congL payT b body_axFan       next_axFan
                  (teqDiff tagAxFan       tagCongL refl)
        s10  = skipAtTag (natCode tagAxKT) (natCode_isValue tagAxKT)        tagCode_congL payT b body_axZ        next_axKT
                  (teqDiff tagAxKT        tagCongL refl)
        s15  = skipAtTag (natCode tagAxIfLfL) (natCode_isValue tagAxIfLfL)     tagCode_congL payT b body_axIfLfL     next_axIfLfL
                  (teqDiff tagAxIfLfL     tagCongL refl)
        s16  = skipAtTag (natCode tagAxIfLfN) (natCode_isValue tagAxIfLfN)     tagCode_congL payT b body_axIfLfN     next_axIfLfN
                  (teqDiff tagAxIfLfN     tagCongL refl)
        s17  = skipAtTag (natCode tagAxTreeEqLL) (natCode_isValue tagAxTreeEqLL)  tagCode_congL payT b body_axTreeEqLL  next_axTreeEqLL
                  (teqDiff tagAxTreeEqLL  tagCongL refl)
        s18  = skipAtTag (natCode tagAxTreeEqLN) (natCode_isValue tagAxTreeEqLN)  tagCode_congL payT b body_axTreeEqLN  next_axTreeEqLN
                  (teqDiff tagAxTreeEqLN  tagCongL refl)
        s19  = skipAtTag (natCode tagAxTreeEqNL) (natCode_isValue tagAxTreeEqNL)  tagCode_congL payT b body_axTreeEqNL  next_axTreeEqNL
                  (teqDiff tagAxTreeEqNL  tagCongL refl)
        s20  = skipAtTag (natCode tagAxTreeEqNN) (natCode_isValue tagAxTreeEqNN)  tagCode_congL payT b body_axTreeEqNN  next_axTreeEqNN
                  (teqDiff tagAxTreeEqNN  tagCongL refl)
        s21  = skipAtTag (natCode tagAxGoodstein) (natCode_isValue tagAxGoodstein) tagCode_congL payT b body_axGoodstein next_axGoodstein
                  (teqDiff tagAxGoodstein tagCongL refl)
        s22  = skipAtTag (natCode tagAxRefl) (natCode_isValue tagAxRefl)      tagCode_congL payT b body_axRefl      next_axRefl
                  (teqDiff tagAxRefl      tagCongL refl)
        s23  = skipAtTag (natCode tagRuleSym) (natCode_isValue tagRuleSym)     tagCode_congL payT b body_ruleSym     next_ruleSym
                  (teqDiff tagRuleSym     tagCongL refl)
        s24  = skipAtTag (natCode tagRuleTrans) (natCode_isValue tagRuleTrans)   tagCode_congL payT b body_ruleTrans   next_ruleTrans
                  (teqDiff tagRuleTrans   tagCongL refl)
        s25  = skipAtTag (natCode tagCong1) (natCode_isValue tagCong1)       tagCode_congL payT b body_cong1       next_cong1
                  (teqDiff tagCong1       tagCongL refl)
        hh   = hitAtTag (natCode tagCongL) (natCode_isValue tagCongL)       tagCode_congL payT b body_congL       next_congL
                  (teqEq tagCongL)
        sndB_unfold : Deriv (atomic (eqn (ap1 Snd b) (ap1 thmT payT)))
  ...
  thmTDispCongR g x t u y_h y_h' shape_h d_h =
    let payG : Term
        ...
        s1   = skipAtTag (natCode tagAxI) (natCode_isValue tagAxI)         tagCode_congR payT b body_axI         next_axI
                  (teqDiff tagAxI         tagCongR refl)
        s2   = skipAtTag (natCode tagAxFst) (natCode_isValue tagAxFst)       tagCode_congR payT b body_axFst       next_axFst
                  (teqDiff tagAxFst       tagCongR refl)
        s3   = skipAtTag (natCode tagAxSnd) (natCode_isValue tagAxSnd)       tagCode_congR payT b body_axSnd       next_axSnd
                  (teqDiff tagAxSnd       tagCongR refl)
        s4   = skipAtTag (natCode tagAxConst) (natCode_isValue tagAxConst)     tagCode_congR payT b body_axConst     next_axConst
                  (teqDiff tagAxConst     tagCongR refl)
        s5   = skipAtTag (natCode tagAxComp) (natCode_isValue tagAxComp)      tagCode_congR payT b body_axComp      next_axComp
                  (teqDiff tagAxComp      tagCongR refl)
        s6   = skipAtTag (natCode tagAxComp2) (natCode_isValue tagAxComp2)     tagCode_congR payT b body_axComp2     next_axComp2
                  (teqDiff tagAxComp2     tagCongR refl)
        s7   = skipAtTag (natCode tagAxLift) (natCode_isValue tagAxLift)      tagCode_congR payT b body_axLift      next_axLift
                  (teqDiff tagAxLift      tagCongR refl)
        s8   = skipAtTag (natCode tagAxPost) (natCode_isValue tagAxPost)      tagCode_congR payT b body_axPost      next_axPost
                  (teqDiff tagAxPost      tagCongR refl)
        s9   = skipAtTag (natCode tagAxFan) (natCode_isValue tagAxFan)       tagCode_congR payT b body_axFan       next_axFan
                  (teqDiff tagAxFan       tagCongR refl)
        s10  = skipAtTag (natCode tagAxKT) (natCode_isValue tagAxKT)        tagCode_congR payT b body_axZ        next_axKT
                  (teqDiff tagAxKT        tagCongR refl)
        s15  = skipAtTag (natCode tagAxIfLfL) (natCode_isValue tagAxIfLfL)     tagCode_congR payT b body_axIfLfL     next_axIfLfL
                  (teqDiff tagAxIfLfL     tagCongR refl)
        s16  = skipAtTag (natCode tagAxIfLfN) (natCode_isValue tagAxIfLfN)     tagCode_congR payT b body_axIfLfN     next_axIfLfN
                  (teqDiff tagAxIfLfN     tagCongR refl)
        s17  = skipAtTag (natCode tagAxTreeEqLL) (natCode_isValue tagAxTreeEqLL)  tagCode_congR payT b body_axTreeEqLL  next_axTreeEqLL
                  (teqDiff tagAxTreeEqLL  tagCongR refl)
        s18  = skipAtTag (natCode tagAxTreeEqLN) (natCode_isValue tagAxTreeEqLN)  tagCode_congR payT b body_axTreeEqLN  next_axTreeEqLN
                  (teqDiff tagAxTreeEqLN  tagCongR refl)
        s19  = skipAtTag (natCode tagAxTreeEqNL) (natCode_isValue tagAxTreeEqNL)  tagCode_congR payT b body_axTreeEqNL  next_axTreeEqNL
                  (teqDiff tagAxTreeEqNL  tagCongR refl)
        s20  = skipAtTag (natCode tagAxTreeEqNN) (natCode_isValue tagAxTreeEqNN)  tagCode_congR payT b body_axTreeEqNN  next_axTreeEqNN
                  (teqDiff tagAxTreeEqNN  tagCongR refl)
        s21  = skipAtTag (natCode tagAxGoodstein) (natCode_isValue tagAxGoodstein) tagCode_congR payT b body_axGoodstein next_axGoodstein
                  (teqDiff tagAxGoodstein tagCongR refl)
        s22  = skipAtTag (natCode tagAxRefl) (natCode_isValue tagAxRefl)      tagCode_congR payT b body_axRefl      next_axRefl
                  (teqDiff tagAxRefl      tagCongR refl)
        s23  = skipAtTag (natCode tagRuleSym) (natCode_isValue tagRuleSym)     tagCode_congR payT b body_ruleSym     next_ruleSym
                  (teqDiff tagRuleSym     tagCongR refl)
        s24  = skipAtTag (natCode tagRuleTrans) (natCode_isValue tagRuleTrans)   tagCode_congR payT b body_ruleTrans   next_ruleTrans
                  (teqDiff tagRuleTrans   tagCongR refl)
        s25  = skipAtTag (natCode tagCong1) (natCode_isValue tagCong1)       tagCode_congR payT b body_cong1       next_cong1
                  (teqDiff tagCong1       tagCongR refl)
        s26  = skipAtTag (natCode tagCongL) (natCode_isValue tagCongL)       tagCode_congR payT b body_congL       next_congL
                  (teqDiff tagCongL       tagCongR refl)
        hh   = hitAtTag (natCode tagCongR) (natCode_isValue tagCongR)       tagCode_congR payT b body_congR       next_congR
                  (teqEq tagCongR)
        sndB_unfold : Deriv (atomic (eqn (ap1 Snd b) (ap1 thmT payT)))
    ...
    let payVarX : Term
        ...
        eSubT : Deriv (atomic (eqn (ap2 subT argsPair codeFP)
                                    (reify (codedSubst (code t) (code (var x))
                                                       (codeFormula P)))))
        eSubT = subTDef x (code t) (code_isValue t) (codeFormula P)
                              (codeFormula_isValue P)
  ...
  thmTDispRuleInst x t P y_h y_h' shape_h d_h =
    let payVarX_ = reify (code (var x))
        ...
        s1   = skipAtTag (natCode tagAxI) (natCode_isValue tagAxI)         tagCode_ruleInst payT b body_axI         next_axI
                  (teqDiff tagAxI         tagRuleInst refl)
        s2   = skipAtTag (natCode tagAxFst) (natCode_isValue tagAxFst)       tagCode_ruleInst payT b body_axFst       next_axFst
                  (teqDiff tagAxFst       tagRuleInst refl)
        s3   = skipAtTag (natCode tagAxSnd) (natCode_isValue tagAxSnd)       tagCode_ruleInst payT b body_axSnd       next_axSnd
                  (teqDiff tagAxSnd       tagRuleInst refl)
        s4   = skipAtTag (natCode tagAxConst) (natCode_isValue tagAxConst)     tagCode_ruleInst payT b body_axConst     next_axConst
                  (teqDiff tagAxConst     tagRuleInst refl)
        s5   = skipAtTag (natCode tagAxComp) (natCode_isValue tagAxComp)      tagCode_ruleInst payT b body_axComp      next_axComp
                  (teqDiff tagAxComp      tagRuleInst refl)
        s6   = skipAtTag (natCode tagAxComp2) (natCode_isValue tagAxComp2)     tagCode_ruleInst payT b body_axComp2     next_axComp2
                  (teqDiff tagAxComp2     tagRuleInst refl)
        s7   = skipAtTag (natCode tagAxLift) (natCode_isValue tagAxLift)      tagCode_ruleInst payT b body_axLift      next_axLift
                  (teqDiff tagAxLift      tagRuleInst refl)
        s8   = skipAtTag (natCode tagAxPost) (natCode_isValue tagAxPost)      tagCode_ruleInst payT b body_axPost      next_axPost
                  (teqDiff tagAxPost      tagRuleInst refl)
        s9   = skipAtTag (natCode tagAxFan) (natCode_isValue tagAxFan)       tagCode_ruleInst payT b body_axFan       next_axFan
                  (teqDiff tagAxFan       tagRuleInst refl)
        s10  = skipAtTag (natCode tagAxKT) (natCode_isValue tagAxKT)        tagCode_ruleInst payT b body_axZ        next_axKT
                  (teqDiff tagAxKT        tagRuleInst refl)
        s15  = skipAtTag (natCode tagAxIfLfL) (natCode_isValue tagAxIfLfL)     tagCode_ruleInst payT b body_axIfLfL     next_axIfLfL
                  (teqDiff tagAxIfLfL     tagRuleInst refl)
        s16  = skipAtTag (natCode tagAxIfLfN) (natCode_isValue tagAxIfLfN)     tagCode_ruleInst payT b body_axIfLfN     next_axIfLfN
                  (teqDiff tagAxIfLfN     tagRuleInst refl)
        s17  = skipAtTag (natCode tagAxTreeEqLL) (natCode_isValue tagAxTreeEqLL)  tagCode_ruleInst payT b body_axTreeEqLL  next_axTreeEqLL
                  (teqDiff tagAxTreeEqLL  tagRuleInst refl)
        s18  = skipAtTag (natCode tagAxTreeEqLN) (natCode_isValue tagAxTreeEqLN)  tagCode_ruleInst payT b body_axTreeEqLN  next_axTreeEqLN
                  (teqDiff tagAxTreeEqLN  tagRuleInst refl)
        s19  = skipAtTag (natCode tagAxTreeEqNL) (natCode_isValue tagAxTreeEqNL)  tagCode_ruleInst payT b body_axTreeEqNL  next_axTreeEqNL
                  (teqDiff tagAxTreeEqNL  tagRuleInst refl)
        s20  = skipAtTag (natCode tagAxTreeEqNN) (natCode_isValue tagAxTreeEqNN)  tagCode_ruleInst payT b body_axTreeEqNN  next_axTreeEqNN
                  (teqDiff tagAxTreeEqNN  tagRuleInst refl)
        s21  = skipAtTag (natCode tagAxGoodstein) (natCode_isValue tagAxGoodstein) tagCode_ruleInst payT b body_axGoodstein next_axGoodstein
                  (teqDiff tagAxGoodstein tagRuleInst refl)
        s22  = skipAtTag (natCode tagAxRefl) (natCode_isValue tagAxRefl)      tagCode_ruleInst payT b body_axRefl      next_axRefl
                  (teqDiff tagAxRefl      tagRuleInst refl)
        s23  = skipAtTag (natCode tagRuleSym) (natCode_isValue tagRuleSym)     tagCode_ruleInst payT b body_ruleSym     next_ruleSym
                  (teqDiff tagRuleSym     tagRuleInst refl)
        s24  = skipAtTag (natCode tagRuleTrans) (natCode_isValue tagRuleTrans)   tagCode_ruleInst payT b body_ruleTrans   next_ruleTrans
                  (teqDiff tagRuleTrans   tagRuleInst refl)
        s25  = skipAtTag (natCode tagCong1) (natCode_isValue tagCong1)       tagCode_ruleInst payT b body_cong1       next_cong1
                  (teqDiff tagCong1       tagRuleInst refl)
        s26  = skipAtTag (natCode tagCongL) (natCode_isValue tagCongL)       tagCode_ruleInst payT b body_congL       next_congL
                  (teqDiff tagCongL       tagRuleInst refl)
        s27  = skipAtTag (natCode tagCongR) (natCode_isValue tagCongR)       tagCode_ruleInst payT b body_congR       next_congR
                  (teqDiff tagCongR       tagRuleInst refl)
        s28  = skipAtTag (natCode tagAxEqTrans) (natCode_isValue tagAxEqTrans)   tagCode_ruleInst payT b body_axEqTrans   next_axEqTrans
                  (teqDiff tagAxEqTrans   tagRuleInst refl)
        s29  = skipAtTag (natCode tagAxEqCong1) (natCode_isValue tagAxEqCong1)   tagCode_ruleInst payT b body_axEqCong1   next_axEqCong1
                  (teqDiff tagAxEqCong1   tagRuleInst refl)
        s30  = skipAtTag (natCode tagAxEqCongL) (natCode_isValue tagAxEqCongL)   tagCode_ruleInst payT b body_axEqCongL   next_axEqCongL
                  (teqDiff tagAxEqCongL   tagRuleInst refl)
        s31  = skipAtTag (natCode tagAxEqCongR) (natCode_isValue tagAxEqCongR)   tagCode_ruleInst payT b body_axEqCongR   next_axEqCongR
                  (teqDiff tagAxEqCongR   tagRuleInst refl)
        s32  = skipAtTag (natCode tagAxK) (natCode_isValue tagAxK)         tagCode_ruleInst payT b body_axK         next_axK
                  (teqDiff tagAxK         tagRuleInst refl)
        s33  = skipAtTag (natCode tagAxS) (natCode_isValue tagAxS)         tagCode_ruleInst payT b body_axS         next_axS
                  (teqDiff tagAxS         tagRuleInst refl)
        s34  = skipAtTag (natCode tagAxNeg) (natCode_isValue tagAxNeg)       tagCode_ruleInst payT b body_axNeg       next_axNeg
                  (teqDiff tagAxNeg       tagRuleInst refl)
        s35  = skipAtTag (natCode tagAxExFalso) (natCode_isValue tagAxExFalso)   tagCode_ruleInst payT b body_axExFalso   next_axExFalso
                  (teqDiff tagAxExFalso   tagRuleInst refl)
        s36  = skipAtTag (natCode tagAxContrapos) (natCode_isValue tagAxContrapos) tagCode_ruleInst payT b body_axContrapos next_axContrapos
                  (teqDiff tagAxContrapos tagRuleInst refl)
        s37  = skipAtTag (natCode tagMp) (natCode_isValue tagMp)          tagCode_ruleInst payT b body_mp          next_mp
                  (teqDiff tagMp          tagRuleInst refl)
        hh   = hitAtTag (natCode tagRuleInst) (natCode_isValue tagRuleInst)    tagCode_ruleInst payT b body_ruleInst    next_ruleInst
                  (teqEq tagRuleInst)
    ...
    let payVarA : Term
        ...
        eSubT2 : Deriv (atomic (eqn (ap2 subT2 argsPair codeFP)
          (reify (codedSubst2 (code tA) (code tB)
                              ...
                              (codeFormula P)))))
        eSubT2 = subTDef2 xA xB (code tA) (code tB) (codeFormula P) (codeFormula_isValue P)
  ...
  thmTDispRuleInst2 xA xB tA tB P y_h y_h' shape_h d_h codeCommEq =
    let payT = reify (nd (code (var xA))
        ...
        s1   = skipAtTag (natCode tagAxI) (natCode_isValue tagAxI)         tagCode_ruleInst2 payT b body_axI         next_axI
                  (teqDiff tagAxI         tagRuleInst2 refl)
        s2   = skipAtTag (natCode tagAxFst) (natCode_isValue tagAxFst)       tagCode_ruleInst2 payT b body_axFst       next_axFst
                  (teqDiff tagAxFst       tagRuleInst2 refl)
        s3   = skipAtTag (natCode tagAxSnd) (natCode_isValue tagAxSnd)       tagCode_ruleInst2 payT b body_axSnd       next_axSnd
                  (teqDiff tagAxSnd       tagRuleInst2 refl)
        s4   = skipAtTag (natCode tagAxConst) (natCode_isValue tagAxConst)     tagCode_ruleInst2 payT b body_axConst     next_axConst
                  (teqDiff tagAxConst     tagRuleInst2 refl)
        s5   = skipAtTag (natCode tagAxComp) (natCode_isValue tagAxComp)      tagCode_ruleInst2 payT b body_axComp      next_axComp
                  (teqDiff tagAxComp      tagRuleInst2 refl)
        s6   = skipAtTag (natCode tagAxComp2) (natCode_isValue tagAxComp2)     tagCode_ruleInst2 payT b body_axComp2     next_axComp2
                  (teqDiff tagAxComp2     tagRuleInst2 refl)
        s7   = skipAtTag (natCode tagAxLift) (natCode_isValue tagAxLift)      tagCode_ruleInst2 payT b body_axLift      next_axLift
                  (teqDiff tagAxLift      tagRuleInst2 refl)
        s8   = skipAtTag (natCode tagAxPost) (natCode_isValue tagAxPost)      tagCode_ruleInst2 payT b body_axPost      next_axPost
                  (teqDiff tagAxPost      tagRuleInst2 refl)
        s9   = skipAtTag (natCode tagAxFan) (natCode_isValue tagAxFan)       tagCode_ruleInst2 payT b body_axFan       next_axFan
                  (teqDiff tagAxFan       tagRuleInst2 refl)
        s10  = skipAtTag (natCode tagAxKT) (natCode_isValue tagAxKT)        tagCode_ruleInst2 payT b body_axZ         next_axKT
                  (teqDiff tagAxKT        tagRuleInst2 refl)
        s15  = skipAtTag (natCode tagAxIfLfL) (natCode_isValue tagAxIfLfL)     tagCode_ruleInst2 payT b body_axIfLfL     next_axIfLfL
                  (teqDiff tagAxIfLfL     tagRuleInst2 refl)
        s16  = skipAtTag (natCode tagAxIfLfN) (natCode_isValue tagAxIfLfN)     tagCode_ruleInst2 payT b body_axIfLfN     next_axIfLfN
                  (teqDiff tagAxIfLfN     tagRuleInst2 refl)
        s17  = skipAtTag (natCode tagAxTreeEqLL) (natCode_isValue tagAxTreeEqLL)  tagCode_ruleInst2 payT b body_axTreeEqLL  next_axTreeEqLL
                  (teqDiff tagAxTreeEqLL  tagRuleInst2 refl)
        s18  = skipAtTag (natCode tagAxTreeEqLN) (natCode_isValue tagAxTreeEqLN)  tagCode_ruleInst2 payT b body_axTreeEqLN  next_axTreeEqLN
                  (teqDiff tagAxTreeEqLN  tagRuleInst2 refl)
        s19  = skipAtTag (natCode tagAxTreeEqNL) (natCode_isValue tagAxTreeEqNL)  tagCode_ruleInst2 payT b body_axTreeEqNL  next_axTreeEqNL
                  (teqDiff tagAxTreeEqNL  tagRuleInst2 refl)
        s20  = skipAtTag (natCode tagAxTreeEqNN) (natCode_isValue tagAxTreeEqNN)  tagCode_ruleInst2 payT b body_axTreeEqNN  next_axTreeEqNN
                  (teqDiff tagAxTreeEqNN  tagRuleInst2 refl)
        s21  = skipAtTag (natCode tagAxGoodstein) (natCode_isValue tagAxGoodstein) tagCode_ruleInst2 payT b body_axGoodstein next_axGoodstein
                  (teqDiff tagAxGoodstein tagRuleInst2 refl)
        s22  = skipAtTag (natCode tagAxRefl) (natCode_isValue tagAxRefl)      tagCode_ruleInst2 payT b body_axRefl      next_axRefl
                  (teqDiff tagAxRefl      tagRuleInst2 refl)
        s23  = skipAtTag (natCode tagRuleSym) (natCode_isValue tagRuleSym)     tagCode_ruleInst2 payT b body_ruleSym     next_ruleSym
                  (teqDiff tagRuleSym     tagRuleInst2 refl)
        s24  = skipAtTag (natCode tagRuleTrans) (natCode_isValue tagRuleTrans)   tagCode_ruleInst2 payT b body_ruleTrans   next_ruleTrans
                  (teqDiff tagRuleTrans   tagRuleInst2 refl)
        s25  = skipAtTag (natCode tagCong1) (natCode_isValue tagCong1)       tagCode_ruleInst2 payT b body_cong1       next_cong1
                  (teqDiff tagCong1       tagRuleInst2 refl)
        s26  = skipAtTag (natCode tagCongL) (natCode_isValue tagCongL)       tagCode_ruleInst2 payT b body_congL       next_congL
                  (teqDiff tagCongL       tagRuleInst2 refl)
        s27  = skipAtTag (natCode tagCongR) (natCode_isValue tagCongR)       tagCode_ruleInst2 payT b body_congR       next_congR
                  (teqDiff tagCongR       tagRuleInst2 refl)
        s28  = skipAtTag (natCode tagAxEqTrans) (natCode_isValue tagAxEqTrans)   tagCode_ruleInst2 payT b body_axEqTrans   next_axEqTrans
                  (teqDiff tagAxEqTrans   tagRuleInst2 refl)
        s29  = skipAtTag (natCode tagAxEqCong1) (natCode_isValue tagAxEqCong1)   tagCode_ruleInst2 payT b body_axEqCong1   next_axEqCong1
                  (teqDiff tagAxEqCong1   tagRuleInst2 refl)
        s30  = skipAtTag (natCode tagAxEqCongL) (natCode_isValue tagAxEqCongL)   tagCode_ruleInst2 payT b body_axEqCongL   next_axEqCongL
                  (teqDiff tagAxEqCongL   tagRuleInst2 refl)
        s31  = skipAtTag (natCode tagAxEqCongR) (natCode_isValue tagAxEqCongR)   tagCode_ruleInst2 payT b body_axEqCongR   next_axEqCongR
                  (teqDiff tagAxEqCongR   tagRuleInst2 refl)
        s32  = skipAtTag (natCode tagAxK) (natCode_isValue tagAxK)         tagCode_ruleInst2 payT b body_axK         next_axK
                  (teqDiff tagAxK         tagRuleInst2 refl)
        s33  = skipAtTag (natCode tagAxS) (natCode_isValue tagAxS)         tagCode_ruleInst2 payT b body_axS         next_axS
                  (teqDiff tagAxS         tagRuleInst2 refl)
        s34  = skipAtTag (natCode tagAxNeg) (natCode_isValue tagAxNeg)       tagCode_ruleInst2 payT b body_axNeg       next_axNeg
                  (teqDiff tagAxNeg       tagRuleInst2 refl)
        s35  = skipAtTag (natCode tagAxExFalso) (natCode_isValue tagAxExFalso)   tagCode_ruleInst2 payT b body_axExFalso   next_axExFalso
                  (teqDiff tagAxExFalso   tagRuleInst2 refl)
        s36  = skipAtTag (natCode tagAxContrapos) (natCode_isValue tagAxContrapos) tagCode_ruleInst2 payT b body_axContrapos next_axContrapos
                  (teqDiff tagAxContrapos tagRuleInst2 refl)
        s37  = skipAtTag (natCode tagMp) (natCode_isValue tagMp)          tagCode_ruleInst2 payT b body_mp          next_mp
                  (teqDiff tagMp          tagRuleInst2 refl)
        s38  = skipAtTag (natCode tagRuleInst) (natCode_isValue tagRuleInst)    tagCode_ruleInst2 payT b body_ruleInst    next_ruleInst
                  (teqDiff tagRuleInst    tagRuleInst2 refl)
        s39  = skipAtTag (natCode tagRuleIndBT) (natCode_isValue tagRuleIndBT)   tagCode_ruleInst2 payT b body_ruleIndBT   next_ruleIndBT
                  (teqDiff tagRuleIndBT   tagRuleInst2 refl)
        s40  = skipAtTag (natCode tagAxFstLf) (natCode_isValue tagAxFstLf)     tagCode_ruleInst2 payT b body_axFstLf     next_axFstLf
                  (teqDiff tagAxFstLf     tagRuleInst2 refl)
        s41  = skipAtTag (natCode tagAxSndLf) (natCode_isValue tagAxSndLf)     tagCode_ruleInst2 payT b body_axSndLf     next_axSndLf
                  (teqDiff tagAxSndLf     tagRuleInst2 refl)
        s42  = skipAtTag (natCode tagAxIfLfLL) (natCode_isValue tagAxIfLfLL)    tagCode_ruleInst2 payT b body_axIfLfLL    next_axIfLfLL
                  (teqDiff tagAxIfLfLL    tagRuleInst2 refl)
        s43  = skipAtTag (natCode tagAxIfLfNL) (natCode_isValue tagAxIfLfNL)    tagCode_ruleInst2 payT b body_axIfLfNL    next_axIfLfNL
                  (teqDiff tagAxIfLfNL    tagRuleInst2 refl)
        hh   = hitAtTag (natCode tagRuleInst2) (natCode_isValue tagRuleInst2)   tagCode_ruleInst2 payT b body_ruleInst2   next_ruleInst2
                  (teqEq tagRuleInst2)
  ...
  thmTDispAxTreeRecLf f s p =
    let payT = reify (nd (codeF1 f) (nd (codeF2 s) (code p)))
        ...
        s1   = skipAtTag (natCode tagAxI) (natCode_isValue tagAxI)         tagCode_axTreeRecLf payT b body_axI         next_axI
                  (teqDiff tagAxI         tagAxTreeRecLf refl)
        s2   = skipAtTag (natCode tagAxFst) (natCode_isValue tagAxFst)       tagCode_axTreeRecLf payT b body_axFst       next_axFst
                  (teqDiff tagAxFst       tagAxTreeRecLf refl)
        s3   = skipAtTag (natCode tagAxSnd) (natCode_isValue tagAxSnd)       tagCode_axTreeRecLf payT b body_axSnd       next_axSnd
                  (teqDiff tagAxSnd       tagAxTreeRecLf refl)
        s4   = skipAtTag (natCode tagAxConst) (natCode_isValue tagAxConst)     tagCode_axTreeRecLf payT b body_axConst     next_axConst
                  (teqDiff tagAxConst     tagAxTreeRecLf refl)
        s5   = skipAtTag (natCode tagAxComp) (natCode_isValue tagAxComp)      tagCode_axTreeRecLf payT b body_axComp      next_axComp
                  (teqDiff tagAxComp      tagAxTreeRecLf refl)
        s6   = skipAtTag (natCode tagAxComp2) (natCode_isValue tagAxComp2)     tagCode_axTreeRecLf payT b body_axComp2     next_axComp2
                  (teqDiff tagAxComp2     tagAxTreeRecLf refl)
        s7   = skipAtTag (natCode tagAxLift) (natCode_isValue tagAxLift)      tagCode_axTreeRecLf payT b body_axLift      next_axLift
                  (teqDiff tagAxLift      tagAxTreeRecLf refl)
        s8   = skipAtTag (natCode tagAxPost) (natCode_isValue tagAxPost)      tagCode_axTreeRecLf payT b body_axPost      next_axPost
                  (teqDiff tagAxPost      tagAxTreeRecLf refl)
        s9   = skipAtTag (natCode tagAxFan) (natCode_isValue tagAxFan)       tagCode_axTreeRecLf payT b body_axFan       next_axFan
                  (teqDiff tagAxFan       tagAxTreeRecLf refl)
        s10  = skipAtTag (natCode tagAxKT) (natCode_isValue tagAxKT)        tagCode_axTreeRecLf payT b body_axZ         next_axKT
                  (teqDiff tagAxKT        tagAxTreeRecLf refl)
        s15  = skipAtTag (natCode tagAxIfLfL) (natCode_isValue tagAxIfLfL)     tagCode_axTreeRecLf payT b body_axIfLfL     next_axIfLfL
                  (teqDiff tagAxIfLfL     tagAxTreeRecLf refl)
        s16  = skipAtTag (natCode tagAxIfLfN) (natCode_isValue tagAxIfLfN)     tagCode_axTreeRecLf payT b body_axIfLfN     next_axIfLfN
                  (teqDiff tagAxIfLfN     tagAxTreeRecLf refl)
        s17  = skipAtTag (natCode tagAxTreeEqLL) (natCode_isValue tagAxTreeEqLL)  tagCode_axTreeRecLf payT b body_axTreeEqLL  next_axTreeEqLL
                  (teqDiff tagAxTreeEqLL  tagAxTreeRecLf refl)
        s18  = skipAtTag (natCode tagAxTreeEqLN) (natCode_isValue tagAxTreeEqLN)  tagCode_axTreeRecLf payT b body_axTreeEqLN  next_axTreeEqLN
                  (teqDiff tagAxTreeEqLN  tagAxTreeRecLf refl)
        s19  = skipAtTag (natCode tagAxTreeEqNL) (natCode_isValue tagAxTreeEqNL)  tagCode_axTreeRecLf payT b body_axTreeEqNL  next_axTreeEqNL
                  (teqDiff tagAxTreeEqNL  tagAxTreeRecLf refl)
        s20  = skipAtTag (natCode tagAxTreeEqNN) (natCode_isValue tagAxTreeEqNN)  tagCode_axTreeRecLf payT b body_axTreeEqNN  next_axTreeEqNN
                  (teqDiff tagAxTreeEqNN  tagAxTreeRecLf refl)
        s21  = skipAtTag (natCode tagAxGoodstein) (natCode_isValue tagAxGoodstein) tagCode_axTreeRecLf payT b body_axGoodstein next_axGoodstein
                  (teqDiff tagAxGoodstein tagAxTreeRecLf refl)
        s22  = skipAtTag (natCode tagAxRefl) (natCode_isValue tagAxRefl)      tagCode_axTreeRecLf payT b body_axRefl      next_axRefl
                  (teqDiff tagAxRefl      tagAxTreeRecLf refl)
        s23  = skipAtTag (natCode tagRuleSym) (natCode_isValue tagRuleSym)     tagCode_axTreeRecLf payT b body_ruleSym     next_ruleSym
                  (teqDiff tagRuleSym     tagAxTreeRecLf refl)
        s24  = skipAtTag (natCode tagRuleTrans) (natCode_isValue tagRuleTrans)   tagCode_axTreeRecLf payT b body_ruleTrans   next_ruleTrans
                  (teqDiff tagRuleTrans   tagAxTreeRecLf refl)
        s25  = skipAtTag (natCode tagCong1) (natCode_isValue tagCong1)       tagCode_axTreeRecLf payT b body_cong1       next_cong1
                  (teqDiff tagCong1       tagAxTreeRecLf refl)
        s26  = skipAtTag (natCode tagCongL) (natCode_isValue tagCongL)       tagCode_axTreeRecLf payT b body_congL       next_congL
                  (teqDiff tagCongL       tagAxTreeRecLf refl)
        s27  = skipAtTag (natCode tagCongR) (natCode_isValue tagCongR)       tagCode_axTreeRecLf payT b body_congR       next_congR
                  (teqDiff tagCongR       tagAxTreeRecLf refl)
        s28  = skipAtTag (natCode tagAxEqTrans) (natCode_isValue tagAxEqTrans)   tagCode_axTreeRecLf payT b body_axEqTrans   next_axEqTrans
                  (teqDiff tagAxEqTrans   tagAxTreeRecLf refl)
        s29  = skipAtTag (natCode tagAxEqCong1) (natCode_isValue tagAxEqCong1)   tagCode_axTreeRecLf payT b body_axEqCong1   next_axEqCong1
                  (teqDiff tagAxEqCong1   tagAxTreeRecLf refl)
        s30  = skipAtTag (natCode tagAxEqCongL) (natCode_isValue tagAxEqCongL)   tagCode_axTreeRecLf payT b body_axEqCongL   next_axEqCongL
                  (teqDiff tagAxEqCongL   tagAxTreeRecLf refl)
        s31  = skipAtTag (natCode tagAxEqCongR) (natCode_isValue tagAxEqCongR)   tagCode_axTreeRecLf payT b body_axEqCongR   next_axEqCongR
                  (teqDiff tagAxEqCongR   tagAxTreeRecLf refl)
        s32  = skipAtTag (natCode tagAxK) (natCode_isValue tagAxK)         tagCode_axTreeRecLf payT b body_axK         next_axK
                  (teqDiff tagAxK         tagAxTreeRecLf refl)
        s33  = skipAtTag (natCode tagAxS) (natCode_isValue tagAxS)         tagCode_axTreeRecLf payT b body_axS         next_axS
                  (teqDiff tagAxS         tagAxTreeRecLf refl)
        s34  = skipAtTag (natCode tagAxNeg) (natCode_isValue tagAxNeg)       tagCode_axTreeRecLf payT b body_axNeg       next_axNeg
                  (teqDiff tagAxNeg       tagAxTreeRecLf refl)
        s35  = skipAtTag (natCode tagAxExFalso) (natCode_isValue tagAxExFalso)   tagCode_axTreeRecLf payT b body_axExFalso   next_axExFalso
                  (teqDiff tagAxExFalso   tagAxTreeRecLf refl)
        s36  = skipAtTag (natCode tagAxContrapos) (natCode_isValue tagAxContrapos) tagCode_axTreeRecLf payT b body_axContrapos next_axContrapos
                  (teqDiff tagAxContrapos tagAxTreeRecLf refl)
        s37  = skipAtTag (natCode tagMp) (natCode_isValue tagMp)          tagCode_axTreeRecLf payT b body_mp          next_mp
                  (teqDiff tagMp          tagAxTreeRecLf refl)
        s38  = skipAtTag (natCode tagRuleInst) (natCode_isValue tagRuleInst)    tagCode_axTreeRecLf payT b body_ruleInst    next_ruleInst
                  (teqDiff tagRuleInst    tagAxTreeRecLf refl)
        s39  = skipAtTag (natCode tagRuleIndBT) (natCode_isValue tagRuleIndBT)   tagCode_axTreeRecLf payT b body_ruleIndBT   next_ruleIndBT
                  (teqDiff tagRuleIndBT   tagAxTreeRecLf refl)
        s40  = skipAtTag (natCode tagAxFstLf) (natCode_isValue tagAxFstLf)     tagCode_axTreeRecLf payT b body_axFstLf     next_axFstLf
                  (teqDiff tagAxFstLf     tagAxTreeRecLf refl)
        s41  = skipAtTag (natCode tagAxSndLf) (natCode_isValue tagAxSndLf)     tagCode_axTreeRecLf payT b body_axSndLf     next_axSndLf
                  (teqDiff tagAxSndLf     tagAxTreeRecLf refl)
        s42  = skipAtTag (natCode tagAxIfLfLL) (natCode_isValue tagAxIfLfLL)    tagCode_axTreeRecLf payT b body_axIfLfLL    next_axIfLfLL
                  (teqDiff tagAxIfLfLL    tagAxTreeRecLf refl)
        s43  = skipAtTag (natCode tagAxIfLfNL) (natCode_isValue tagAxIfLfNL)    tagCode_axTreeRecLf payT b body_axIfLfNL    next_axIfLfNL
                  (teqDiff tagAxIfLfNL    tagAxTreeRecLf refl)
        s44  = skipAtTag (natCode tagRuleInst2) (natCode_isValue tagRuleInst2)   tagCode_axTreeRecLf payT b body_ruleInst2   next_ruleInst2
                  (teqDiff tagRuleInst2   tagAxTreeRecLf refl)
        hh   = hitAtTag (natCode tagAxTreeRecLf) (natCode_isValue tagAxTreeRecLf) tagCode_axTreeRecLf payT b body_axTreeRecLf next_axTreeRecLf
  ...
  thmTDispAxTreeRecNd f s p a' b' =
    let payT = reify (nd (codeF1 f)
        ...
        s1   = skipAtTag (natCode tagAxI) (natCode_isValue tagAxI)         tagCode_axTreeRecNd payT b body_axI         next_axI
                  (teqDiff tagAxI         tagAxTreeRecNd refl)
        s2   = skipAtTag (natCode tagAxFst) (natCode_isValue tagAxFst)       tagCode_axTreeRecNd payT b body_axFst       next_axFst
                  (teqDiff tagAxFst       tagAxTreeRecNd refl)
        s3   = skipAtTag (natCode tagAxSnd) (natCode_isValue tagAxSnd)       tagCode_axTreeRecNd payT b body_axSnd       next_axSnd
                  (teqDiff tagAxSnd       tagAxTreeRecNd refl)
        s4   = skipAtTag (natCode tagAxConst) (natCode_isValue tagAxConst)     tagCode_axTreeRecNd payT b body_axConst     next_axConst
                  (teqDiff tagAxConst     tagAxTreeRecNd refl)
        s5   = skipAtTag (natCode tagAxComp) (natCode_isValue tagAxComp)      tagCode_axTreeRecNd payT b body_axComp      next_axComp
                  (teqDiff tagAxComp      tagAxTreeRecNd refl)
        s6   = skipAtTag (natCode tagAxComp2) (natCode_isValue tagAxComp2)     tagCode_axTreeRecNd payT b body_axComp2     next_axComp2
                  (teqDiff tagAxComp2     tagAxTreeRecNd refl)
        s7   = skipAtTag (natCode tagAxLift) (natCode_isValue tagAxLift)      tagCode_axTreeRecNd payT b body_axLift      next_axLift
                  (teqDiff tagAxLift      tagAxTreeRecNd refl)
        s8   = skipAtTag (natCode tagAxPost) (natCode_isValue tagAxPost)      tagCode_axTreeRecNd payT b body_axPost      next_axPost
                  (teqDiff tagAxPost      tagAxTreeRecNd refl)
        s9   = skipAtTag (natCode tagAxFan) (natCode_isValue tagAxFan)       tagCode_axTreeRecNd payT b body_axFan       next_axFan
                  (teqDiff tagAxFan       tagAxTreeRecNd refl)
        s10  = skipAtTag (natCode tagAxKT) (natCode_isValue tagAxKT)        tagCode_axTreeRecNd payT b body_axZ         next_axKT
                  (teqDiff tagAxKT        tagAxTreeRecNd refl)
        s15  = skipAtTag (natCode tagAxIfLfL) (natCode_isValue tagAxIfLfL)     tagCode_axTreeRecNd payT b body_axIfLfL     next_axIfLfL
                  (teqDiff tagAxIfLfL     tagAxTreeRecNd refl)
        s16  = skipAtTag (natCode tagAxIfLfN) (natCode_isValue tagAxIfLfN)     tagCode_axTreeRecNd payT b body_axIfLfN     next_axIfLfN
                  (teqDiff tagAxIfLfN     tagAxTreeRecNd refl)
        s17  = skipAtTag (natCode tagAxTreeEqLL) (natCode_isValue tagAxTreeEqLL)  tagCode_axTreeRecNd payT b body_axTreeEqLL  next_axTreeEqLL
                  (teqDiff tagAxTreeEqLL  tagAxTreeRecNd refl)
        s18  = skipAtTag (natCode tagAxTreeEqLN) (natCode_isValue tagAxTreeEqLN)  tagCode_axTreeRecNd payT b body_axTreeEqLN  next_axTreeEqLN
                  (teqDiff tagAxTreeEqLN  tagAxTreeRecNd refl)
        s19  = skipAtTag (natCode tagAxTreeEqNL) (natCode_isValue tagAxTreeEqNL)  tagCode_axTreeRecNd payT b body_axTreeEqNL  next_axTreeEqNL
                  (teqDiff tagAxTreeEqNL  tagAxTreeRecNd refl)
        s20  = skipAtTag (natCode tagAxTreeEqNN) (natCode_isValue tagAxTreeEqNN)  tagCode_axTreeRecNd payT b body_axTreeEqNN  next_axTreeEqNN
                  (teqDiff tagAxTreeEqNN  tagAxTreeRecNd refl)
        s21  = skipAtTag (natCode tagAxGoodstein) (natCode_isValue tagAxGoodstein) tagCode_axTreeRecNd payT b body_axGoodstein next_axGoodstein
                  (teqDiff tagAxGoodstein tagAxTreeRecNd refl)
        s22  = skipAtTag (natCode tagAxRefl) (natCode_isValue tagAxRefl)      tagCode_axTreeRecNd payT b body_axRefl      next_axRefl
                  (teqDiff tagAxRefl      tagAxTreeRecNd refl)
        s23  = skipAtTag (natCode tagRuleSym) (natCode_isValue tagRuleSym)     tagCode_axTreeRecNd payT b body_ruleSym     next_ruleSym
                  (teqDiff tagRuleSym     tagAxTreeRecNd refl)
        s24  = skipAtTag (natCode tagRuleTrans) (natCode_isValue tagRuleTrans)   tagCode_axTreeRecNd payT b body_ruleTrans   next_ruleTrans
                  (teqDiff tagRuleTrans   tagAxTreeRecNd refl)
        s25  = skipAtTag (natCode tagCong1) (natCode_isValue tagCong1)       tagCode_axTreeRecNd payT b body_cong1       next_cong1
                  (teqDiff tagCong1       tagAxTreeRecNd refl)
        s26  = skipAtTag (natCode tagCongL) (natCode_isValue tagCongL)       tagCode_axTreeRecNd payT b body_congL       next_congL
                  (teqDiff tagCongL       tagAxTreeRecNd refl)
        s27  = skipAtTag (natCode tagCongR) (natCode_isValue tagCongR)       tagCode_axTreeRecNd payT b body_congR       next_congR
                  (teqDiff tagCongR       tagAxTreeRecNd refl)
        s28  = skipAtTag (natCode tagAxEqTrans) (natCode_isValue tagAxEqTrans)   tagCode_axTreeRecNd payT b body_axEqTrans   next_axEqTrans
                  (teqDiff tagAxEqTrans   tagAxTreeRecNd refl)
        s29  = skipAtTag (natCode tagAxEqCong1) (natCode_isValue tagAxEqCong1)   tagCode_axTreeRecNd payT b body_axEqCong1   next_axEqCong1
                  (teqDiff tagAxEqCong1   tagAxTreeRecNd refl)
        s30  = skipAtTag (natCode tagAxEqCongL) (natCode_isValue tagAxEqCongL)   tagCode_axTreeRecNd payT b body_axEqCongL   next_axEqCongL
                  (teqDiff tagAxEqCongL   tagAxTreeRecNd refl)
        s31  = skipAtTag (natCode tagAxEqCongR) (natCode_isValue tagAxEqCongR)   tagCode_axTreeRecNd payT b body_axEqCongR   next_axEqCongR
                  (teqDiff tagAxEqCongR   tagAxTreeRecNd refl)
        s32  = skipAtTag (natCode tagAxK) (natCode_isValue tagAxK)         tagCode_axTreeRecNd payT b body_axK         next_axK
                  (teqDiff tagAxK         tagAxTreeRecNd refl)
        s33  = skipAtTag (natCode tagAxS) (natCode_isValue tagAxS)         tagCode_axTreeRecNd payT b body_axS         next_axS
                  (teqDiff tagAxS         tagAxTreeRecNd refl)
        s34  = skipAtTag (natCode tagAxNeg) (natCode_isValue tagAxNeg)       tagCode_axTreeRecNd payT b body_axNeg       next_axNeg
                  (teqDiff tagAxNeg       tagAxTreeRecNd refl)
        s35  = skipAtTag (natCode tagAxExFalso) (natCode_isValue tagAxExFalso)   tagCode_axTreeRecNd payT b body_axExFalso   next_axExFalso
                  (teqDiff tagAxExFalso   tagAxTreeRecNd refl)
        s36  = skipAtTag (natCode tagAxContrapos) (natCode_isValue tagAxContrapos) tagCode_axTreeRecNd payT b body_axContrapos next_axContrapos
                  (teqDiff tagAxContrapos tagAxTreeRecNd refl)
        s37  = skipAtTag (natCode tagMp) (natCode_isValue tagMp)          tagCode_axTreeRecNd payT b body_mp          next_mp
                  (teqDiff tagMp          tagAxTreeRecNd refl)
        s38  = skipAtTag (natCode tagRuleInst) (natCode_isValue tagRuleInst)    tagCode_axTreeRecNd payT b body_ruleInst    next_ruleInst
                  (teqDiff tagRuleInst    tagAxTreeRecNd refl)
        s39  = skipAtTag (natCode tagRuleIndBT) (natCode_isValue tagRuleIndBT)   tagCode_axTreeRecNd payT b body_ruleIndBT   next_ruleIndBT
                  (teqDiff tagRuleIndBT   tagAxTreeRecNd refl)
        s40  = skipAtTag (natCode tagAxFstLf) (natCode_isValue tagAxFstLf)     tagCode_axTreeRecNd payT b body_axFstLf     next_axFstLf
                  (teqDiff tagAxFstLf     tagAxTreeRecNd refl)
        s41  = skipAtTag (natCode tagAxSndLf) (natCode_isValue tagAxSndLf)     tagCode_axTreeRecNd payT b body_axSndLf     next_axSndLf
                  (teqDiff tagAxSndLf     tagAxTreeRecNd refl)
        s42  = skipAtTag (natCode tagAxIfLfLL) (natCode_isValue tagAxIfLfLL)    tagCode_axTreeRecNd payT b body_axIfLfLL    next_axIfLfLL
                  (teqDiff tagAxIfLfLL    tagAxTreeRecNd refl)
        s43  = skipAtTag (natCode tagAxIfLfNL) (natCode_isValue tagAxIfLfNL)    tagCode_axTreeRecNd payT b body_axIfLfNL    next_axIfLfNL
                  (teqDiff tagAxIfLfNL    tagAxTreeRecNd refl)
        s44  = skipAtTag (natCode tagRuleInst2) (natCode_isValue tagRuleInst2)   tagCode_axTreeRecNd payT b body_ruleInst2   next_ruleInst2
                  (teqDiff tagRuleInst2   tagAxTreeRecNd refl)
        s45  = skipAtTag (natCode tagAxTreeRecLf) (natCode_isValue tagAxTreeRecLf) tagCode_axTreeRecNd payT b body_axTreeRecLf next_axTreeRecLf
                  (teqDiff tagAxTreeRecLf tagAxTreeRecNd refl)
        hh   = hitAtTag (natCode tagAxTreeRecNd) (natCode_isValue tagAxTreeRecNd) tagCode_axTreeRecNd payT b body_axTreeRecNd fbBody
  ...
  body_axTreeEqLL_eval_param payT bb =
    liftKT_eval outAxTreeEqLL
                ...
                (ap2 Pair tagCode_axTreeEqLL payT) bb
  ...
  body_axTreeEqNN_eval_param a1T a2T b1T b2T bb =
    let payA1  = a1T
        ...
        ka1a2  = pairOfConst_eval K_pairV K_pairV_isValue
                   (Fan (Lift (Comp Fst Snd))
                        (Lift (Comp Fst (Comp Snd Snd))) Pair)
                   a bb (ap2 Pair payA1 payA2) a1a2
        a_full = pairOfConst_eval K_a2V K_a2V_isValue
                   (Fan (Lift (KT K_pair))
                        (Fan (Lift (Comp Fst Snd))
                             (Lift (Comp Fst (Comp Snd Snd))) Pair)
                        Pair)
        ...
        kb1b2  = pairOfConst_eval K_pairV K_pairV_isValue
                   (Fan (Lift (Comp Fst (Comp Snd (Comp Snd Snd))))
                        (Lift (Comp Snd (Comp Snd (Comp Snd Snd)))) Pair)
                   a bb (ap2 Pair payB1 payB2) b1b2
        b_full = pairOfConst_eval K_a2V K_a2V_isValue
                   (Fan (Lift (KT K_pair))
                        (Fan (Lift (Comp Fst (Comp Snd (Comp Snd Snd))))
                             (Lift (Comp Snd (Comp Snd (Comp Snd Snd)))) Pair)
                        Pair)
        ...
        l_inner = pairOfFan_eval
                    ...
                    a_full b_full
        l_te   = pairOfConst_eval K_teV K_teV_isValue
                   (Fan (Fan (Lift (KT K_a2))
                             (Fan (Lift (KT K_pair))
                                  (Fan (Lift (Comp Fst Snd))
                                       (Lift (Comp Fst (Comp Snd Snd))) Pair)
        ...
        kA1B1  = pairOfConst_eval K_teV K_teV_isValue
                   (Fan (Lift (Comp Fst Snd))
                        (Lift (Comp Fst (Comp Snd (Comp Snd Snd)))) Pair)
                   a bb (ap2 Pair payA1 payB1) a1b1
        blkA   = pairOfConst_eval K_a2V K_a2V_isValue
                   (Fan (Lift (KT K_te))
                        (Fan (Lift (Comp Fst Snd))
                             (Lift (Comp Fst (Comp Snd (Comp Snd Snd)))) Pair)
                        Pair)
        ...
        kA2B2  = pairOfConst_eval K_teV K_teV_isValue
                   (Fan (Lift (Comp Fst (Comp Snd Snd)))
                        (Lift (Comp Snd (Comp Snd (Comp Snd Snd)))) Pair)
                   a bb (ap2 Pair payA2 payB2) a2b2
        blkBin = pairOfConst_eval K_a2V K_a2V_isValue
                   (Fan (Lift (KT K_te))
                        (Fan (Lift (Comp Fst (Comp Snd Snd)))
                             (Lift (Comp Snd (Comp Snd (Comp Snd Snd)))) Pair)
                        Pair)
        ...
        kPOO   = pairOfConst_eval K_pairV K_pairV_isValue
                   (Fan (Lift (KT K_oo)) (Lift (KT K_oo)) Pair)
                   a bb (ap2 Pair K_oo K_oo) ooOO
        blkPOO = pairOfConst_eval K_a2V K_a2V_isValue
                   (Fan (Lift (KT K_pair))
        ...
        binPOO = pairOfFan_eval
                   ...
                   blkBin blkPOO
        kBinPOO = pairOfConst_eval K_pairV K_pairV_isValue
                    (Fan (Fan (Lift (KT K_a2))
                              (Fan (Lift (KT K_te))
                                   (Fan (Lift (Comp Fst (Comp Snd Snd)))
                                        (Lift (Comp Snd (Comp Snd (Comp Snd Snd))))
                    ...
                    (ap2 Pair (ap2 Pair K_a2 (ap2 Pair K_te (ap2 Pair payA2 payB2)))
                               (ap2 Pair K_a2 (ap2 Pair K_pair (ap2 Pair K_oo K_oo))))
                    binPOO
        blkC   = pairOfConst_eval K_a2V K_a2V_isValue
                   (Fan (Lift (KT K_pair))
                        (Fan (Fan (Lift (KT K_a2))
                                  (Fan (Lift (KT K_te))
                                       (Fan (Lift (Comp Fst (Comp Snd Snd)))
                    ...
                    (ap2 Pair K_a2
                      (ap2 Pair K_pair
                        (ap2 Pair (ap2 Pair K_a2 (ap2 Pair K_te (ap2 Pair payA2 payB2)))
                                   (ap2 Pair K_a2 (ap2 Pair K_pair (ap2 Pair K_oo K_oo))))))
                    blkA blkC
        r_ifLf  = pairOfConst_eval K_ifLfV K_ifLfV_isValue
                    (Fan (Fan (Lift (KT K_a2))
                              (Fan (Lift (KT K_te))
                                   (Fan (Lift (Comp Fst Snd))
                                        (Lift (Comp Fst (Comp Snd (Comp Snd Snd)))) Pair)
...
module WithDispatch
  ...
  --    ( y , dispatch )  Sigma return type expected by  BRA2.Thm11.Thm11 .
  --
  ...
  mkR : (P : Formula) (m : Nat) (rest : Term) -> IsValue rest ->
  ...
  mkR P m rest rv d =
    mkSigma (nd (natCode (suc m)) rest)
      (mkSigma (valNd (natCode (suc m)) rest (natCode_isValue (suc m)) rv)
  ...
  encodeRich (mp {P = P} {Q = Q} pf1 pf2) =
    let r1 = encodeRich pf1
        ...
        y1_iv = fst (snd r1)
        y1' = fst (snd (snd r1))
        shape1 = fst (snd (snd (snd r1)))
        d1 = snd (snd (snd (snd r1)))
        y2 = fst r2
        y2_iv = fst (snd r2)
        d2 = snd (snd (snd (snd r2)))
    in mkR Q tagAxContrapos (nd y1 y2) (valNd y1 y2 (y1_iv) (y2_iv)) (thmTDispMp P Q y1 y2 y1' shape1 d1 d2)
  ...
  encodeRich (ruleIndBT2 P v1 v2 v3 v4 pf_LL pf_LN pf_NL pf_PP) =
    let
        ...
        y_LL = fst r_LL
        y_LL_iv = fst (snd r_LL)
        y_LN = fst r_LN
        y_LN_iv = fst (snd r_LN)
        y_NL = fst r_NL
        y_NL_iv = fst (snd r_NL)
        y_PP = fst r_PP
        y_PP_iv = fst (snd r_PP)
        y_step = nd y_LN (nd y_NL y_PP)
        y_step_iv = valNd y_LN (nd y_NL y_PP) y_LN_iv (valNd y_NL y_PP y_NL_iv y_PP_iv)
    in mkR P tagRuleInst
           (nd (codeFormula P)
               (nd (code (var zero))
                   (nd (code (var zero))
           ...
           (valNd (codeFormula P)
                  ...
                  (codeFormula_isValue P)
                  (valNd (code (var zero))
                         (nd (code (var zero)) (nd y_LL y_step))
                         (code_isValue (var zero))
                         (valNd (code (var zero)) (nd y_LL y_step)
                                (code_isValue (var zero))
                                (valNd y_LL y_step y_LL_iv y_step_iv))))
           (thmTDispRuleIndBT_param P zero zero (reify y_LL) (reify y_step))
  -- Group I (10 axiom cases, all concrete dispatches).
  encodeRich (axI t) =
    mkR (atomic (eqn (ap1 I t) t)) zero (code t) (code_isValue t) (thmTDispAxI t)
  encodeRich (axFst a' b') =
    mkR (atomic (eqn (ap1 Fst (ap2 Pair a' b')) a')) tagAxI (nd (code a') (code b')) (valNd (code a') (code b') (code_isValue a') (code_isValue b')) (thmTDispAxFst a' b')
  encodeRich (axSnd a' b') =
    mkR (atomic (eqn (ap1 Snd (ap2 Pair a' b')) b')) tagAxFst (nd (code a') (code b')) (valNd (code a') (code b') (code_isValue a') (code_isValue b')) (thmTDispAxSnd a' b')
  encodeRich (axConst a' b') =
    mkR (atomic (eqn (ap2 Const a' b') a')) tagAxSnd (nd (code a') (code b')) (valNd (code a') (code b') (code_isValue a') (code_isValue b')) (thmTDispAxConst a' b')
  encodeRich (axComp f g t) =
    mkR (atomic (eqn (ap1 (Comp f g) t) (ap1 f (ap1 g t)))) tagAxConst (nd (codeF1 f) (nd (codeF1 g) (code t))) (valNd (codeF1 f) (nd (codeF1 g) (code t)) (codeF1_isValue f) (valNd (codeF1 g) (code t) (codeF1_isValue g) (code_isValue t))) (thmTDispAxComp f g t)
  encodeRich (axComp2 h' f g t) =
    mkR (atomic (eqn (ap1 (Comp2 h' f g) t) (ap2 h' (ap1 f t) (ap1 g t)))) tagAxComp (nd (codeF2 h') (nd (codeF1 f) (nd (codeF1 g) (code t)))) (valNd (codeF2 h') (nd (codeF1 f) (nd (codeF1 g) (code t))) (codeF2_isValue h') (valNd (codeF1 f) (nd (codeF1 g) (code t)) (codeF1_isValue f) (valNd (codeF1 g) (code t) (codeF1_isValue g) (code_isValue t)))) (thmTDispAxComp2 h' f g t)
  encodeRich (axLift f a' b') =
    mkR (atomic (eqn (ap2 (Lift f) a' b') (ap1 f a'))) tagAxComp2 (nd (codeF1 f) (nd (code a') (code b'))) (valNd (codeF1 f) (nd (code a') (code b')) (codeF1_isValue f) (valNd (code a') (code b') (code_isValue a') (code_isValue b'))) (thmTDispAxLift f a' b')
  encodeRich (axPost f h' a' b') =
    mkR (atomic (eqn (ap2 (Post f h') a' b') (ap1 f (ap2 h' a' b')))) tagAxLift (nd (codeF1 f) (nd (codeF2 h') (nd (code a') (code b')))) (valNd (codeF1 f) (nd (codeF2 h') (nd (code a') (code b'))) (codeF1_isValue f) (valNd (codeF2 h') (nd (code a') (code b')) (codeF2_isValue h') (valNd (code a') (code b') (code_isValue a') (code_isValue b')))) (thmTDispAxPost f h' a' b')
  encodeRich (axFan h1 h2 h' a' b') =
    mkR (atomic (eqn (ap2 (Fan h1 h2 h') a' b')
                      (ap2 h' (ap2 h1 a' b') (ap2 h2 a' b')))) tagAxPost (nd (codeF2 h1) (nd (codeF2 h2) (nd (codeF2 h') (nd (code a') (code b'))))) (valNd (codeF2 h1) (nd (codeF2 h2) (nd (codeF2 h') (nd (code a') (code b')))) (codeF2_isValue h1) (valNd (codeF2 h2) (nd (codeF2 h') (nd (code a') (code b'))) (codeF2_isValue h2) (valNd (codeF2 h') (nd (code a') (code b')) (codeF2_isValue h') (valNd (code a') (code b') (code_isValue a') (code_isValue b'))))) (thmTDispAxFan h1 h2 h' a' b')
  encodeRich (axZ x) =
    mkR (atomic (eqn (ap1 Z x) O)) tagAxFan (nd (codeF1 Z) (code x)) (valNd (codeF1 Z) (code x) (codeF1_isValue Z) (code_isValue x)) (thmTDispAxZ x)
  ...
  encodeRich (axIfLfL a' b') =
    mkR (atomic (eqn (ap2 IfLf O (ap2 Pair a' b')) a')) tagAxKT (nd (code a') (code b')) (valNd (code a') (code b') (code_isValue a') (code_isValue b')) (thmTDispAxIfLfL a' b')
  encodeRich (axIfLfN x y a' b') =
    mkR (atomic (eqn (ap2 IfLf (ap2 Pair x y) (ap2 Pair a' b')) b')) tagAxIfLfL (nd (code x) (nd (code y) (nd (code a') (code b')))) (valNd (code x) (nd (code y) (nd (code a') (code b'))) (code_isValue x) (valNd (code y) (nd (code a') (code b')) (code_isValue y) (valNd (code a') (code b') (code_isValue a') (code_isValue b')))) (thmTDispAxIfLfN x y a' b')
  encodeRich axTreeEqLL =
    mkR (atomic (eqn (ap2 TreeEq O O) O)) tagAxIfLfN lf (valO) thmTDispAxTreeEqLL
  encodeRich (axTreeEqLN a' b') =
    mkR (atomic (eqn (ap2 TreeEq O (ap2 Pair a' b')) (ap2 Pair O O))) tagAxTreeEqLL (nd (code a') (code b')) (valNd (code a') (code b') (code_isValue a') (code_isValue b')) (thmTDispAxTreeEqLN a' b')
  encodeRich (axTreeEqNL a' b') =
    mkR (atomic (eqn (ap2 TreeEq (ap2 Pair a' b') O) (ap2 Pair O O))) tagAxTreeEqLN (nd (code a') (code b')) (valNd (code a') (code b') (code_isValue a') (code_isValue b')) (thmTDispAxTreeEqNL a' b')
    ...
    mkR (atomic (eqn (ap2 TreeEq (ap2 Pair a1 a2) (ap2 Pair b1 b2))
                      (ap2 IfLf (ap2 TreeEq a1 b1)
                                (ap2 Pair (ap2 TreeEq a2 b2)
                                          (ap2 Pair O O))))) tagAxTreeEqNL (nd (code a1) (nd (code a2) (nd (code b1) (code b2)))) (valNd (code a1) (nd (code a2) (nd (code b1) (code b2))) (code_isValue a1) (valNd (code a2) (nd (code b1) (code b2)) (code_isValue a2) (valNd (code b1) (code b2) (code_isValue b1) (code_isValue b2)))) (thmTDispAxTreeEqNN a1 a2 b1 b2)
  encodeRich (axGoodstein a' b') =
    mkR (atomic (eqn (ap2 IfLf (ap2 TreeEq a' b') (ap2 Pair a' O))
                      (ap2 IfLf (ap2 TreeEq a' b') (ap2 Pair b' O)))) tagAxTreeEqNN (nd (code a') (code b')) (valNd (code a') (code b') (code_isValue a') (code_isValue b')) (thmTDispAxGoodstein a' b')
  ...
  encodeRich (axRefl t) =
    mkR (atomic (eqn t t)) tagAxGoodstein (code t) (code_isValue t) (thmTDispAxRefl t)
  encodeRich (ruleSym {t = t} {u = u} pf) =
    let rec = encodeRich pf
        y_h = fst rec
        y_h_iv = fst (snd rec)
        d_h = snd (snd (snd (snd rec)))
    in mkR (atomic (eqn u t)) tagAxRefl y_h (y_h_iv) (thmTDispRuleSym t u y_h d_h)
  encodeRich (ruleTrans {t = t} {u = u} {v = v} pf1 pf2) =
    let r1 = encodeRich pf1
        ...
        y2_iv = fst (snd r2)
        d2 = snd (snd (snd (snd r2)))
    in mkR (atomic (eqn t v)) tagRuleSym (nd y1 y2) (valNd y1 y2 (y1_iv) (y2_iv)) (thmTDispRuleTrans t u v y1 y2 y1' shape1 d1 d2)
  encodeRich (cong1 f {t = t} {u = u} pf) =
    let rec = encodeRich pf
        y_h = fst rec
        y_h_iv = fst (snd rec)
        d_h = snd (snd (snd (snd rec)))
    in mkR (atomic (eqn (ap1 f t) (ap1 f u))) tagRuleTrans (nd (codeF1 f) y_h) (valNd (codeF1 f) y_h (codeF1_isValue f) (y_h_iv)) (thmTDispCong1 f t u y_h d_h)
  encodeRich (congL g {t = t} {u = u} x pf) =
    let rec = encodeRich pf
        ...
        shape_h = fst (snd (snd (snd rec)))
        d_h = snd (snd (snd (snd rec)))
    in mkR (atomic (eqn (ap2 g t x) (ap2 g u x))) tagCong1 (nd (nd (codeF2 g) (code x)) y_h) (valNd (nd (codeF2 g) (code x)) y_h (valNd (codeF2 g) (code x) (codeF2_isValue g) (code_isValue x)) (y_h_iv)) (thmTDispCongL g x t u y_h y_h' shape_h d_h)
  encodeRich (congR g x {t = t} {u = u} pf) =
    let rec = encodeRich pf
        ...
        shape_h = fst (snd (snd (snd rec)))
        d_h = snd (snd (snd (snd rec)))
    in mkR (atomic (eqn (ap2 g x t) (ap2 g x u))) tagCongL (nd (nd (codeF2 g) (code x)) y_h) (valNd (nd (codeF2 g) (code x)) y_h (valNd (codeF2 g) (code x) (codeF2_isValue g) (code_isValue x)) (y_h_iv)) (thmTDispCongR g x t u y_h y_h' shape_h d_h)
  -- Group IV (deferred non-recursive: axEqTrans..axContrapos).
  encodeRich (axEqTrans a' b' c') =
    mkR ((atomic (eqn a' b'))
          imp ((atomic (eqn a' c'))
                imp (atomic (eqn b' c')))) tagCongR (nd (code a') (nd (code b') (code c'))) (valNd (code a') (nd (code b') (code c')) (code_isValue a') (valNd (code b') (code c') (code_isValue b') (code_isValue c'))) (thmTDispAxEqTrans a' b' c')
  encodeRich (axEqCong1 f a' b') =
    mkR ((atomic (eqn a' b'))
          imp (atomic (eqn (ap1 f a') (ap1 f b')))) tagAxEqTrans (nd (codeF1 f) (nd (code a') (code b'))) (valNd (codeF1 f) (nd (code a') (code b')) (codeF1_isValue f) (valNd (code a') (code b') (code_isValue a') (code_isValue b'))) (thmTDispAxEqCong1 f a' b')
  encodeRich (axEqCongL g a' b' c') =
    mkR ((atomic (eqn a' b'))
          imp (atomic (eqn (ap2 g a' c') (ap2 g b' c')))) tagAxEqCong1 (nd (codeF2 g) (nd (code a') (nd (code b') (code c')))) (valNd (codeF2 g) (nd (code a') (nd (code b') (code c'))) (codeF2_isValue g) (valNd (code a') (nd (code b') (code c')) (code_isValue a') (valNd (code b') (code c') (code_isValue b') (code_isValue c')))) (thmTDispAxEqCongL g a' b' c')
  encodeRich (axEqCongR g a' b' c') =
    mkR ((atomic (eqn a' b'))
          imp (atomic (eqn (ap2 g c' a') (ap2 g c' b')))) tagAxEqCongL (nd (codeF2 g) (nd (code a') (nd (code b') (code c')))) (valNd (codeF2 g) (nd (code a') (nd (code b') (code c'))) (codeF2_isValue g) (valNd (code a') (nd (code b') (code c')) (code_isValue a') (valNd (code b') (code c') (code_isValue b') (code_isValue c')))) (thmTDispAxEqCongR g a' b' c')
  encodeRich (axK P Q) =
    mkR (P imp (Q imp P)) tagAxEqCongR (nd (codeFormula P) (codeFormula Q)) (valNd (codeFormula P) (codeFormula Q) (codeFormula_isValue P) (codeFormula_isValue Q)) (thmTDispAxK P Q)
  encodeRich (axS P Q R) =
    mkR ((P imp (Q imp R)) imp ((P imp Q) imp (P imp R))) tagAxK (nd (codeFormula P) (nd (codeFormula Q) (codeFormula R))) (valNd (codeFormula P) (nd (codeFormula Q) (codeFormula R)) (codeFormula_isValue P) (valNd (codeFormula Q) (codeFormula R) (codeFormula_isValue Q) (codeFormula_isValue R))) (thmTDispAxS P Q R)
  encodeRich (axNeg P Q) =
    mkR (((not P) imp (not Q)) imp (Q imp P)) tagAxS (nd (codeFormula P) (codeFormula Q)) (valNd (codeFormula P) (codeFormula Q) (codeFormula_isValue P) (codeFormula_isValue Q)) (thmTDispAxNeg P Q)
  ...
  encodeRich axFstLf =
    mkR (atomic (eqn (ap1 Fst O) O)) tagRuleIndBT lf (valO) thmTDispAxFstLf
  encodeRich axSndLf =
    mkR (atomic (eqn (ap1 Snd O) O)) tagAxFstLf lf (valO) thmTDispAxSndLf
  encodeRich axIfLfLL =
    mkR (atomic (eqn (ap2 IfLf O O) O)) tagAxSndLf lf (valO) thmTDispAxIfLfLL
  encodeRich (axIfLfNL x y) =
    mkR (atomic (eqn (ap2 IfLf (ap2 Pair x y) O) O)) tagAxIfLfLL (nd (code x) (code y)) (valNd (code x) (code y) (code_isValue x) (code_isValue y)) (thmTDispAxIfLfNL x y)
  encodeRich (axTreeRecLf f s p) =
    mkR (atomic (eqn (ap2 (treeRec f s) p O) (ap1 f p))) tagRuleIndBT2 (nd (codeF1 f) (nd (codeF2 s) (code p))) (valNd (codeF1 f) (nd (codeF2 s) (code p)) (codeF1_isValue f) (valNd (codeF2 s) (code p) (codeF2_isValue s) (code_isValue p))) (thmTDispAxTreeRecLf f s p)
    ...
    mkR (atomic (eqn (ap2 (treeRec f s) p (ap2 Pair a' b'))
                      (ap2 s (ap2 Pair p (ap2 Pair a' b'))
                             (ap2 Pair (ap2 (treeRec f s) p a')
                                       (ap2 (treeRec f s) p b'))))) tagAxTreeRecLf (nd (codeF1 f) (nd (codeF2 s) (nd (code p) (nd (code a') (code b'))))) (valNd (codeF1 f) (nd (codeF2 s) (nd (code p) (nd (code a') (code b')))) (codeF1_isValue f) (valNd (codeF2 s) (nd (code p) (nd (code a') (code b'))) (codeF2_isValue s) (valNd (code p) (nd (code a') (code b')) (code_isValue p) (valNd (code a') (code b') (code_isValue a') (code_isValue b'))))) (thmTDispAxTreeRecNd f s p a' b')
  -- Lite projection for  BRA2.Thm11.Thm11 .
  ...
  encode P pf =
    let r = encodeRich pf
    in mkSigma (fst r) (mkSigma (fst (snd r)) (snd (snd (snd (snd r)))))
  ...
  open import BRA2.Thm11 using (module Thm11)
