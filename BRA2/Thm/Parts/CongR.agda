...
module BRA2.Thm.Parts.CongR where

open import BRA2.Base
open import BRA2.Term
open import BRA2.Formula
open import BRA2.Thm.Tag using (tagCongR)
...
open import BRA2.SoundCongRVProof using (body_congR_v)

------------------------------------------------------------------------
-- body_congR (alias for the verifying body in BRA2.SoundCongRVProof).
