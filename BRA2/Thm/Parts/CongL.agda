...
module BRA2.Thm.Parts.CongL where

open import BRA2.Base
open import BRA2.Term
open import BRA2.Formula
open import BRA2.Thm.Tag using (tagCongL)
...
open import BRA2.SoundCongLVProof using (body_congL_v)

------------------------------------------------------------------------
-- body_congL (alias for the verifying body in BRA2.SoundCongLVProof).
