...
-- The dispatch-lemma for mp is stated in  BRA2.Thm.ThmT  as
--
--   thmTDispMp :
...
--                        (reify (codeFormula Q))))
--
-- and consumed in  BRA2.Thm.Encode  at the mp pattern-match by the
-- one-liner
--
...
module BRA2.Thm.Parts.Mp where
...
open import BRA2.SoundMpVProof using (body_mp_v)

------------------------------------------------------------------------
-- body_mp (alias for the verifying body in BRA2.SoundMpVProof).
