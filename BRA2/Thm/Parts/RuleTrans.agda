...
module BRA2.Thm.Parts.RuleTrans where
...
open import BRA2.SoundRuleTransVProof using (body_ruleTrans_v)

------------------------------------------------------------------------
-- body_ruleTrans (alias for the verifying body in BRA2.SoundRuleTransVProof).
