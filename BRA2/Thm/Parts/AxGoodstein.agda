...
module BRA2.Thm.Parts.AxGoodstein where

open import BRA2.Base
open import BRA2.Term
open import BRA2.Formula
open import BRA2.DerivThreshold
open import BRA2.Thm.Tag using (tagAxGoodstein)
...
abstract
  ...
  body_axGoodstein_eval a' b' bb =
    let payAT  = reify (code a')
        ...
        teInner = pairOfConst_eval K_teV K_teV_isValue (Lift Snd) a bb payT snd_a
        teFull  = pairOfConst_eval K_a2V K_a2V_isValue
        ...
        l_pair = pairOfConst_eval K_pairV K_pairV_isValue
                    (Fan (Lift (Comp Fst Snd)) (Lift (KT K_oo)) Pair)
                    a bb (ap2 Pair payAT K_oo) l_aoo
        l_pFull = pairOfConst_eval K_a2V K_a2V_isValue
                    (Fan (Lift (KT K_pair))
                         (Fan (Lift (Comp Fst Snd)) (Lift (KT K_oo)) Pair)
                         Pair)
        ...
        lhs_inner = pairOfFan_eval
                      ...
                      teFull l_pFull
        lhs_ifLf = pairOfConst_eval K_ifLfV K_ifLfV_isValue
        ...
        r_pair = pairOfConst_eval K_pairV K_pairV_isValue
                    (Fan (Lift (Comp Snd Snd)) (Lift (KT K_oo)) Pair)
                    a bb (ap2 Pair payBT K_oo) r_boo
        r_pFull = pairOfConst_eval K_a2V K_a2V_isValue
                    (Fan (Lift (KT K_pair))
                         (Fan (Lift (Comp Snd Snd)) (Lift (KT K_oo)) Pair)
                         Pair)
        ...
        rhs_inner = pairOfFan_eval
                      ...
                      teFull r_pFull
        rhs_ifLf = pairOfConst_eval K_ifLfV K_ifLfV_isValue
                     (Fan (Fan (Lift (KT K_a2))
                               (Fan (Lift (KT K_te)) (Lift Snd) Pair) Pair)
                          (Fan (Lift (KT K_a2))
                               (Fan (Lift (KT K_pair))
