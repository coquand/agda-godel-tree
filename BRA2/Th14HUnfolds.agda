...
-- BRA2.Thm14Constr5Final .  Mirrors  Th14Step3 's f_part_inner2_unfold /
...
module BRA2.Th14HUnfolds where
...
open import BRA2.Thm.Tag  using (tagRuleInst ; tagMp)

open import BRA2.Thm.ThmT using (thmT)
open import BRA2.Thm.TagCodes using (tagCode_ruleInst ; tagCode_mp)
...
open import BRA2.GoedelII using (i ; G)
open import BRA2.Thm14Numerals using (t'_term ; t'_term_isValue)
...
module Th14HUnfolds
  ...
  h_part_inner1_unfold x =
    let
        ...
        kt_t = ktRed t'_term t'_term_isValue x
