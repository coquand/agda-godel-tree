...
module BRA2.Thm12.Parts.Lift where
...
open import BRA2.Thm.Tag using (tagAxLift ; tagRuleTrans)
open import BRA2.Thm.ThmT using (thmT ; tagCode_axLift ; tagCode_ruleTrans)
open import BRA2.Thm12.Param.AxLift
  ...
  D2_Lift_reduce a b =
    let -- Outer Fan unfolds.
        ...
        l2 = ruleTrans (axLift (KT tagCode_axLift) a b)
                       (axKT (natCode tagAxLift) (natCode_isValue tagAxLift) a)
        ...
        l4 = ruleTrans (axLift (KT codeF1f_T) a b) (axKT (codeF1 f) (codeF1_isValue f) a)
