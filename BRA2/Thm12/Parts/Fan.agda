...
module BRA2.Thm12.Parts.Fan where
...
open import BRA2.Thm12.Param.AxFan
...
module FanCase
  ...
  private
    ...
    y1_part : Fun2
    y1_part = Fan (Lift (KT BRA2.Thm.ThmT.tagCode_axFan)) y1_inner2 Pair
    ...
    y2a_part : Fun2
    y2a_part = Fan (Lift (KT BRA2.Thm.ThmT.tagCode_congL)) y2a_inner2 Pair
    ...
    y2b_part : Fun2
    y2b_part = Fan (Lift (KT BRA2.Thm.ThmT.tagCode_congR)) y2b_inner2 Pair
    ...
    let -- ====================================================================
        ...
        red_y1_inner4 =
          let s1 = axFan (Lift (KT cF2h)) pair_corxv Pair x v
              ...
              s2 = ruleTrans (axLift (KT cF2h) x v) (axKT (codeF2 h) (codeF2_isValue h) x)
          in ruleTrans s1
        ...
        red_y1_inner3 =
          let s1 = axFan (Lift (KT cF2h2)) y1_inner4 Pair x v
              ...
              s2 = ruleTrans (axLift (KT cF2h2) x v) (axKT (codeF2 h2) (codeF2_isValue h2) x)
          in ruleTrans s1
        ...
        red_y1_inner2 =
          let s1 = axFan (Lift (KT cF2h1)) y1_inner3 Pair x v
              ...
              s2 = ruleTrans (axLift (KT cF2h1) x v) (axKT (codeF2 h1) (codeF2_isValue h1) x)
          in ruleTrans s1
        ...
        red_y1 =
          let s1 = axFan (Lift (KT BRA2.Thm.ThmT.tagCode_axFan)) y1_inner2 Pair x v
              s2 : Deriv (atomic (eqn
                          (ap2 (Lift (KT BRA2.Thm.ThmT.tagCode_axFan)) x v)
                          BRA2.Thm.ThmT.tagCode_axFan))
              s2 = ruleTrans (axLift (KT BRA2.Thm.ThmT.tagCode_axFan) x v)
                             (axKT (natCode BRA2.Thm.Tag.tagAxFan) (natCode_isValue BRA2.Thm.Tag.tagAxFan) x)
          in ruleTrans s1
               (ruleTrans (congL Pair (ap2 y1_inner2 x v) s2)
                          (congR Pair BRA2.Thm.ThmT.tagCode_axFan red_y1_inner2))
        ...
        red_enc_h2_num =
          let s1 = axFan (Lift (KT (reify tagAp2))) enc_h2_num_inner Pair x v
              s2 : Deriv (atomic (eqn (ap2 (Lift (KT (reify tagAp2))) x v)
                                       (reify tagAp2)))
              s2 = ruleTrans (axLift (KT (reify tagAp2)) x v) (axKT tagAp2 tagAp2_isValue x)
          in ruleTrans s1
                          ...
                          (parEncCongL h (ap2 D2_h1 x v)
                            (ap2 Pair (reify tagAp2)
                              (ap2 Pair cF2h2
                                (ap2 Pair (ap1 cor x) (ap1 cor v)))))))
        red_y2a =
          let s1 = axFan (Lift (KT BRA2.Thm.ThmT.tagCode_congL)) y2a_inner2 Pair x v
              s2 : Deriv (atomic (eqn
                          (ap2 (Lift (KT BRA2.Thm.ThmT.tagCode_congL)) x v)
                          BRA2.Thm.ThmT.tagCode_congL))
              s2 = ruleTrans (axLift (KT BRA2.Thm.ThmT.tagCode_congL) x v)
                             (axKT (natCode BRA2.Thm.Tag.tagCongL) (natCode_isValue BRA2.Thm.Tag.tagCongL) x)
          in ruleTrans s1
               (ruleTrans (congL Pair (ap2 y2a_inner2 x v) s2)
                          (congR Pair BRA2.Thm.ThmT.tagCode_congL red_y2a_inner2))
        ...
        red_y2b =
          let s1 = axFan (Lift (KT BRA2.Thm.ThmT.tagCode_congR)) y2b_inner2 Pair x v
              s2 : Deriv (atomic (eqn
                          (ap2 (Lift (KT BRA2.Thm.ThmT.tagCode_congR)) x v)
                          BRA2.Thm.ThmT.tagCode_congR))
              s2 = ruleTrans (axLift (KT BRA2.Thm.ThmT.tagCode_congR) x v)
                             (axKT (natCode BRA2.Thm.Tag.tagCongR) (natCode_isValue BRA2.Thm.Tag.tagCongR) x)
          in ruleTrans s1
               (ruleTrans (congL Pair (ap2 y2b_inner2 x v) s2)
                          (congR Pair BRA2.Thm.ThmT.tagCode_congR red_y2b_inner2))
        ...
        y1_shape : Deriv (atomic (eqn
                      ...
                      (ap2 Pair O _)))
        y1_shape = axFst BRA2.Thm.ThmT.tagCode_axFan _
