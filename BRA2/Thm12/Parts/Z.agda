...
module BRA2.Thm12.Parts.Z where
...
open import BRA2.Thm.ThmT using (thmT ; tagCode_axKT)
open import BRA2.Thm12.Param.AxZ using (parDispAxZ ; parEncAxZ ; parOutAxZ)
...
D_Z_reduce x =
  let codeF1Z_T : Term
      ...
      s2 = axKT (natCode tagAxKT) (natCode_isValue tagAxKT) x
      ...
      s4 = axKT (codeF1 Z) (codeF1_isValue Z) x
