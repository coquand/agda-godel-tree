...
-- BRA2.Thm12.Parts.TreeEq   (Theorem 12 case for g = TreeEq, binary).
--
...
module BRA2.Thm12.Parts.TreeEq where
...
open import BRA2.Thm12.Param.AxTreeEqLL
  using (parEncAxTreeEqLL ; parOutAxTreeEqLL ; parDispAxTreeEqLL)
open import BRA2.Thm12.Param.AxTreeEqLN
  using (parEncAxTreeEqLN ; parOutAxTreeEqLN ; parDispAxTreeEqLN)
open import BRA2.Thm12.Param.AxTreeEqNL
...
module ConstructionBase
  ...
  D_TreeEq_reduce_OO =
    let s1 = axFan fstProj outerInner IfLf O O
        ...
        ilf2 = ruleTrans (axLift (KT caseLLTerm) O O)
                         (axKT (nd (natCode tagAxTreeEqLL) lf) (valNd (natCode tagAxTreeEqLL) lf (natCode_isValue tagAxTreeEqLL) valO) O)
  ...
  D_TreeEq_reduce_LN a b =
    let v = ap2 Pair a b
        ...
        lnf3 = axKT (natCode tagAxTreeEqLN) (natCode_isValue tagAxTreeEqLN) v
  ...
  D_TreeEq_reduce_NL p q =
    let x = ap2 Pair p q
        ...
        nlf3 = axKT (natCode tagAxTreeEqNL) (natCode_isValue tagAxTreeEqNL) x
