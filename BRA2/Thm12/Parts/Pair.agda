...
-- (BRA2.Cor).  So both LHS and RHS of the encoded equation reduce to the
...
module BRA2.Thm12.Parts.Pair where
...
open import BRA2.Thm.ThmT using (thmT ; tagCode_axRefl)
open import BRA2.Thm12.Param.AxRefl
...
D2_Pair_reduce x v =
  let s1 : Deriv (atomic (eqn (ap2 D2_Pair x v)
      ...
      s2b = axKT (natCode tagAxRefl) (natCode_isValue tagAxRefl) x
