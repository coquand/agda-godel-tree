...
-- BRA2.Thm12.Parts.TreeRec   (Theorem 12 case for g = treeRec f s, binary).
--
...
--   * D2_treeRec_NN_fun_closed : derived from BRA2.SubstClosure.Fun2_closed.
--   * treeRec_fs_closed : derived from BRA2.SubstClosure.Fun2_closed.

module BRA2.Thm12.Parts.TreeRec where
...
open import BRA2.Thm.Tag using (tagAxTreeRecLf ; tagRuleTrans)
open import BRA2.Thm.ThmT using (thmT ; tagCode_axTreeRecLf
                                 ; tagCode_ruleTrans ; thClosed)
open import BRA2.SubstClosure
