...
module BRA2.Thm12.Parts.Const where
...
open import BRA2.Thm.ThmT using (thmT ; tagCode_axConst)
open import BRA2.Thm12.Param.AxConst
...
D2_Const_reduce x v =
  let s1 : Deriv (atomic (eqn (ap2 D2_Const x v)
      ...
      s2b = axKT (natCode tagAxConst) (natCode_isValue tagAxConst) x
