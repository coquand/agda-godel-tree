...
open import BRA2.Thm12.Param.AxSnd
  using (parEncAxSnd ; parOutAxSnd ; parDispAxSnd)
open import BRA2.Thm12.Param.AxSndLf
...
D_Snd_reduce_O =
  let s1 : Deriv (atomic (eqn (ap1 D_Snd O)
      ...
      d2 = axKT (nd (natCode tagAxSndLf) lf) (valNd (natCode tagAxSndLf) lf (natCode_isValue tagAxSndLf) valO) O
...
D_Snd_reduce_Pair v1 v2 =
  let pv = ap2 Pair v1 v2
      ...
      d2 = axKT (nd (natCode tagAxSndLf) lf) (valNd (natCode tagAxSndLf) lf (natCode_isValue tagAxSndLf) valO) pv
      ...
      n2 = axKT (natCode (suc (suc (suc zero)))) (natCode_isValue (suc (suc (suc zero)))) pv  -- tagAxSnd = 3
