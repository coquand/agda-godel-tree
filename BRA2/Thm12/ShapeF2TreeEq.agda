...
-- BRA2.Thm12.ShapeF2TreeEq -- universal Fst-shape for the Th12TreeEqClose
-- D_TreeEq (= Construction.D_TreeEq instantiated with the specific
-- D_TreeEq_NN_fun from BRA2.Th12TreeEqNNFun).
--
...
module BRA2.Thm12.ShapeF2TreeEq where
...
open import BRA2.Thm12.Param.AxTreeEqLL using (parEncAxTreeEqLL)
open import BRA2.Thm12.Param.AxTreeEqLN using (parEncAxTreeEqLN)
open import BRA2.Thm12.Param.AxTreeEqNL using (parEncAxTreeEqNL)
open import BRA2.Thm.ThmT using (tagCode_ruleTrans)
open import BRA2.Thm.Tag using (tagRuleTrans)
open import BRA2.Th12TreeEqNNFun using (inner_dispatch)
...
shape_NN p q a b =
  let
    ...
    --   = tagCode_ruleTrans  via axKT (natCode tagRuleTrans) (natCode_isValue tagRuleTrans) X.
