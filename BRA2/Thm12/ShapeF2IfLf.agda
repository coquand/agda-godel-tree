...
-- BRA2.Thm12.ShapeF2IfLf -- universal Fst-shape lemma for D_IfLf.
--
-- Mirrors BRA2.Thm12.Parts.IfLf.D_correct2_IfLf_univ structure: 4 leaf
...
module BRA2.Thm12.ShapeF2IfLf where
...
open import BRA2.Thm12.Parts.IfLf
  using ( D_IfLf
        ; D_IfLf_reduce_OO
        ; D_IfLf_reduce_LN
        ; D_IfLf_reduce_NL
        ; D_IfLf_reduce_NN )
open import BRA2.Thm12.Param.AxIfLfL  using (parEncAxIfLfL)
open import BRA2.Thm12.Param.AxIfLfN  using (parEncAxIfLfN)
open import BRA2.Thm12.Param.AxIfLfLL using (parEncAxIfLfLL)
open import BRA2.Thm12.Param.AxIfLfNL using (parEncAxIfLfNL)
