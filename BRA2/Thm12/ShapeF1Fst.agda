...
-- BRA2.Thm12.ShapeF1Fst -- universal Fst-shape for Parts.Fst.D_Fst
...
module BRA2.Thm12.ShapeF1Fst where
...
open import BRA2.Thm12.Parts.Fst
  using ( D_Fst
        ; D_Fst_reduce_O
        ; D_Fst_reduce_Pair )
open import BRA2.Thm12.Param.AxFstLf using (parEncAxFstLf)
open import BRA2.Thm12.Param.AxFst   using (parEncAxFst)
