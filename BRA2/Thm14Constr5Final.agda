...
-- contract that BRA2.GoedelII.Compose consumes.
--
...
module BRA2.Thm14Constr5Final where
...
open import BRA2.GoedelII using (i ; cG ; G)
open import BRA2.Thm14Numerals using (t_term ; t'_term)
