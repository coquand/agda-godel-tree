...
-- BRA2.Th12TreeEqBasePP -- pointwise basePP_imp body for Th12 TreeEq.
--
...
module BRA2.Th12TreeEqBasePP where
...
open import BRA2.Thm12.Param.AxTreeEqNN
  using (parEncAxTreeEqNN ; parOutAxTreeEqNN ; parDispAxTreeEqNN)
open import BRA2.Thm12.Parts.IfLf using (D_IfLf ; codeFTeq2_IfLf ; D_correct2_IfLf)
open import BRA2.Thm12.Parts.TreeEq using (codeFTeq2_TreeEq)

open import BRA2.Th12TreeEqNNFun
open import BRA2.Th12TreeEqNNReduce
...
--                                                  (Pair (cor v1)(cor v2)))
--
-- Standard lemma; mirrors BRA2.Thm12.Parts.TreeEq.corPairUnfold (private).
...
Th12_F2_TreeEq_NN_pt v1 v2 v3 v4 =
  let
    ...
    disp : Deriv (atomic (eqn
            ...
            (ap2 Pair u1 u4)))
    disp = BRA2.Thm.ThmT.thmTDispRuleTrans_param y1T y2T u1 u2 u3 u4 _ _
             shape d1 d2
