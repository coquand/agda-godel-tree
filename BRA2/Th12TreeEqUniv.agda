...
-- BRA2.Th12TreeEqUniv -- assembles ruleIndBT2 for Theorem 12 TreeEq.
--
...
module BRA2.Th12TreeEqUniv where
...
open import BRA2.Th12TreeEqBaseLN using (P_Th12_TreeEq ; v3Nat ; v4Nat ; baseLN_imp)
open import BRA2.Th12TreeEqBaseNL using (v1Nat ; v2Nat ; baseNL_imp)
