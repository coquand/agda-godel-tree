...
The development comprises 16 files and 3578 lines of Agda, with no
postulates, no holes, and no standard library.
...
The remaining gap for a fully internal G\"odel~II is the same gap that
exists in any sufficiently strong system: the system cannot prove its own
soundness. This is not a limitation of the architecture but the very
content of G\"odel's second incompleteness theorem.

\bigskip

\noindent\textbf{Artifact.}
The complete Agda development is available as 16 source files. All files
